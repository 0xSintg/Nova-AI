...
function ensureZalouserPluginEnabled(cfg: Nova AIConfig): Nova AIConfig {
      ...
      await prompter.note(
        [
          ...
          t("wizard.zalouser.peersLookupTip", {
            command: formatCliCommand("nova-ai directory peers list --channel zalouser"),
          }),
        ].join("\n"),
        ...
        await prompter.note(
          [
            ...
            t("wizard.zalouser.groupsLookupTip", {
              command: formatCliCommand("nova-ai directory groups list --channel zalouser"),
            }),
