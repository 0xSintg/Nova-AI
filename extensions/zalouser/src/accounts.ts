...
function mergeZalouserAccountConfig(cfg: Nova AIConfig, accountId: string): ZalouserAccountConfig {
...
function resolveZalouserAccountBase(params: { cfg: Nova AIConfig; accountId?: string | null }) {
