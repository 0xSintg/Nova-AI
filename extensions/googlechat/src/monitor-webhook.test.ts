...
import type { FixedWindowRateLimiter } from "nova-ai/plugin-sdk/webhook-ingress";
...
vi.mock("nova-ai/plugin-sdk/webhook-request-guards", () => ({
  readJsonWebhookBodyOrReject,
}));

vi.mock("nova-ai/plugin-sdk/webhook-targets", () => ({
...
describe("googlechat monitor webhook", () => {
  ...
  afterAll(() => {
    vi.doUnmock("nova-ai/plugin-sdk/webhook-request-guards");
    vi.doUnmock("nova-ai/plugin-sdk/webhook-targets");
    vi.doUnmock("./auth.js");
    vi.resetModules();
  });
