...
function resolveGoogleChatAccountImpl(params: { cfg: Nova AIConfig; accountId?: string | null }) {
...
vi.mock("./channel.deps.runtime.js", () => {
  return {
    ...
    listGoogleChatAccountIds: (cfg: Nova AIConfig) => {
...
function createGoogleChatCfg(): Nova AIConfig {
  return {
    channels: {
      googlechat: {
        enabled: true,
