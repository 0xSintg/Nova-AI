...
import { safeParseJsonWithSchema, safeParseWithSchema } from "nova-ai/plugin-sdk/extension-shared";
import { mergePairLoopGuardConfig } from "nova-ai/plugin-sdk/pair-loop-guard-runtime";
import { isSecretRef } from "nova-ai/plugin-sdk/secret-input";
...
export function listEnabledGoogleChatAccounts(cfg: Nova AIConfig): ResolvedGoogleChatAccount[] {
