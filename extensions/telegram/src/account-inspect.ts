import { resolveAccountWithDefaultFallback } from "nova-ai/plugin-sdk/account-core";
import { tryReadSecretFileSync } from "nova-ai/plugin-sdk/channel-core";
...
import { resolveDefaultSecretProviderAlias } from "nova-ai/plugin-sdk/provider-auth";
import { DEFAULT_ACCOUNT_ID, normalizeAccountId } from "nova-ai/plugin-sdk/routing";
import {
  hasConfiguredSecretInput,
  normalizeSecretInputString,
} from "nova-ai/plugin-sdk/secret-input";
import { coerceSecretRef } from "nova-ai/plugin-sdk/secret-input-runtime";
...
function inspectTokenValue(params: { cfg: Nova AIConfig; value: unknown }): {
  token: string;
