...
import { resolveAgentMaxConcurrent } from "nova-ai/plugin-sdk/model-session-runtime";
...
export function createTelegramRunnerOptions(cfg: Nova AIConfig): RunOptions<unknown> {
  return {
    sink: {
