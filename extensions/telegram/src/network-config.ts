...
import { isTruthyEnvValue, isWSL2Sync } from "nova-ai/plugin-sdk/runtime-env";
import { normalizeOptionalLowercaseString } from "nova-ai/plugin-sdk/string-coerce-runtime";

export const TELEGRAM_DISABLE_AUTO_SELECT_FAMILY_ENV =
  "NOVA_AI_TELEGRAM_DISABLE_AUTO_SELECT_FAMILY";
export const TELEGRAM_ENABLE_AUTO_SELECT_FAMILY_ENV = "NOVA_AI_TELEGRAM_ENABLE_AUTO_SELECT_FAMILY";
export const TELEGRAM_DNS_RESULT_ORDER_ENV = "NOVA_AI_TELEGRAM_DNS_RESULT_ORDER";
 ...
 *
 * Priority:
 * 1. Environment variable NOVA_AI_TELEGRAM_DNS_RESULT_ORDER
