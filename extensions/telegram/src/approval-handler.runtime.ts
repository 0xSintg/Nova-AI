import type {
  ...
  PendingApprovalView,
} from "nova-ai/plugin-sdk/approval-handler-runtime";
import { createChannelApprovalNativeRuntimeAdapter } from "nova-ai/plugin-sdk/approval-handler-runtime";
import { buildChannelApprovalNativeTargetKey } from "nova-ai/plugin-sdk/approval-native-runtime";
import { buildPluginApprovalPendingReplyPayload } from "nova-ai/plugin-sdk/approval-reply-runtime";
import {
  buildApprovalPresentationFromActionDescriptors,
  buildExecApprovalPendingReplyPayload,
} from "nova-ai/plugin-sdk/approval-reply-runtime";
import type { ExecApprovalPendingReplyParams } from "nova-ai/plugin-sdk/approval-reply-runtime";
import type {
  ExecApprovalRequest,
  PluginApprovalRequest,
} from "nova-ai/plugin-sdk/approval-runtime";
