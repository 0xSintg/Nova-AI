...
import type { TelegramAccountConfig } from "nova-ai/plugin-sdk/config-contracts";
...
vi.mock("nova-ai/plugin-sdk/plugin-runtime", () => ({
...
vi.mock("nova-ai/plugin-sdk/reply-dispatch-runtime", () => ({
...
export function createNativeCommandsHarness(params?: {
  ...
  const telegramDeps = {
    getRuntimeConfig: vi.fn(() => params?.cfg ?? ({} as Nova AIConfig)),
