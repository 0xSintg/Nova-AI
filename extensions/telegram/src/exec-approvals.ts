import { resolveApprovalApprovers } from "nova-ai/plugin-sdk/approval-auth-runtime";
import {
...
import { resolveApprovalRequestChannelAccountId } from "nova-ai/plugin-sdk/approval-native-runtime";
import type {
  ExecApprovalRequest,
  PluginApprovalRequest,
} from "nova-ai/plugin-sdk/approval-runtime";
import type { Nova AIConfig } from "nova-ai/plugin-sdk/config-contracts";
import type { TelegramExecApprovalConfig } from "nova-ai/plugin-sdk/config-contracts";
import type { ReplyPayload } from "nova-ai/plugin-sdk/reply-runtime";
import { normalizeAccountId } from "nova-ai/plugin-sdk/routing";
import {
...
function resolveTelegramOwnerApprovers(cfg: Nova AIConfig): Array<string | number> {
