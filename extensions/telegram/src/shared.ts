import { resolveNormalizedAccountEntry } from "nova-ai/plugin-sdk/account-core";
...
import { createChannelPluginBase, type ChannelPlugin } from "nova-ai/plugin-sdk/channel-core";
import { getChatChannelMeta } from "nova-ai/plugin-sdk/channel-plugin-common";
import type { Nova AIConfig, TelegramAccountConfig } from "nova-ai/plugin-sdk/config-contracts";
 ...
 *
 * See: https://github.com/nova-ai/nova-ai/issues/53876
 */
function isBlockedByMultiBotGuard(cfg: Nova AIConfig, accountId: string): boolean {
