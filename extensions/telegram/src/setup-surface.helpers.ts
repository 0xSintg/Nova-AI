...
export function shouldShowTelegramDmAccessWarning(cfg: Nova AIConfig, accountId: string): boolean {
...
export function buildTelegramDmAccessWarningLines(accountId: string): string[] {
  ...
  return [
    ...
    "  " + formatCliCommand(`nova-ai config set ${configBase}.dmPolicy "allowlist"`),
    "  " + formatCliCommand(`nova-ai config set ${configBase}.allowFrom '["YOUR_USER_ID"]'`),
