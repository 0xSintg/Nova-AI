...
import { resetInboundDedupe } from "nova-ai/plugin-sdk/reply-runtime";
...
type DispatchReplyWithBufferedBlockDispatcherFn =
  typeof import("nova-ai/plugin-sdk/reply-runtime").dispatchReplyWithBufferedBlockDispatcher;
type DispatchReplyHarnessParams = Parameters<DispatchReplyWithBufferedBlockDispatcherFn>[0];
type ReadRemoteMediaBufferFn =
  typeof import("nova-ai/plugin-sdk/media-runtime").readRemoteMediaBuffer;
...
export const telegramBotDepsForTest: TelegramBotDeps = {
  getRuntimeConfig: (() =>
    ...
    }) as Nova AIConfig) as TelegramBotDeps["getRuntimeConfig"],
