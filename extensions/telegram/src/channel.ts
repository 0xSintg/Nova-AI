...
import type { ChannelMessageActionAdapter } from "nova-ai/plugin-sdk/channel-contract";
import {
...
import { createAccountStatusSink } from "nova-ai/plugin-sdk/channel-lifecycle";
...
} from "nova-ai/plugin-sdk/outbound-send-deps";
import { type RoutePeer } from "nova-ai/plugin-sdk/routing";
import {
...
const telegramMessageAdapter = createChannelMessageAdapterFromOutbound<Nova AIConfig>({
  id: "telegram",
  live: {
    capabilities: {
      draftPreview: true,
  ...
  base: {
    ...
    gateway: {
      ...
      logoutAccount: async ({ accountId, cfg }) => {
        ...
        const nextCfg = { ...cfg } as Nova AIConfig;
