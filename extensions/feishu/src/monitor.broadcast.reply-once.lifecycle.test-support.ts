...
import type { NovabotConfig, RuntimeEnv } from "../runtime-api.js";
...
function createLifecycleConfig(): NovabotConfig {
  return {
    broadcast: {
...
describe("Feishu broadcast reply-once lifecycle", () => {
  beforeEach(() => {
    ...
    setFeishuLifecycleStateDir("nova-ai-feishu-broadcast");
