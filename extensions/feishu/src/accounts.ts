import {
  DEFAULT_ACCOUNT_ID,
  type Nova AIConfig as NovabotConfig,
  createAccountListHelpers,
  hasConfiguredAccountValue,
  normalizeAccountId,
  normalizeOptionalAccountId,
  resolveMergedAccountConfig,
} from "nova-ai/plugin-sdk/account-resolution";
import { coerceSecretRef } from "nova-ai/plugin-sdk/provider-auth";
 ...
 */
export function resolveDefaultFeishuAccountSelection(cfg: NovabotConfig): {
  accountId: string;
 ...
 */
export function resolveDefaultFeishuAccountId(cfg: NovabotConfig): string {
 ...
 */
function mergeFeishuAccountConfig(cfg: NovabotConfig, accountId: string): FeishuConfig {
 ...
 */
export function listEnabledFeishuAccounts(cfg: NovabotConfig): ResolvedFeishuAccount[] {
