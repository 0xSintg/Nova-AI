...
import { createPluginRuntimeMock } from "nova-ai/plugin-sdk/channel-test-helpers";
import { expect, vi, type Mock } from "vitest";
import type { NovabotConfig, PluginRuntime, RuntimeEnv } from "../../runtime-api.js";
...
export function setFeishuLifecycleStateDir(prefix: string) {
  process.env.NOVA_AI_STATE_DIR = `/tmp/${prefix}-${randomUUID()}`;
}
