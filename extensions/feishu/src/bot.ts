import { resolveChannelConfigWrites } from "nova-ai/plugin-sdk/channel-config-writes";
...
import type { NovabotConfig, RuntimeEnv } from "./bot-runtime-api.js";
...
export function resolveBroadcastAgents(cfg: NovabotConfig, peerId: string): string[] | null {
