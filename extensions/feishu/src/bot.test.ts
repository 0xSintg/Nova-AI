import type * as ConversationRuntime from "nova-ai/plugin-sdk/conversation-runtime";
import { createRuntimeEnv } from "nova-ai/plugin-sdk/plugin-test-runtime";
import type { ResolvedAgentRoute } from "nova-ai/plugin-sdk/routing";
import { resolveGroupSessionKey } from "nova-ai/plugin-sdk/session-store-runtime";
import { afterAll, beforeEach, describe, expect, it, vi } from "vitest";
import type { NovabotConfig, PluginRuntime } from "../runtime-api.js";
...
async function dispatchMessage(params: { cfg: NovabotConfig; event: FeishuMessageEvent }) {
...
describe("createFeishuMessageReceiveHandler media dedupe", () => {
  it("keeps same-id media variants distinct at receive time", async () => {
    ...
    const handler = createFeishuMessageReceiveHandler({
      cfg: { channels: { feishu: { dmPolicy: "open" } } } as NovabotConfig,
      core,
