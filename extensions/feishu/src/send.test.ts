...
vi.mock("nova-ai/plugin-sdk/markdown-table-runtime", () => ({
  resolveMarkdownTableMode: mockResolveMarkdownTableMode,
}));

vi.mock("nova-ai/plugin-sdk/text-chunking", async (importOriginal) => {
  const actual = await importOriginal<typeof import("nova-ai/plugin-sdk/text-chunking")>();
  return {
    ...actual,
...
describe("getMessageFeishu", () => {
  ...
  afterAll(() => {
    vi.doUnmock("nova-ai/plugin-sdk/markdown-table-runtime");
