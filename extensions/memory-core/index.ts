...
import { resolveMemoryBackendConfig } from "nova-ai/plugin-sdk/memory-core-host-runtime-files";
import {
  definePluginEntry,
  type AnyAgentTool,
  type Nova AIPluginToolContext,
...
type MemoryToolOptions = {
  ...
  getConfig?: () => Nova AIConfig | undefined;
  agentId?: string;
...
function getToolConfig(options: MemoryToolOptions): Nova AIConfig | undefined {
...
function resolveMemoryToolOptions(ctx: Nova AIPluginToolContext): MemoryToolOptions {
