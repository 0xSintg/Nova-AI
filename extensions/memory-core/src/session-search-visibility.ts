import type { Nova AIConfig } from "nova-ai/plugin-sdk/memory-core-host-runtime-core";
import type { MemorySearchResult } from "nova-ai/plugin-sdk/memory-core-host-runtime-files";
import { resolveSessionAgentId } from "nova-ai/plugin-sdk/memory-host-core";
import {
...
function isGlobalSessionKeyForSharedScope(cfg: Nova AIConfig, key: string): boolean {
