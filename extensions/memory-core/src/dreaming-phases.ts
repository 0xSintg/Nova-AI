...
import {
  ...
  sessionPathForFile,
} from "nova-ai/plugin-sdk/memory-core-host-engine-qmd";
...
import type { Nova AIPluginApi } from "nova-ai/plugin-sdk/plugin-entry";
import { appendRegularFile, privateFileStore } from "nova-ai/plugin-sdk/security-runtime";
...
type Logger = Pick<Nova AIPluginApi["logger"], "info" | "warn" | "error">;
...
const LIGHT_SLEEP_EVENT_TEXT = "__nova-ai_memory_core_light_sleep__";
const REM_SLEEP_EVENT_TEXT = "__nova-ai_memory_core_rem_sleep__";
...
const MANAGED_DAILY_DREAMING_BLOCKS = [
  {
    heading: "## Light Sleep",
    startMarker: "<!-- nova-ai:dreaming:light:start -->",
    endMarker: "<!-- nova-ai:dreaming:light:end -->",
  },
  {
    heading: "## REM Sleep",
    startMarker: "<!-- nova-ai:dreaming:rem:start -->",
    endMarker: "<!-- nova-ai:dreaming:rem:end -->",
  },
] as const;
