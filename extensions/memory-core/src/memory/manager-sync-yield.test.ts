...
import type { MemorySource } from "nova-ai/plugin-sdk/memory-core-host-engine-storage";
...
class SessionSyncYieldHarness extends MemoryManagerSyncOps {
  protected readonly cfg = {} as Nova AIConfig;
  protected readonly agentId = "main";
  protected readonly workspaceDir = "/tmp/nova-ai-test-workspace";
...
describe("session sync responsiveness", () => {
  beforeEach(() => {
    vi.stubEnv("NOVA_AI_STATE_DIR", path.join(os.tmpdir(), "nova-ai-session-sync-yield"));
