...
import { classifyMemoryMultimodalPath } from "nova-ai/plugin-sdk/memory-core-host-engine-embeddings";
import {
...
const TEST_MEMORY_WATCH_FACTORY_KEY = Symbol.for("nova-ai.test.memoryWatchFactory");
...
export abstract class MemoryManagerSyncOps {
  protected abstract readonly cfg: Nova AIConfig;
  ...
  protected async runSync(params?: {
    ...
    const targetedSessionSync = await runMemoryTargetedSessionSync({
      ...
      useUnsafeReindex:
        ...
        process.env.NOVA_AI_TEST_MEMORY_UNSAFE_REINDEX === "1",
      sessionsDirtyFiles: this.sessionsDirtyFiles,
