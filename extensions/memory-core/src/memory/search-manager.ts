...
import { checkQmdBinaryAvailability } from "nova-ai/plugin-sdk/memory-core-host-engine-qmd";
import {
...
const MEMORY_SEARCH_MANAGER_CACHE_KEY = Symbol.for("nova-ai.memorySearchManagerCache");
type Maybe<T> = T | null;
