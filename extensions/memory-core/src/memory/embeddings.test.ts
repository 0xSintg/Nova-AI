...
import type { MemoryEmbeddingProviderAdapter } from "nova-ai/plugin-sdk/memory-core-host-engine-embeddings";
...
vi.mock("nova-ai/plugin-sdk/memory-core-host-engine-embeddings", () => ({
