...
import { createAsyncLock } from "nova-ai/plugin-sdk/async-lock-runtime";
import {
  extractErrorCode,
  formatErrorMessage,
...
import { resolveStateDir } from "nova-ai/plugin-sdk/memory-core-host-runtime-core";
import { getRuntimeConfig } from "nova-ai/plugin-sdk/runtime-config-snapshot";
import { pathExists, replaceFileAtomic } from "nova-ai/plugin-sdk/security-runtime";
import {
  loadSessionStore,
  resolveStorePath,
  updateSessionStore,
...
const DIARY_START_MARKER = "<!-- nova-ai:dreaming:diary:start -->";
const DIARY_END_MARKER = "<!-- nova-ai:dreaming:diary:end -->";
const BACKFILL_ENTRY_MARKER = "nova-ai:dreaming:backfill-entry";
