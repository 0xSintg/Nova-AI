...
export type GatewayCfg = Nova AIConfig;

export type GatewayCfgLoader = () => Nova AIConfig;

export interface ActiveCfgProvider {
  getActiveCfg(): Nova AIConfig;
}

export interface ActiveCfgProviderOptions {
  fallback: Nova AIConfig;
...
function defaultGatewayCfgLoader(): Nova AIConfig {
