...
import { coerceSecretRef, normalizeSecretInputString } from "nova-ai/plugin-sdk/secret-input";
...
export function listQQBotAccountIds(cfg: Nova AIConfig): string[] {
  return listAccountIds(cfg as unknown as Record<string, unknown>);
}

/** Resolve the default QQBot account ID. */
export function resolveDefaultQQBotAccountId(cfg: Nova AIConfig): string {
...
/** Apply account config updates back into the Nova AI config object. */
