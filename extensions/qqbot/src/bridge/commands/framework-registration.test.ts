...
function registerCommands(): Nova AIPluginCommandDefinition[] {
  ensurePlatformAdapter();
  const commands: Nova AIPluginCommandDefinition[] = [];
  const api = {
    logger: {},
    registerCommand: (command: Nova AIPluginCommandDefinition) => {
...
function findCommand(
  commands: Nova AIPluginCommandDefinition[],
  name: string,
): Nova AIPluginCommandDefinition {
