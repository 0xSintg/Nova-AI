...
import { resolveConfiguredCapabilityProvider } from "nova-ai/plugin-sdk/provider-selection-runtime";
import type { TalkEvent } from "nova-ai/plugin-sdk/realtime-voice";
...
export class VoiceCallWebhookServer {
  ...
  private fullConfig: Nova AIConfig | null;
  ...
  private async initializeMediaStreaming(): Promise<void> {
    ...
    const pluginConfig =
      this.fullConfig ?? (this.coreConfig as unknown as Nova AIConfig | undefined);
    ...
    const resolution = resolveConfiguredCapabilityProvider({
      ...
      cfg: pluginConfig,
      cfgForResolve: pluginConfig ?? ({} as Nova AIConfig),
    ...
    const streamConfig: MediaStreamConfig = {
      ...
      providerConfig,
      cfg: this.fullConfig ?? (this.coreConfig as Nova AIConfig | null) ?? undefined,
