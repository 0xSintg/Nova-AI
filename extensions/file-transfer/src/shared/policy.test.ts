...
// without touching ~/.nova-ai/nova-ai.json.
...
vi.mock("nova-ai/plugin-sdk/config-mutation", () => ({
...
afterAll(() => {
  vi.doUnmock("nova-ai/plugin-sdk/runtime-config-snapshot");
  vi.doUnmock("nova-ai/plugin-sdk/config-mutation");
  vi.resetModules();
});
