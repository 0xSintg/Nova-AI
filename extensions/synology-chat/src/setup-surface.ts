...
function getChannelConfig(cfg: Nova AIConfig): SynologyChatChannelConfig {
  return (cfg.channels?.[channel] as SynologyChatChannelConfig | undefined) ?? {};
}

function getRawAccountConfig(cfg: Nova AIConfig, accountId: string): SynologyChatAccountRaw {
...
function isSynologyChatConfigured(cfg: Nova AIConfig, accountId: string): boolean {
...
function resolveExistingAllowedUserIds(cfg: Nova AIConfig, accountId: string): string[] {
