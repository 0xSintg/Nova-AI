...
import { resolveDangerousNameMatchingEnabled } from "nova-ai/plugin-sdk/dangerous-name-runtime";
import type {
...
/** Extract the channel config from the full Nova AI config object. */
function getChannelConfig(cfg: Nova AIConfig): SynologyChatChannelConfig | undefined {
 ...
 */
export function listAccountIds(cfg: Nova AIConfig): string[] {
...
export function resolveAccount(
  ...
  const envBotName = process.env.NOVA_AI_BOT_NAME ?? "Nova AI";
