import { DEFAULT_ACCOUNT_ID, type Nova AIConfig } from "nova-ai/plugin-sdk/account-resolution";
import { registerPluginHttpRoute } from "nova-ai/plugin-sdk/webhook-ingress";
