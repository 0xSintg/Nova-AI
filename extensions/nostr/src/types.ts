...
import { normalizeSecretInputString, type SecretInput } from "nova-ai/plugin-sdk/secret-input";
...
function resolveConfiguredDefaultNostrAccountId(cfg: Nova AIConfig): string | undefined {
 ...
 */
export function listNostrAccountIds(cfg: Nova AIConfig): string[] {
  const nostrCfg = (cfg.channels as Record<string, unknown> | undefined)?.nostr as
    | NostrAccountConfig
    | undefined;
 ...
 */
export function resolveDefaultNostrAccountId(cfg: Nova AIConfig): string {
