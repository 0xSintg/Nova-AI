...
import { patchTopLevelChannelConfigSection } from "nova-ai/plugin-sdk/setup";
import {
...
function getNostrConfig(cfg: Nova AIConfig): NostrAccountConfig | undefined {
  return (cfg.channels as Record<string, unknown> | undefined)?.nostr as
    | NostrAccountConfig
    | undefined;
}

function listSetupNostrAccountIds(cfg: Nova AIConfig): string[] {
...
function resolveDefaultSetupNostrAccountId(cfg: Nova AIConfig): string {
