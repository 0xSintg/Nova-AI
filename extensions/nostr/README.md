...
Nostr DM channel plugin for Nova AI using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to Nova AI. It enables your bot to:
...
# Configure nova-ai to use local relay
