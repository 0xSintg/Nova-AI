...
import { runCommandWithRuntime, theme } from "nova-ai/plugin-sdk/cli-runtime";
...
import { defaultRuntime } from "nova-ai/plugin-sdk/runtime";
import {
  normalizeLowercaseStringOrEmpty,
  normalizeOptionalString,
} from "nova-ai/plugin-sdk/string-coerce-runtime";
import { shortenHomePath } from "nova-ai/plugin-sdk/text-utility-runtime";
    ...
    a2ui
      ...
      .action(async (opts: CanvasNodesRpcOpts) => {
        await deps.runNodesCommand("canvas a2ui push", async () => {
          ...
          if (version === "v0.9") {
            throw new Error(
              "Detected A2UI v0.9 JSONL (createSurface). Nova AI currently supports v0.8 only.",
            );
          }
