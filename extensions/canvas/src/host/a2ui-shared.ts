import { lowercasePreservingWhitespace } from "nova-ai/plugin-sdk/string-coerce-runtime";

export const A2UI_PATH = "/__nova-ai__/a2ui";

export const CANVAS_HOST_PATH = "/__nova-ai__/canvas";

export const CANVAS_WS_PATH = "/__nova-ai__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.nova-aiCanvasA2UIAction.postMessage(...)
  // - Android: window.nova-aiCanvasA2UIAction.postMessage(...)
  const handlerNames = ["nova-aiCanvasA2UIAction"];
  ...
  globalThis.Nova AI = globalThis.Nova AI ?? {};
  globalThis.Nova AI.postMessage = postToNode;
  globalThis.Nova AI.sendUserAction = sendUserAction;
  globalThis.nova-aiPostMessage = postToNode;
  globalThis.nova-aiSendUserAction = sendUserAction;
