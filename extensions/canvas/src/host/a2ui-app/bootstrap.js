...
import { themeContext } from "@nova-ai/a2ui-theme-context";
...
class Nova AIA2UIHost extends LitElement {
  static properties = {
    surfaces: { state: true },
  ...
  static styles = css`
    :host {
      ...
      padding: var(--nova-ai-a2ui-inset-top, 0px) var(--nova-ai-a2ui-inset-right, 0px)
        var(--nova-ai-a2ui-inset-bottom, 0px) var(--nova-ai-a2ui-inset-left, 0px);
    }
    ...
    #surfaces {
      ...
      height: 100%;
      overflow: auto;
      padding-bottom: var(--nova-ai-a2ui-scroll-pad-bottom, 0px);
    }
    ...
    .status {
      ...
      top: var(--nova-ai-a2ui-status-top, 12px);
      display: inline-flex;
      align-items: center;
      gap: 8px;
      padding: 8px 10px;
    ...
    .toast {
      ...
      left: 50%;
      transform: translateX(-50%);
      bottom: var(--nova-ai-a2ui-toast-bottom, 12px);
      display: inline-flex;
      align-items: center;
      gap: 8px;
      padding: 8px 10px;
    ...
    .empty {
      ...
      left: 50%;
      transform: translateX(-50%);
      top: var(--nova-ai-a2ui-empty-top, var(--nova-ai-a2ui-status-top, 12px));
      text-align: center;
      opacity: 0.8;
      padding: 10px 12px;
      pointer-events: none;
  ...
  connectedCallback() {
    ...
    globalThis.nova-aiA2UI = api;
    this.addEventListener("a2uiaction", (evt) => this.#handleA2UIAction(evt));
    this.#statusListener = (evt) => this.#handleActionStatus(evt);
    for (const eventName of ["nova-ai:a2ui-action-status"]) {
  ...
  #handleA2UIAction(evt) {
    ...
    globalThis["__nova-aiLastA2UIAction"] = userAction;

    const handler =
      globalThis.webkit?.messageHandlers?.nova-aiCanvasA2UIAction ??
      globalThis.nova-aiCanvasA2UIAction;
    if (handler?.postMessage) {
      try {
        // WebKit message handlers support structured objects; Android's JS interface expects strings.
        if (handler === globalThis.nova-aiCanvasA2UIAction) {
...
if (!customElements.get("nova-ai-a2ui-host")) {
  customElements.define("nova-ai-a2ui-host", Nova AIA2UIHost);
}
