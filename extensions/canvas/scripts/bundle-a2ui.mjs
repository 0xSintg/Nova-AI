...
async function main() {
  ...
  if (!hasA2uiPackage || !hasAppDir) {
    ...
    if (process.env.NOVA_AI_SPARSE_PROFILE || process.env.NOVA_AI_A2UI_SKIP_MISSING === "1") {
      console.error(
        "A2UI package missing; skipping bundle because NOVA_AI_A2UI_SKIP_MISSING=1 or NOVA_AI_SPARSE_PROFILE is set.",
      );
      return;
    }
