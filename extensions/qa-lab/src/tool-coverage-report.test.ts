...
describe("qa tool coverage report", () => {
  ...
  it("passes required Nova AI dynamic tool coverage when both runtimes exercise the tool", () => {
    const report = buildQaToolCoverageReport({
      scenarios: [
        makeScenario("tool-web-search", "web-search", {
          toolName: "web_search",
          toolCoverage: {
            bucket: "nova-ai-dynamic-integration",
            expectedLayer: "nova-ai-dynamic",
            capabilityLayer: "nova-ai-dynamic-direct",
            required: true,
          },
        }),
      ],
  ...
  it("fails required Nova AI dynamic tool coverage when a runtime skips the tool", () => {
    const report = buildQaToolCoverageReport({
      scenarios: [
        makeScenario("tool-web-search", "web-search", {
          toolName: "web_search",
  ...
  it("fails required Nova AI dynamic tool coverage when the fixture failure mode is preserved", () => {
    const report = buildQaToolCoverageReport({
      scenarios: [
        makeScenario("tool-web-search", "web-search", {
          toolName: "web_search",
