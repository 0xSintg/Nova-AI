...
const providerFilter = parseCsvFilter(process.env.NOVA_AI_LIVE_MUSIC_GENERATION_PROVIDERS);
const envModelMap = parseProviderModelMap(process.env.NOVA_AI_LIVE_MUSIC_GENERATION_MODELS);
