import { createClaimableDedupe } from "nova-ai/plugin-sdk/persistent-dedupe";
...
function evaluateMentionGateForMessage(params: { cfg: Nova AIConfig; threadRootId?: string }) {
...
describe("shouldUpdateMattermostDraftToolProgress", () => {
  type MattermostConfig = NonNullable<NonNullable<Nova AIConfig["channels"]>["mattermost"]>;
