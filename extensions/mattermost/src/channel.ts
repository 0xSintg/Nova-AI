...
import { createLoggedPairingApprovalNotifier } from "nova-ai/plugin-sdk/channel-pairing";
import { createRestrictSendersChannelSecurity } from "nova-ai/plugin-sdk/channel-policy";
import {
  attachChannelToResult,
  createAttachedChannelResultAdapter,
  type ChannelOutboundAdapter,
} from "nova-ai/plugin-sdk/channel-send-result";
import { createChannelDirectoryAdapter } from "nova-ai/plugin-sdk/directory-runtime";
import { buildPassiveProbedChannelStatusSummary } from "nova-ai/plugin-sdk/extension-shared";
import {
...
import { resolvePayloadMediaUrls, sendTextMediaPayload } from "nova-ai/plugin-sdk/reply-payload";
import { isPrivateNetworkOptInEnabled } from "nova-ai/plugin-sdk/ssrf-runtime";
import {
...
export const mattermostPlugin: ChannelPlugin<ResolvedMattermostAccount> = createChatChannelPlugin({
  ...
  pairing: {
    text: {
      ...
      message: "Nova AI: your access has been approved.",
