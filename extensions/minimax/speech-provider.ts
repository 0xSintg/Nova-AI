...
import { asFiniteNumber, asObject, trimToUndefined } from "nova-ai/plugin-sdk/speech-core";
import {
...
function resolveConfiguredPortalTtsBaseUrl(cfg: Nova AIConfig | undefined): string | undefined {
