...
import type { waitForTransportReady } from "nova-ai/plugin-sdk/transport-ready-runtime";
...
vi.mock("nova-ai/plugin-sdk/conversation-runtime", async (importOriginal) => {
  const actual = await importOriginal<typeof import("nova-ai/plugin-sdk/conversation-runtime")>();
  return {
    ...actual,
...
vi.mock("nova-ai/plugin-sdk/channel-inbound", async (importOriginal) => {
  const actual = await importOriginal<typeof import("nova-ai/plugin-sdk/channel-inbound")>();
  return {
    ...actual,
...
vi.mock("nova-ai/plugin-sdk/reply-runtime", async (importOriginal) => {
  const actual = await importOriginal<typeof import("nova-ai/plugin-sdk/reply-runtime")>();
  return {
    ...actual,
