...
function mergeSignalAccountConfig(cfg: Nova AIConfig, accountId: string): SignalAccountConfig {
...
export function listEnabledSignalAccounts(cfg: Nova AIConfig): ResolvedSignalAccount[] {
