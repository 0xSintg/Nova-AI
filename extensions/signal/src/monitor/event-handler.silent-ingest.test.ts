...
vi.mock("nova-ai/plugin-sdk/hook-runtime", async () => {
  const actual = await vi.importActual<typeof import("nova-ai/plugin-sdk/hook-runtime")>(
    "nova-ai/plugin-sdk/hook-runtime",
  );
  return {
    ...actual,
