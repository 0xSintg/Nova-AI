...
import { readProviderJsonArrayFieldResponse } from "nova-ai/plugin-sdk/provider-http";
import type { ModelDefinitionConfig } from "nova-ai/plugin-sdk/provider-model-shared";
import { SELF_HOSTED_DEFAULT_COST } from "nova-ai/plugin-sdk/provider-setup";
...
/** Discovers LLM models from LM Studio and maps them to Nova AI model definitions. */
