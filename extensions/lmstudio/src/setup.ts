...
import { withAgentModelAliases } from "nova-ai/plugin-sdk/provider-onboard";
import {
...
function stripLmstudioStoredAuthConfig(cfg: Nova AIConfig): Nova AIConfig {
...
function mergeDiscoveredLmstudioAllowlistEntries(params: {
  existing?: NonNullable<NonNullable<Nova AIConfig["agents"]>["defaults"]>["models"];
  discoveredModels: ModelDefinitionConfig[];
}) {
