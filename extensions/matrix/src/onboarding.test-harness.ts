import type { OutputRuntimeEnv } from "nova-ai/plugin-sdk/runtime";
import type { ChannelSetupWizardAdapter } from "nova-ai/plugin-sdk/setup";
...
export function createMatrixUpdateKeepCredentialsPrompter(params?: {
  ...
  return createMatrixWizardPrompter({
    ...
    text: {
      ...
      "Matrix device name (optional)": params?.deviceName ?? "Nova AI Gateway",
    },
    confirm: {
