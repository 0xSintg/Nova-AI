...
import { hasConfiguredSecretInput } from "nova-ai/plugin-sdk/secret-input-runtime";
...
export function resolveMatrixChannelConfig(cfg: Nova AIConfig): Record<string, unknown> | null {
