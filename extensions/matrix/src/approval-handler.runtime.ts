...
import { buildPluginApprovalResolvedReplyPayload } from "nova-ai/plugin-sdk/approval-runtime";
import type {
  ExecApprovalRequest,
...
// Nova AI Matrix custom event content for capable clients; body and reactions remain fallback.
const MATRIX_APPROVAL_METADATA_KEY = "com.nova-ai.approval" as const;
