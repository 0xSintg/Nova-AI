...
export type MatrixStreamingConfig = {
  ...
  progress?: import("nova-ai/plugin-sdk/channel-streaming").ChannelStreamingProgressConfig;
  preview?: {
...
export type CoreConfig = {
  ...
  session?: {
    store?: string;
    dmScope?: NonNullable<Nova AIConfig["session"]>["dmScope"];
  };
  messages?: {
    ackReaction?: string;
    ackReactionScope?: "group-mentions" | "group-all" | "direct" | "all" | "none" | "off";
  };
  secrets?: Nova AIConfig["secrets"];
  [key: string]: unknown;
};
