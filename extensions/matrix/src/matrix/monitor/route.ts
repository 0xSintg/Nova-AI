import { resolveConfiguredAcpBindingRecord } from "nova-ai/plugin-sdk/acp-binding-resolve-runtime";
...
import { getSessionBindingService } from "nova-ai/plugin-sdk/session-binding-runtime";
