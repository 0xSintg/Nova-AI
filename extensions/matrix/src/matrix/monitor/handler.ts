...
import { isDangerousNameMatchingEnabled } from "nova-ai/plugin-sdk/dangerous-name-runtime";
import { hasFinalInboundReplyDispatch } from "nova-ai/plugin-sdk/inbound-reply-dispatch";
import type { ChannelBotLoopProtectionFacts } from "nova-ai/plugin-sdk/inbound-reply-dispatch";
import { mergePairLoopGuardConfig } from "nova-ai/plugin-sdk/pair-loop-guard-runtime";
import { buildInboundHistoryFromEntries } from "nova-ai/plugin-sdk/reply-history";
import {
  buildTtsSupplementMediaPayload,
  getReplyPayloadTtsSupplement,
} from "nova-ai/plugin-sdk/reply-payload";
import type { GetReplyOptions } from "nova-ai/plugin-sdk/reply-runtime";
...
import { MATRIX_NOVA_AI_FINALIZED_PREVIEW_KEY } from "../send/types.js";
...
let acpBindingRuntimePromise:
  | Promise<typeof import("nova-ai/plugin-sdk/acp-binding-runtime")>
  | undefined;
let sessionBindingRuntimePromise:
  | Promise<typeof import("nova-ai/plugin-sdk/session-binding-runtime")>
  | undefined;
...
function loadAcpBindingRuntime(): Promise<
  typeof import("nova-ai/plugin-sdk/acp-binding-runtime")
> {
  acpBindingRuntimePromise ??= import("nova-ai/plugin-sdk/acp-binding-runtime");
  return acpBindingRuntimePromise;
}

function loadSessionBindingRuntime(): Promise<
  typeof import("nova-ai/plugin-sdk/session-binding-runtime")
> {
  sessionBindingRuntimePromise ??= import("nova-ai/plugin-sdk/session-binding-runtime");
...
function buildMatrixFinalizedPreviewContent(): Record<string, unknown> {
  return { [MATRIX_NOVA_AI_FINALIZED_PREVIEW_KEY]: true };
}
