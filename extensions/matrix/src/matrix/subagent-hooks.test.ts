import type { Nova AIPluginApi as MatrixEntryPluginApi } from "nova-ai/plugin-sdk/channel-entry-contract";
import {
...
vi.mock("nova-ai/plugin-sdk/conversation-binding-runtime", () => ({
