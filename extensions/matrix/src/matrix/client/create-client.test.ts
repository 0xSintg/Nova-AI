...
describe("createMatrixClient", () => {
  const storagePaths = {
    rootDir: "/tmp/nova-ai-matrix-create-client-test",
    storagePath: "/tmp/nova-ai-matrix-create-client-test/storage.json",
    recoveryKeyPath: "/tmp/nova-ai-matrix-create-client-test/recovery.key",
    idbSnapshotPath: "/tmp/nova-ai-matrix-create-client-test/idb.snapshot",
    metaPath: "/tmp/nova-ai-matrix-create-client-test/storage-meta.json",
    accountKey: "default",
  ...
  it("persists storage metadata by default", async () => {
    ...
    expect(MatrixClientMock).toHaveBeenCalledWith("https://matrix.example.org", "tok", {
      ...
      cryptoDatabasePrefix: "nova-ai-matrix-default-token-hash",
