...
import type { ModelDefinitionConfig } from "nova-ai/plugin-sdk/provider-onboard";
import { withFetchPreconnect } from "nova-ai/plugin-sdk/test-env";
...
describe("Ollama provider", () => {
  const createAgentDir = () => mkdtempSync(join(tmpdir(), "nova-ai-test-"));
  ...
  async function runOllamaCatalog(params: { config?: Nova AIConfig; env?: NodeJS.ProcessEnv }) {
