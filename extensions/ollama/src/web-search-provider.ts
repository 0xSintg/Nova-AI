...
import { resolveEnvApiKey } from "nova-ai/plugin-sdk/provider-auth-runtime";
import {
...
function resolveConfiguredOllamaWebSearchApiKey(config?: Nova AIConfig): string | undefined {
...
function resolveOllamaWebSearchApiKey(config?: Nova AIConfig): string | undefined {
  return resolveConfiguredOllamaWebSearchApiKey(config) ?? resolveEnvOllamaWebSearchApiKey();
}

function resolveOllamaWebSearchBaseUrl(config?: Nova AIConfig): string {
