...
import { buildApiKeyCredential } from "nova-ai/plugin-sdk/provider-auth";
import type {
...
export default definePluginEntry({
  ...
  register(api: Nova AIPluginApi) {
    ...
    const resolveCurrentPluginConfig = (config?: Nova AIConfig): OllamaPluginConfig => {
    ...
    api.registerProvider({
      ...
      buildUnknownModelHint: () =>
        ...
        'Set OLLAMA_API_KEY="ollama-local" (any value works) or run "nova-ai configure". ' +
        "See: https://docs.nova-ai.com/providers/ollama",
    });
  },
});
