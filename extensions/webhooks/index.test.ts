...
function createApi(params?: {
  pluginConfig?: Nova AIPluginApi["pluginConfig"];
  registerHttpRoute?: Nova AIPluginApi["registerHttpRoute"];
  logger?: Nova AIPluginApi["logger"];
}): Nova AIPluginApi {
...
function requireFirstRouteRegistration(mock: ReturnType<typeof vi.fn>) {
  ...
  return call[0] as Parameters<Nova AIPluginApi["registerHttpRoute"]>[0];
}
