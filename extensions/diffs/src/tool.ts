...
import { stringEnum } from "nova-ai/plugin-sdk/channel-actions";
...
import type { AnyAgentTool, Nova AIPluginApi, Nova AIPluginToolContext } from "../api.js";
...
function buildArtifactContext(
  context: Nova AIPluginToolContext | undefined,
