...
import { buildPluginConfigSchema } from "nova-ai/plugin-sdk/plugin-entry";
import { z } from "zod";
import type { Nova AIPluginConfigSchema } from "../api.js";
import {
...
export const diffsPluginConfigSchema: Nova AIPluginConfigSchema = {
