...
function resolveKimiBaseUrl(kimi?: KimiConfig, openClawConfig?: Nova AIConfig): string {
...
export async function executeKimiWebSearchProviderTool(
  ctx: { config?: Nova AIConfig; searchConfig?: SearchConfigRecord },
  ...
  if (!result.grounded) {
    return {
      ...
      provider: "kimi",
      model,
      docs: "https://docs.nova-ai.com/tools/kimi-search",
