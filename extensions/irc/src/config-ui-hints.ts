import type { ChannelConfigUiHint } from "nova-ai/plugin-sdk/core";

export const ircChannelConfigUiHints = {
  "": {
    label: "IRC",
    help: "IRC channel provider configuration and compatibility settings for classic IRC transport workflows. Use this section when bridging legacy chat infrastructure into Nova AI.",
  },
  dmPolicy: {
    label: "IRC DM Policy",
