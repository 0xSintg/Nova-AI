...
import { createWebSearchProviderContractFields } from "nova-ai/plugin-sdk/provider-web-search-config-contract";
...
export function createBraveWebSearchProvider(): WebSearchProviderPlugin {
  return {
    ...
    docsUrl: "https://docs.nova-ai.com/tools/brave-search",
    autoDetectOrder: 10,
