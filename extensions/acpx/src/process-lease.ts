...
export const NOVA_AI_ACPX_LEASE_ID_ENV = "NOVA_AI_ACPX_LEASE_ID";
export const NOVA_AI_GATEWAY_INSTANCE_ID_ENV = "NOVA_AI_GATEWAY_INSTANCE_ID";
export const NOVA_AI_ACPX_LEASE_ID_ARG = "--nova-ai-acpx-lease-id";
export const NOVA_AI_GATEWAY_INSTANCE_ID_ARG = "--nova-ai-gateway-instance-id";
...
export function withAcpxLeaseEnvironment(params: {
  ...
  return [
    "env",
    `${NOVA_AI_ACPX_LEASE_ID_ENV}=${quoteEnvValue(params.leaseId)}`,
    `${NOVA_AI_GATEWAY_INSTANCE_ID_ENV}=${quoteEnvValue(params.gatewayInstanceId)}`,
