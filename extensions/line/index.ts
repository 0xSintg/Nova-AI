import {
  ...
  type Nova AIPluginCommandDefinition,
  type Nova AIPluginApi,
} from "nova-ai/plugin-sdk/channel-entry-contract";

type RegisteredLineCardCommand = Nova AIPluginCommandDefinition;

let lineCardCommandPromise: Promise<RegisteredLineCardCommand> | null = null;

async function loadLineCardCommand(api: Nova AIPluginApi): Promise<RegisteredLineCardCommand> {
