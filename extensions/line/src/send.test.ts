...
vi.mock("nova-ai/plugin-sdk/plugin-config-runtime", () => ({
...
vi.mock("nova-ai/plugin-sdk/channel-activity-runtime", () => ({
...
describe("LINE send helpers", () => {
  ...
  afterAll(() => {
    ...
    vi.doUnmock("nova-ai/plugin-sdk/channel-activity-runtime");
