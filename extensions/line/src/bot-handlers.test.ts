...
vi.mock("nova-ai/plugin-sdk/channel-inbound", () => ({
  buildMentionRegexes: () => [],
  matchesMentionPatterns: () => false,
}));
vi.mock("nova-ai/plugin-sdk/channel-pairing", () => ({
...
vi.mock("nova-ai/plugin-sdk/command-auth", () => ({
...
vi.mock("nova-ai/plugin-sdk/runtime-group-policy", () => ({
...
vi.mock("nova-ai/plugin-sdk/reply-history", () => ({
...
vi.mock("nova-ai/plugin-sdk/routing", () => ({
...
describe("handleLineWebhookEvents", () => {
  ...
  afterAll(() => {
    vi.doUnmock("nova-ai/plugin-sdk/channel-inbound");
    vi.doUnmock("nova-ai/plugin-sdk/channel-pairing");
    vi.doUnmock("nova-ai/plugin-sdk/command-auth");
    vi.doUnmock("nova-ai/plugin-sdk/runtime-group-policy");
    vi.doUnmock("nova-ai/plugin-sdk/runtime-env");
    vi.doUnmock("nova-ai/plugin-sdk/reply-history");
    vi.doUnmock("nova-ai/plugin-sdk/routing");
    vi.doUnmock("nova-ai/plugin-sdk/conversation-runtime");
