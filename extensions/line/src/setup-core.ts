import type { ChannelSetupAdapter, Nova AIConfig } from "nova-ai/plugin-sdk/setup";
import { createSetupInputPresenceValidator } from "nova-ai/plugin-sdk/setup";
...
export function isLineConfigured(cfg: Nova AIConfig, accountId: string): boolean {
