...
import { buildMentionRegexes, matchesMentionPatterns } from "nova-ai/plugin-sdk/channel-inbound";
...
import { shouldComputeCommandAuthorized } from "nova-ai/plugin-sdk/command-auth-native";
import type { GroupPolicy, Nova AIConfig } from "nova-ai/plugin-sdk/config-contracts";
import {
  readChannelAllowFromStore,
  resolvePairingIdLabel,
  upsertChannelPairingRequest,
} from "nova-ai/plugin-sdk/conversation-runtime";
import { createClaimableDedupe, type ClaimableDedupe } from "nova-ai/plugin-sdk/persistent-dedupe";
import {
