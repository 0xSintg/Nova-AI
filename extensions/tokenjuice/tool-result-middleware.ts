...
} from "nova-ai/plugin-sdk/agent-harness";
import { createTokenjuiceNova AIEmbeddedExtension } from "./runtime-api.js";

type TokenjuiceToolResultHandler = (
  event: {
    toolName: string;
    input: Record<string, unknown>;
    content: Nova AIAgentToolResult["content"];
    details: unknown;
    isError?: boolean;
  },
  ctx: { cwd: string },
) => Promise<Partial<Nova AIAgentToolResult> | void> | Partial<Nova AIAgentToolResult> | void;
