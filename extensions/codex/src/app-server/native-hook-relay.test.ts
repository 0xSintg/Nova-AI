import type { NativeHookRelayRegistrationHandle } from "nova-ai/plugin-sdk/agent-harness-runtime";
          ...
          hooks: [
            {
              type: "command",
              command:
                "nova-ai hooks relay --provider codex --relay-id relay-1 --event pre_tool_use",
              timeout: 7,
              async: false,
              statusMessage: "Nova AI native hook relay",
            },
          ],
        },
      ],
          ...
          hooks: [
            {
              type: "command",
              command:
                "nova-ai hooks relay --provider codex --relay-id relay-1 --event post_tool_use",
              timeout: 7,
              async: false,
              statusMessage: "Nova AI native hook relay",
            },
          ...
          hooks: [
            {
              type: "command",
              command:
                "nova-ai hooks relay --provider codex --relay-id relay-1 --event permission_request",
              timeout: 7,
              async: false,
              statusMessage: "Nova AI native hook relay",
            },
          ...
          hooks: [
            {
              type: "command",
              command:
                "nova-ai hooks relay --provider codex --relay-id relay-1 --event before_agent_finalize",
              timeout: 7,
              async: false,
              statusMessage: "Nova AI native hook relay",
            },
...
function createRelay(options?: {
  ...
  return {
    ...
    commandForEvent: (event) =>
      `nova-ai hooks relay --provider codex --relay-id relay-1 --event ${event}`,
    renew: () => undefined,
