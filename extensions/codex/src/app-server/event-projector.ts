...
import { emitTrustedDiagnosticEvent } from "nova-ai/plugin-sdk/diagnostic-runtime";
...
export class CodexAppServerEventProjector {
  ...
  buildResult(
    ...
    // context for Nova AI history, search, and future harness switching.
    if (reasoningText) {
...
function shouldSuppressChannelProgressForItem(item: CodexThreadItem): boolean {
  ...
  // Dynamic Nova AI tool requests are emitted at the item/tool/call request
