...
describe("zalo outbound hosted media", () => {
  ...
  it("loads outbound media under Nova AI control and returns a hosted URL", async () => {
  ...
  it("creates hosted media storage with private filesystem permissions", async () => {
    ...
    const storageDir = join(resolvePreferredNova AITmpDir(), "nova-ai-zalo-outbound-media");
