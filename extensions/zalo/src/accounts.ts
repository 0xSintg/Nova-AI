...
function mergeZaloAccountConfig(cfg: Nova AIConfig, accountId: string): ZaloAccountConfig {
...
export function listEnabledZaloAccounts(cfg: Nova AIConfig): ResolvedZaloAccount[] {
