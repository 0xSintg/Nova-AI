...
import type { AnyAgentTool } from "nova-ai/plugin-sdk/agent-runtime";
import type { PluginTrustedToolPolicyRegistration } from "nova-ai/plugin-sdk/core";
...
async function makeTempDir(): Promise<string> {
  const dir = await fs.mkdtemp(path.join(os.tmpdir(), "nova-ai-skill-workshop-test-"));
  tempDirs.push(dir);
  return dir;
}
