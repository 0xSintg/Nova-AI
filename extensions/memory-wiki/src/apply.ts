...
const GENERATED_START = "<!-- nova-ai:wiki:generated:start -->";
const GENERATED_END = "<!-- nova-ai:wiki:generated:end -->";
const HUMAN_START = "<!-- nova-ai:human:start -->";
const HUMAN_END = "<!-- nova-ai:human:end -->";
