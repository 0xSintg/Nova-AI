...
import { resolveDefaultAgentId, resolveSessionAgentId } from "nova-ai/plugin-sdk/memory-host-core";
import { getActiveMemorySearchManager } from "nova-ai/plugin-sdk/memory-host-search";
import {
  extractTranscriptIdentityFromSessionsMemoryHit,
  loadCombinedSessionStoreForGateway,
  resolveTranscriptStemToSessionKeys,
} from "nova-ai/plugin-sdk/session-transcript-hit";
import {
  createAgentToAgentPolicy,
  createSessionVisibilityGuard,
  resolveEffectiveSessionToolsVisibility,
} from "nova-ai/plugin-sdk/session-visibility";
...
const AGENT_DIGEST_PATH = ".nova-ai-wiki/cache/agent-digest.json";
const CLAIMS_DIGEST_PATH = ".nova-ai-wiki/cache/claims.jsonl";
const RELATED_BLOCK_PATTERN =
  /<!-- nova-ai:wiki:related:start -->[\s\S]*?<!-- nova-ai:wiki:related:end -->/g;
