...
import { mapPluginConfigIssues } from "nova-ai/plugin-sdk/extension-shared";
import { buildPluginConfigSchema, z, type Nova AIPluginConfigSchema } from "../api.js";
...
export const memoryWikiConfigSchema: Nova AIPluginConfigSchema = memoryWikiConfigSchemaBase;
...
export function resolveDefaultMemoryWikiVaultPath(homedir = os.homedir()): string {
  return path.join(homedir, ".nova-ai", "wiki", "main");
}
