...
import { resolveDefaultAgentId } from "nova-ai/plugin-sdk/memory-host-core";
import type { Nova AIConfig, Nova AIPluginApi } from "../api.js";
...
type GatewayMethodContext = Parameters<
  Parameters<Nova AIPluginApi["registerGatewayMethod"]>[1]
>[0];
...
function resolveGatewayAgentId(
  ...
  appConfig: Nova AIConfig | undefined,
): string | undefined {
  return (
