...
import type { ProviderPlugin } from "nova-ai/plugin-sdk/provider-test-contracts";
...
vi.mock("nova-ai/plugin-sdk/provider-catalog-runtime", async () => {
  const actual = await vi.importActual<
    typeof import("nova-ai/plugin-sdk/provider-catalog-runtime")
  >("nova-ai/plugin-sdk/provider-catalog-runtime");
