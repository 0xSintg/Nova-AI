...
} from "nova-ai/plugin-sdk/image-generation";
import {
  parseOpenAiCompatibleImageResponse,
  toImageDataUrl,
} from "nova-ai/plugin-sdk/image-generation";
import { createSubsystemLogger } from "nova-ai/plugin-sdk/logging-core";
import { resolveClosestSize } from "nova-ai/plugin-sdk/media-generation-runtime";
import { extensionForMime } from "nova-ai/plugin-sdk/media-mime";
import {
...
import { resolveApiKeyForProvider } from "nova-ai/plugin-sdk/provider-auth-runtime";
import {
...
function shouldAllowPrivateImageEndpoint(req: {
  ...
  return process.env.NOVA_AI_QA_ALLOW_LOCAL_IMAGE_PROVIDER === "1";
}
...
function hasExplicitOpenAIDirectAuthConfig(cfg: Nova AIConfig | undefined): boolean {
...
function hasExplicitOpenAIDirectProviderConfig(cfg: Nova AIConfig | undefined): boolean {
