import { ensureModelAllowlistEntry } from "nova-ai/plugin-sdk/provider-onboard";
import {
...
export function applyOpenAIProviderConfig(cfg: Nova AIConfig): Nova AIConfig {
...
export function applyOpenAIConfig(cfg: Nova AIConfig): Nova AIConfig {
