...
import { isProviderApiKeyConfigured } from "nova-ai/plugin-sdk/provider-auth";
...
const SUPPORTED_DURATIONS_HINT = Symbol.for("nova-ai.videoGeneration.supportedDurations");
