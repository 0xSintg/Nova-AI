import { clearLiveCatalogCacheForTests } from "nova-ai/plugin-sdk/provider-catalog-shared";
import {
...
vi.mock("nova-ai/plugin-sdk/provider-http", async () => {
  const actual = await vi.importActual<typeof import("nova-ai/plugin-sdk/provider-http")>(
    "nova-ai/plugin-sdk/provider-http",
  );
  return {
    ...actual,
