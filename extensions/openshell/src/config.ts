...
import { buildPluginConfigSchema, type Nova AIPluginConfigSchema } from "nova-ai/plugin-sdk/core";
import {
...
export function createOpenShellPluginConfigSchema(): Nova AIPluginConfigSchema {
