...
import type { Nova AIPluginService } from "nova-ai/plugin-sdk/core";
import { listDevicePairing } from "nova-ai/plugin-sdk/device-bootstrap";
...
import { replaceFileAtomic } from "nova-ai/plugin-sdk/security-runtime";
...
export function createPairingNotifierService(api: Nova AIPluginApi): Nova AIPluginService {
...
export function registerPairingNotifierService(api: Nova AIPluginApi): void {
