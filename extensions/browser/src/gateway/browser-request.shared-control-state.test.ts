...
const mocks = vi.hoisted(() => ({
  runtimeConfig: {} as Nova AIConfig,
  runtimeSourceConfig: null as Nova AIConfig | null,
...
vi.mock("../browser/chrome.js", () => ({
  ...
  launchNova AIChrome: vi.fn(async () => {
    throw new Error("launch should not be needed for status");
  }),
  resolveNova AIUserDataDir: vi.fn(() => "/tmp/nova-ai-browser"),
