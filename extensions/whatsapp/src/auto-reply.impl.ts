export { HEARTBEAT_PROMPT, stripHeartbeatToken } from "nova-ai/plugin-sdk/reply-runtime";
export { HEARTBEAT_TOKEN, SILENT_REPLY_TOKEN } from "nova-ai/plugin-sdk/reply-runtime";
