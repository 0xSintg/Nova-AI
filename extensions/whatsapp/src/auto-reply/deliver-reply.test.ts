...
import { sleep } from "nova-ai/plugin-sdk/text-utility-runtime";
...
vi.mock("nova-ai/plugin-sdk/text-utility-runtime", async () => {
  const actual = await vi.importActual<typeof import("nova-ai/plugin-sdk/text-utility-runtime")>(
    "nova-ai/plugin-sdk/text-utility-runtime",
  );
  return {
    ...actual,
    sleep: vi.fn(async () => {}),
