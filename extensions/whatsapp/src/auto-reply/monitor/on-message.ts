import type { AckReactionHandle } from "nova-ai/plugin-sdk/channel-feedback";
import type { Nova AIConfig } from "nova-ai/plugin-sdk/config-contracts";
import type { getReplyFromConfig } from "nova-ai/plugin-sdk/reply-runtime";
import type { MsgContext } from "nova-ai/plugin-sdk/reply-runtime";
import { resolveAgentRoute } from "nova-ai/plugin-sdk/routing";
import { buildGroupHistoryKey } from "nova-ai/plugin-sdk/routing";
...
export function createWebOnMessageHandler(params: {
  ...
  replyLogger: ReturnType<(typeof import("nova-ai/plugin-sdk/runtime-env"))["getChildLogger"]>;
