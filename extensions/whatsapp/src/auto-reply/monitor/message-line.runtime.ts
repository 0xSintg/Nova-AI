...
} from "nova-ai/plugin-sdk/channel-envelope";

type WhatsAppMessagePrefixConfig = Nova AIConfig;
...
export function resolveMessagePrefix(
  ...
  return resolveIdentityNamePrefix(cfg, agentId) ?? opts?.fallback ?? "[nova-ai]";
}
