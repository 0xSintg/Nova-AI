...
import { formatInboundEnvelope } from "nova-ai/plugin-sdk/channel-envelope";
...
function makeCfg(storePath: string): Nova AIConfig {
  return {
...
function createHandlerForTest(opts: { cfg: Nova AIConfig; replyResolver: unknown }) {
