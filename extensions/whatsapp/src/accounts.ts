...
import type { DmPolicy, GroupPolicy, ReplyToMode } from "nova-ai/plugin-sdk/config-contracts";
import { resolveOAuthDir } from "nova-ai/plugin-sdk/state-paths";
...
export function listWhatsAppAuthDirs(cfg: Nova AIConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: Nova AIConfig): boolean {
...
export function resolveWhatsAppAuthDir(params: { cfg: Nova AIConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: Nova AIConfig): ResolvedWhatsAppAccount[] {
