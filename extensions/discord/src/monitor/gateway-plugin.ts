...
import type { DiscordAccountConfig } from "nova-ai/plugin-sdk/config-contracts";
import {
  captureWsEvent,
...
type ResolveDiscordGatewayIntentsParams = {
  intentsConfig?: import("nova-ai/plugin-sdk/config-contracts").DiscordIntentsConfig;
...
function createGatewayPlugin(params: {
  ...
  class Nova AIGatewayPlugin extends discordGateway.GatewayPlugin {
  ...
  return new Nova AIGatewayPlugin();
}
...
export function createDiscordGatewayPlugin(params: {
  ...
  return createGatewayPlugin({
    options: {
      ...
      intents,
      // Nova AI registers its own async interaction listener.
