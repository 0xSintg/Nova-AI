...
import * as pluginCommandsModule from "nova-ai/plugin-sdk/plugin-runtime";
import * as dispatcherModule from "nova-ai/plugin-sdk/reply-dispatch-runtime";
...
function createCommand(cfg: Nova AIConfig, discordConfig?: DiscordAccountConfig) {
...
async function runGuildSlashCommand(params?: {
  userId?: string;
  mutateConfig?: (cfg: Nova AIConfig) => void;
