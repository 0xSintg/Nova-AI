...
let conversationRuntimePromise:
  | Promise<typeof import("nova-ai/plugin-sdk/conversation-binding-runtime")>
  | undefined;

async function loadConversationRuntime() {
  conversationRuntimePromise ??= import("nova-ai/plugin-sdk/conversation-binding-runtime");
