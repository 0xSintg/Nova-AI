...
import { resolveChunkMode } from "nova-ai/plugin-sdk/reply-chunking";
...
let replyRuntimePromise: Promise<typeof import("nova-ai/plugin-sdk/reply-runtime")> | undefined;

async function loadReplyRuntime() {
  replyRuntimePromise ??= import("nova-ai/plugin-sdk/reply-runtime");
