...
import { danger, warn, type RuntimeEnv } from "nova-ai/plugin-sdk/runtime-env";
import { normalizeLowercaseStringOrEmpty } from "nova-ai/plugin-sdk/string-coerce-runtime";

export type GetPluginCommandSpecs =
  typeof import("nova-ai/plugin-sdk/plugin-runtime").getPluginCommandSpecs;

let pluginRuntimePromise: Promise<typeof import("nova-ai/plugin-sdk/plugin-runtime")> | undefined;

async function loadPluginRuntime() {
  const promise = pluginRuntimePromise ?? import("nova-ai/plugin-sdk/plugin-runtime");
