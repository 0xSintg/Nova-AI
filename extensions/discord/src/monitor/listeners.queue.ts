import { createSubsystemLogger, formatDurationSeconds } from "nova-ai/plugin-sdk/runtime-env";

export type DiscordListenerLogger = ReturnType<
  typeof import("nova-ai/plugin-sdk/runtime-env").createSubsystemLogger
>;
