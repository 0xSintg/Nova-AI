...
import { loadJsonFile, saveJsonFile } from "nova-ai/plugin-sdk/json-store";
import { normalizeAccountId, resolveAgentIdFromSessionKey } from "nova-ai/plugin-sdk/routing";
...
// registry.
const THREAD_BINDINGS_STATE_KEY = Symbol.for("nova-ai.discordThreadBindingsState");
