import type { ChannelRuntimeSurface } from "nova-ai/plugin-sdk/channel-contract";
import {
  listNativeCommandSpecsForConfig,
  listSkillCommandsForAgents,
} from "nova-ai/plugin-sdk/command-auth-native";
import type { Nova AIConfig, ReplyToMode } from "nova-ai/plugin-sdk/config-contracts";
import { createConnectedChannelStatusPatch } from "nova-ai/plugin-sdk/gateway-runtime";
import {
...
import { isVerbose, logVerbose, shouldLogVerbose, warn } from "nova-ai/plugin-sdk/runtime-env";
...
export async function monitorDiscordProvider(opts: MonitorDiscordOpts = {}) {
  ...
  try {
    ...
    const guildHistories = new Map<
      string,
      import("nova-ai/plugin-sdk/reply-history").HistoryEntry[]
    >();
