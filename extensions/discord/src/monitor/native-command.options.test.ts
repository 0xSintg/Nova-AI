...
let listNativeCommandSpecs: typeof import("nova-ai/plugin-sdk/command-auth").listNativeCommandSpecs;
...
function createNativeCommand(
  ...
  opts?: {
    cfg?: Nova AIConfig;
    discordConfig?: NonNullable<Nova AIConfig["channels"]>["discord"];
  },
  ...
  const baseCfg: Nova AIConfig = opts?.cfg ?? {};
  const discordConfig: NonNullable<Nova AIConfig["channels"]>["discord"] =
...
describe("createDiscordNativeCommand option wiring", () => {
  beforeAll(async () => {
    ({ listNativeCommandSpecs } = await import("nova-ai/plugin-sdk/command-auth"));
  ...
  it("returns no autocomplete choices for group DMs outside dm.groupChannels", async () => {
    ...
    } satisfies NonNullable<Nova AIConfig["channels"]>["discord"];
    const command = createNativeCommand("think", {
      cfg: {
        commands: {
          allowFrom: {
  ...
  it("truncates Discord command and option descriptions to Discord's limit", () => {
    ...
    const discordConfig = {} as NonNullable<Nova AIConfig["channels"]>["discord"];
