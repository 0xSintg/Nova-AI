...
vi.mock("nova-ai/plugin-sdk/channel-activity-runtime", async () => {
  const actual = await vi.importActual<
    typeof import("nova-ai/plugin-sdk/channel-activity-runtime")
  >("nova-ai/plugin-sdk/channel-activity-runtime");
  return {
    ...actual,
