...
import type { Nova AIConfig, TtsConfig } from "nova-ai/plugin-sdk/config-contracts";
import { parseTtsDirectives } from "nova-ai/plugin-sdk/speech";
...
function resolveVoiceTtsConfig(params: { cfg: Nova AIConfig; override?: TtsConfig }): {
  cfg: Nova AIConfig;
