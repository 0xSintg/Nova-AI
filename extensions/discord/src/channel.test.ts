...
function createCfg(): Nova AIConfig {
  return {
    channels: {
      discord: {
        enabled: true,
...
function resolveAccount(cfg: Nova AIConfig, accountId = "default"): ResolvedDiscordAccount {
  return discordPlugin.config.resolveAccount(cfg, accountId);
}

function startDiscordAccount(cfg: Nova AIConfig, accountId = "default") {
