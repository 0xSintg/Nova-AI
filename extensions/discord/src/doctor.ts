...
import { collectProviderDangerousNameMatchingScopes } from "nova-ai/plugin-sdk/runtime-doctor";
...
export function scanDiscordNumericIdEntries(cfg: Nova AIConfig): DiscordNumericIdHit[] {
...
export function maybeRepairDiscordNumericIds(
  cfg: Nova AIConfig,
  doctorFixCommand: string,
): { config: Nova AIConfig; changes: string[]; warnings?: string[] } {
...
function collectDiscordMutableAllowlistWarnings(cfg: Nova AIConfig): string[] {
