...
const DISCORD_COMPONENT_ENTRIES_KEY = Symbol.for("nova-ai.discord.componentEntries");
const DISCORD_MODAL_ENTRIES_KEY = Symbol.for("nova-ai.discord.modalEntries");
