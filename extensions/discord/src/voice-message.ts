...
import { unlinkIfExists } from "nova-ai/plugin-sdk/media-runtime";
import type { RetryRunner } from "nova-ai/plugin-sdk/retry-runtime";
import { writeExternalFileWithinRoot } from "nova-ai/plugin-sdk/security-runtime";
import { fetchWithSsrFGuard, type SsrFPolicy } from "nova-ai/plugin-sdk/ssrf-runtime";
...
async function generateWaveformFromPcm(filePath: string): Promise<string> {
  const tempDir = resolvePreferredNova AITmpDir();
