...
describe("discord config schema", () => {
  ...
  it("loads guild map and dm group settings", () => {
    ...
    expect(cfg.dm?.groupChannels).toEqual(["nova-ai-dm"]);
    ...
    expect(cfg.guilds?.["123"]?.slug).toBe("friends-of-nova-ai");
  ...
  it.each([
    ...
    },
    {
      ...
      config: { activity: "Live", activityUrl: "https://twitch.tv/nova-ai" },
    },
    {
