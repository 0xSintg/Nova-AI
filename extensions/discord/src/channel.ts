...
import { sleepWithAbort } from "nova-ai/plugin-sdk/runtime-env";
import {
...
import { resolveTargetsWithOptionalToken } from "nova-ai/plugin-sdk/target-resolver-runtime";
import {
...
function resolveDiscordStartupDelayMs(cfg: Nova AIConfig, accountId: string): number {
    ...
    base: {
      ...
      agentPrompt: {
        messageToolHints: () => [
          ...
          "- Forms: add `components.modal` (title, fields). Nova AI adds a trigger button and routes submissions as new messages.",
        ],
      },
      messaging: {
