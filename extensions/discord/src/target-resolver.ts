import type { DirectoryConfigParams } from "nova-ai/plugin-sdk/directory-runtime";
import { buildMessagingTarget, type MessagingTarget } from "nova-ai/plugin-sdk/messaging-targets";
