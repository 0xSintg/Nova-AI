...
// Deprecated compatibility surface for existing @nova-ai/discord/api.js consumers.
...
export { resolveOpenProviderRuntimeGroupPolicy as resolveDiscordRuntimeGroupPolicy } from "nova-ai/plugin-sdk/runtime-group-policy";
