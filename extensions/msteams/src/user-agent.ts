...
function resolveNova AIVersion(): string {
  try {
 ...
 * and appends the Nova AI version.
 *
 * Format: "teams.ts[apps]/<sdk-version> Nova AI/<nova-ai-version>"
 * Example: "teams.ts[apps]/2.0.5 Nova AI/2026.3.22"
 *
...
export function buildUserAgent(): string {
  ...
  cachedUserAgent = `teams.ts[apps]/${resolveTeamsSdkVersion()} Nova AI/${resolveNova AIVersion()}`;
  return cachedUserAgent;
}
