...
import { createTopLevelChannelConfigAdapter } from "nova-ai/plugin-sdk/channel-config-helpers";
import type {
  ChannelMessageActionAdapter,
  ChannelMessageToolDiscovery,
} from "nova-ai/plugin-sdk/channel-contract";
import { createChatChannelPlugin } from "nova-ai/plugin-sdk/channel-core";
import { createChannelMessageAdapterFromOutbound } from "nova-ai/plugin-sdk/channel-message";
...
const resolveMSTeamsChannelConfig = (cfg: Nova AIConfig) => ({
...
export const msteamsPlugin: ChannelPlugin<ResolvedMSTeamsAccount, ProbeMSTeamsResult> =
  createChatChannelPlugin({
    ...
    security: {
      collectWarnings: projectConfigWarningCollector<{ cfg: Nova AIConfig }>(
