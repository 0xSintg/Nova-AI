...
} from "nova-ai/plugin-sdk/speech";
...
async function resolveXaiAudioApiKey(
  ...
  throw new Error(
    "xAI credentials missing for TTS. Sign in with `nova-ai onboard --auth-choice xai-oauth`, or run `nova-ai onboard --auth-choice xai-api-key`, or set XAI_API_KEY.",
  );
}
