...
function readLegacyGrokFallbackAuth(cfg?: Nova AIConfig): XaiFallbackAuth | undefined {
...
function readLegacyGrokApiKeyResult(cfg?: Nova AIConfig): ConfiguredRuntimeApiKeyResolution {
  const search = cfg?.tools?.web?.search;
  if (!search || typeof search !== "object") {
    return { status: "missing" };
  }
...
export function resolveFallbackXaiAuth(cfg?: Nova AIConfig): XaiFallbackAuth | undefined {
...
export function resolveFallbackXaiApiKey(cfg?: Nova AIConfig): string | undefined {
