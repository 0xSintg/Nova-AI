...
>({
  ...
  resolveParams: (_cfg: Nova AIConfig, api) => ({
    providerId: "xai",
    api,
...
function pruneRetiredXaiBuiltinModels(cfg: Nova AIConfig): Nova AIConfig {
...
export function applyXaiProviderConfig(cfg: Nova AIConfig): Nova AIConfig {
...
export function applyXaiConfig(cfg: Nova AIConfig): Nova AIConfig {
