import { createProviderUsageFetch, makeResponse } from "nova-ai/plugin-sdk/test-env";
...
vi.mock("nova-ai/plugin-sdk/json-store", () => ({
  loadJsonFile: jsonStoreMocks.loadJsonFile,
  saveJsonFile: jsonStoreMocks.saveJsonFile,
}));

vi.mock("nova-ai/plugin-sdk/state-paths", () => ({
  resolveStateDir: () => "/tmp/nova-ai-state",
}));

import type { ProviderResolveDynamicModelContext } from "nova-ai/plugin-sdk/core";
...
describe("github-copilot token", () => {
  const cachePath = "/tmp/nova-ai-state/credentials/github-copilot.token.json";
