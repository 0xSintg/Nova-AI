...
import { getCachedLiveCatalogValue } from "nova-ai/plugin-sdk/provider-catalog-shared";
...
function applyCopilotDefaultModel(cfg: Nova AIConfig): Nova AIConfig {
...
export default definePluginEntry({
  ...
  register(api) {
    ...
    function resolveCurrentPluginConfig(config?: Nova AIConfig): GithubCopilotPluginConfig {
