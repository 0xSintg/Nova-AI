...
import { buildCopilotIdeHeaders } from "nova-ai/plugin-sdk/provider-auth";
import { resolveConfiguredSecretInputString } from "nova-ai/plugin-sdk/secret-input-runtime";
