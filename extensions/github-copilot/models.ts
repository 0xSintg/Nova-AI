...
import { buildCopilotIdeHeaders, COPILOT_INTEGRATION_ID } from "nova-ai/plugin-sdk/provider-auth";
...
import { normalizeModelCompat } from "nova-ai/plugin-sdk/provider-model-shared";
...
export function resolveCopilotForwardCompatModel(
  ...
  // by simply adding them to agents.defaults.models in nova-ai.json — no
