...
import { createProviderHttpError } from "nova-ai/plugin-sdk/provider-http";
import {
...
} from "nova-ai/plugin-sdk/provider-transport-runtime";
...
type GoogleTransportApi = CanonicalGoogleTransportApi | "nova-ai-google-generative-ai-transport";
...
const GOOGLE_GEMINI3_FIRST_RESPONSE_RETRY_ENV = "NOVA_AI_GOOGLE_GEMINI_FIRST_RESPONSE_RETRY_MS";
...
function normalizeGoogleTransportRouteApi(
  ...
  switch (api) {
    ...
    case "nova-ai-google-generative-ai-transport":
