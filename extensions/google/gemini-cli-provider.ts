...
import { buildOauthProviderAuthResult } from "nova-ai/plugin-sdk/provider-auth-result";
import type { ProviderPlugin } from "nova-ai/plugin-sdk/provider-model-shared";
import { fetchGeminiUsage } from "nova-ai/plugin-sdk/provider-usage";
...
export function registerGoogleGeminiCliProvider(api: Nova AIPluginApi) {
