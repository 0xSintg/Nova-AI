...
vi.mock("nova-ai/plugin-sdk/memory-core-host-engine-embeddings", async (importOriginal) => {
  const actual =
    await importOriginal<typeof import("nova-ai/plugin-sdk/memory-core-host-engine-embeddings")>();
  return {
    ...actual,
