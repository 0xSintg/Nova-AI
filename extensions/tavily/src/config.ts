...
export function resolveTavilySearchConfig(cfg?: Nova AIConfig): TavilySearchConfig {
...
export function resolveTavilyApiKey(cfg?: Nova AIConfig): string | undefined {
...
export function resolveTavilyBaseUrl(cfg?: Nova AIConfig): string {
  const search = resolveTavilySearchConfig(cfg);
  const configured =
