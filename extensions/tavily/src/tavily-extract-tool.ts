...
import type { Nova AIPluginToolContext } from "nova-ai/plugin-sdk/plugin-entry";
...
export function createTavilyExtractTool(api: Nova AIPluginApi, ctx?: TavilyToolConfigContext) {
  return {
    name: "tavily_extract",
