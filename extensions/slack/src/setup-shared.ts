...
import { patchChannelConfigForAccount } from "nova-ai/plugin-sdk/setup-runtime";
import { formatDocsLink } from "nova-ai/plugin-sdk/setup-tools";
import type { ResolvedSlackAccount } from "./accounts.js";
import type { Nova AIConfig } from "./channel-api.js";

export const SLACK_CHANNEL = "slack" as const;

export function buildSlackManifest(botName = "Nova AI") {
  const safeName = botName.trim() || "Nova AI";
  const manifest = {
    display_information: {
      name: safeName,
      description: `${safeName} connector for Nova AI`,
    },
    features: {
      bot_user: {
      ...
      assistant_view: {
        assistant_description: `${safeName} connects Slack assistant threads to Nova AI agents.`,
        suggested_prompts: [
          {
