...
import { buildApprovalPresentationFromActionDescriptors } from "nova-ai/plugin-sdk/approval-reply-runtime";
import type { ExecApprovalRequest } from "nova-ai/plugin-sdk/approval-runtime";
import type { Nova AIConfig } from "nova-ai/plugin-sdk/config-contracts";
import { logError } from "nova-ai/plugin-sdk/logging-core";
...
type SlackExecApprovalConfig = NonNullable<
  NonNullable<NonNullable<Nova AIConfig["channels"]>["slack"]>["execApprovals"]
>;
