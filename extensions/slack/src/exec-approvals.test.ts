...
function buildConfig(
  execApprovals?: NonNullable<NonNullable<Nova AIConfig["channels"]>["slack"]>["execApprovals"],
  channelOverrides?: Partial<NonNullable<NonNullable<Nova AIConfig["channels"]>["slack"]>>,
): Nova AIConfig {
  return {
    channels: {
      slack: {
