...
} from "nova-ai/plugin-sdk/allowlist-config-edit";
import { adaptScopedAccountAccessor } from "nova-ai/plugin-sdk/channel-config-helpers";
import {
...
} from "nova-ai/plugin-sdk/channel-send-result";
import {
  createChannelDirectoryAdapter,
  createRuntimeDirectoryLiveAdapter,
} from "nova-ai/plugin-sdk/directory-runtime";
import { createLazyRuntimeModule } from "nova-ai/plugin-sdk/lazy-runtime";
import { resolveOutboundSendDep } from "nova-ai/plugin-sdk/outbound-send-deps";
import { buildOutboundBaseSessionKey, type RoutePeer } from "nova-ai/plugin-sdk/routing";
import {
...
//
// `nova-ai/plugin-sdk/channel-policy` is intentionally NOT lazy here —
...
const EXTENSION_SHARED_MODULE_ID = "nova-ai/plugin-sdk/extension-shared";
const TARGET_RESOLVER_RUNTIME_MODULE_ID = "nova-ai/plugin-sdk/target-resolver-runtime";
  ...
  base: {
    ...
    actions: createSlackActions(SLACK_CHANNEL, {
      invoke: async (action, cfg, toolContext) =>
        ...
        )(action, cfg as Nova AIConfig, toolContext as SlackActionContext | undefined),
    }),
