import { resolveGlobalDedupeCache } from "nova-ai/plugin-sdk/dedupe-runtime";
 ...
 */
const SLACK_THREAD_PARTICIPATION_KEY = Symbol.for("nova-ai.slackThreadParticipation");
