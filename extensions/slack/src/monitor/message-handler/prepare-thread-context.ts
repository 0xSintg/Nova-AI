import { formatInboundEnvelope } from "nova-ai/plugin-sdk/channel-inbound";
import { runTasksWithConcurrency } from "nova-ai/plugin-sdk/concurrency-runtime";
import type { ContextVisibilityMode } from "nova-ai/plugin-sdk/config-contracts";
import { logVerbose } from "nova-ai/plugin-sdk/runtime-env";
import {
  filterSupplementalContextItems,
  shouldIncludeSupplementalContext,
} from "nova-ai/plugin-sdk/security-runtime";
...
export async function resolveSlackThreadContextData(params: {
  ...
  envelopeOptions: ReturnType<
    typeof import("nova-ai/plugin-sdk/channel-inbound").resolveEnvelopeFormatOptions
  >;
