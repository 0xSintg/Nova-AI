...
import { resolveDefaultAgentId } from "nova-ai/plugin-sdk/agent-runtime";
import { formatAllowlistMatchMeta } from "nova-ai/plugin-sdk/allow-from";
import type {
  Nova AIConfig,
  SlackReactionNotificationMode,
} from "nova-ai/plugin-sdk/config-contracts";
import type { SessionScope } from "nova-ai/plugin-sdk/config-contracts";
import type { DmPolicy, GroupPolicy } from "nova-ai/plugin-sdk/config-contracts";
import { resolveRuntimeConversationBindingRoute } from "nova-ai/plugin-sdk/conversation-runtime";
import { createDedupeCache } from "nova-ai/plugin-sdk/dedupe-runtime";
import type { HistoryEntry } from "nova-ai/plugin-sdk/reply-history";
...
export type SlackMonitorContext = {
  ...
  slashCommand: Required<import("nova-ai/plugin-sdk/config-contracts").SlackSlashCommandConfig>;
  textLimit: number;
