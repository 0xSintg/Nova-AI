...
vi.mock("nova-ai/plugin-sdk/channel-ingress-runtime", async () => {
  const actual = await vi.importActual<
    typeof import("nova-ai/plugin-sdk/channel-ingress-runtime")
  >("nova-ai/plugin-sdk/channel-ingress-runtime");
  return {
    ...actual,
