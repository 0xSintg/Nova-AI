...
vi.mock("nova-ai/plugin-sdk/channel-inbound", async () => {
  const actual = await vi.importActual<typeof import("nova-ai/plugin-sdk/channel-inbound")>(
    "nova-ai/plugin-sdk/channel-inbound",
  );
  return {
    ...actual,
