...
vi.mock("nova-ai/plugin-sdk/fetch-runtime", async () => {
  const actual = await vi.importActual<typeof import("nova-ai/plugin-sdk/fetch-runtime")>(
    "nova-ai/plugin-sdk/fetch-runtime",
  );
  return {
    ...actual,
