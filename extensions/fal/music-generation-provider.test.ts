import { expectExplicitMusicGenerationCapabilities } from "nova-ai/plugin-sdk/provider-test-contracts";
...
vi.mock("nova-ai/plugin-sdk/provider-http", async (importOriginal) => {
  const original = await importOriginal<typeof import("nova-ai/plugin-sdk/provider-http")>();
  return {
    ...original,
