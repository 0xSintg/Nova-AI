...
<p align="center">
    <picture>
        <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/nova-ai/nova-ai/main/docs/assets/nova-ai-logo-text-dark.svg">
        <img src="https://raw.githubusercontent.com/nova-ai/nova-ai/main/docs/assets/nova-ai-logo-text.svg" alt="Nova AI" width="500">
    </picture>
</p>
...
<p align="center">
  <a href="https://github.com/nova-ai/nova-ai/actions/workflows/ci.yml?branch=main"><img src="https://img.shields.io/github/actions/workflow/status/nova-ai/nova-ai/ci.yml?branch=main&style=for-the-badge" alt="CI status"></a>
  <a href="https://github.com/nova-ai/nova-ai/releases"><img src="https://img.shields.io/github/v/release/nova-ai/nova-ai?include_prereleases&style=for-the-badge" alt="GitHub release"></a>
  <a href="https://discord.gg/nova"><img src="https://img.shields.io/discord/1456350064065904867?label=Discord&logo=discord&logoColor=white&color=5865F2&style=for-the-badge" alt="Discord"></a>
  <a href="LICENSE"><img src="https://img.shields.io/badge/License-MIT-blue.svg?style=for-the-badge" alt="MIT License"></a>
</p>

**Nova AI** is a _personal AI assistant_ you run on your own devices.
...
[Website](https://nova-ai.com) · [Docs](https://docs.nova-ai.com) · [Vision](VISION.md) · [DeepWiki](https://deepwiki.com/nova-ai/nova-ai) · [Getting Started](https://docs.nova-ai.com/start/getting-started) · [Updating](https://docs.nova-ai.com/install/updating) · [Showcase](https://docs.nova-ai.com/start/showcase) · [FAQ](https://docs.nova-ai.com/help/faq) · [Onboarding](https://docs.nova-ai.com/start/wizard) · [Nix](https://github.com/nova-ai/nix-nova-ai) · [Docker](https://docs.nova-ai.com/install/docker) · [Discord](https://discord.gg/nova)

New install? Start here: [Getting started](https://docs.nova-ai.com/start/getting-started)

Preferred setup: run `nova-ai onboard` in your terminal.
Nova AI Onboard guides you step by step through setting up the gateway, workspace, channels, and skills. It is the recommended CLI setup path and works on **macOS, Linux, and Windows (via WSL2; strongly recommended)**.
  ...
  <tr>
    <td align="center" width="16.66%">
      <a href="https://openai.com/">
        <picture>
          <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/nova-ai/nova-ai/main/docs/assets/sponsors/openai-light.svg">
          <img src="https://raw.githubusercontent.com/nova-ai/nova-ai/main/docs/assets/sponsors/openai.svg" alt="OpenAI" height="28">
        </picture>
      </a>
    </td>
    <td align="center" width="16.66%">
      <a href="https://github.com/">
        <picture>
          <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/nova-ai/nova-ai/main/docs/assets/sponsors/github-light.svg">
          <img src="https://raw.githubusercontent.com/nova-ai/nova-ai/main/docs/assets/sponsors/github.svg" alt="GitHub" height="28">
        </picture>
      </a>
    </td>
    <td align="center" width="16.66%">
      <a href="https://www.nvidia.com/">
        <picture>
          <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/nova-ai/nova-ai/main/docs/assets/sponsors/nvidia.svg">
          <img src="https://raw.githubusercontent.com/nova-ai/nova-ai/main/docs/assets/sponsors/nvidia-dark.svg" alt="NVIDIA" height="28">
        </picture>
      </a>
    </td>
    <td align="center" width="16.66%">
      <a href="https://vercel.com/">
        <picture>
          <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/nova-ai/nova-ai/main/docs/assets/sponsors/vercel-light.svg">
          <img src="https://raw.githubusercontent.com/nova-ai/nova-ai/main/docs/assets/sponsors/vercel.svg" alt="Vercel" height="24">
        </picture>
      </a>
    </td>
    <td align="center" width="16.66%">
      <a href="https://blacksmith.sh/">
        <picture>
          <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/nova-ai/nova-ai/main/docs/assets/sponsors/blacksmith-light.svg">
          <img src="https://raw.githubusercontent.com/nova-ai/nova-ai/main/docs/assets/sponsors/blacksmith.svg" alt="Blacksmith" height="28">
        </picture>
      </a>
    </td>
    <td align="center" width="16.66%">
      <a href="https://www.convex.dev/">
        <picture>
          <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/nova-ai/nova-ai/main/docs/assets/sponsors/convex-light.svg">
          <img src="https://raw.githubusercontent.com/nova-ai/nova-ai/main/docs/assets/sponsors/convex.svg" alt="Convex" height="24">
        </picture>
      </a>
    </td>
  </tr>
...
Model note: while many providers and models are supported, prefer a current flagship model from the provider you trust and already use. See [Onboarding](https://docs.nova-ai.com/start/onboarding).
...
```bash
npm install -g nova-ai@latest
# or: pnpm add -g nova-ai@latest

nova-ai onboard --install-daemon
```

Nova AI Onboard installs the Gateway daemon (launchd/systemd user service) so it stays running.

## Quick start (TL;DR)

Runtime: **Node 24 (recommended) or Node 22.19+**.

Full beginner guide (auth, pairing, channels): [Getting started](https://docs.nova-ai.com/start/getting-started)

```bash
nova-ai onboard --install-daemon

nova-ai gateway --port 18789 --verbose

# Send a message
nova-ai message send --target +1234567890 --message "Hello from Nova AI"
...
nova-ai agent --message "Ship checklist" --thinking high
```

Upgrading? [Updating guide](https://docs.nova-ai.com/install/updating) (and run `nova-ai doctor`).

Models config + CLI: [Models](https://docs.nova-ai.com/concepts/models). Auth profile rotation + fallbacks: [Model failover](https://docs.nova-ai.com/concepts/model-failover).

## Security defaults (DM access)

Nova AI connects to real messaging surfaces. Treat inbound DMs as **untrusted input**.

Full security guide: [Security](https://docs.nova-ai.com/gateway/security)

Default behavior on Telegram/WhatsApp/Signal/iMessage/Microsoft Teams/Discord/Google Chat/Slack:

- **DM pairing** (`dmPolicy="pairing"` / `channels.discord.dmPolicy="pairing"` / `channels.slack.dmPolicy="pairing"`; legacy: `channels.discord.dm.policy`, `channels.slack.dm.policy`): unknown senders receive a short pairing code and the bot does not process their message.
- Approve with: `nova-ai pairing approve <channel> <code>` (then the sender is added to a local allowlist store).
- Public inbound DMs require an explicit opt-in: set `dmPolicy="open"` and include `"*"` in the channel allowlist (`allowFrom` / `channels.discord.allowFrom` / `channels.slack.allowFrom`; legacy: `channels.discord.dm.allowFrom`, `channels.slack.dm.allowFrom`).

Run `nova-ai doctor` to surface risky/misconfigured DM policies.

## Highlights

- **[Local-first Gateway](https://docs.nova-ai.com/gateway)** — single control plane for sessions, channels, tools, and events.
- **[Multi-channel inbox](https://docs.nova-ai.com/channels)** — WhatsApp, Telegram, Slack, Discord, Google Chat, Signal, iMessage, IRC, Microsoft Teams, Matrix, Feishu, LINE, Mattermost, Nextcloud Talk, Nostr, Synology Chat, Tlon, Twitch, Zalo, Zalo Personal, WeChat, QQ, WebChat, macOS, iOS/Android.
- **[Multi-agent routing](https://docs.nova-ai.com/gateway/configuration)** — route inbound channels/accounts/peers to isolated agents (workspaces + per-agent sessions).
- **[Voice Wake](https://docs.nova-ai.com/nodes/voicewake) + [Talk Mode](https://docs.nova-ai.com/nodes/talk)** — wake words on macOS/iOS and continuous voice on Android (ElevenLabs + system TTS fallback).
- **[Live Canvas](https://docs.nova-ai.com/platforms/mac/canvas)** — agent-driven visual workspace with [A2UI](https://docs.nova-ai.com/platforms/mac/canvas#canvas-a2ui).
- **[First-class tools](https://docs.nova-ai.com/tools)** — browser, canvas, nodes, cron, sessions, and Discord/Slack actions.
- **[Companion apps](https://docs.nova-ai.com/platforms/macos)** — macOS menu bar app + iOS/Android [nodes](https://docs.nova-ai.com/nodes).
- **[Onboarding](https://docs.nova-ai.com/start/wizard) + [skills](https://docs.nova-ai.com/tools/skills)** — onboarding-driven setup with bundled/managed/workspace skills.
...
- Before exposing anything remotely, read [Security](https://docs.nova-ai.com/gateway/security), [Sandboxing](https://docs.nova-ai.com/gateway/sandboxing), and [Configuration](https://docs.nova-ai.com/gateway/configuration).
...
- Architecture overview: [Architecture](https://docs.nova-ai.com/concepts/architecture)

## Docs by goal

- New here: [Getting started](https://docs.nova-ai.com/start/getting-started), [Onboarding](https://docs.nova-ai.com/start/wizard), [Updating](https://docs.nova-ai.com/install/updating)
- Channel setup: [Channels index](https://docs.nova-ai.com/channels), [WhatsApp](https://docs.nova-ai.com/channels/whatsapp), [Telegram](https://docs.nova-ai.com/channels/telegram), [Discord](https://docs.nova-ai.com/channels/discord), [Slack](https://docs.nova-ai.com/channels/slack)
- Apps + nodes: [macOS](https://docs.nova-ai.com/platforms/macos), [iOS](https://docs.nova-ai.com/platforms/ios), [Android](https://docs.nova-ai.com/platforms/android), [Nodes](https://docs.nova-ai.com/nodes)
- Config + security: [Configuration](https://docs.nova-ai.com/gateway/configuration), [Security](https://docs.nova-ai.com/gateway/security), [Sandboxing](https://docs.nova-ai.com/gateway/sandboxing)
- Remote + web: [Gateway](https://docs.nova-ai.com/gateway), [Remote access](https://docs.nova-ai.com/gateway/remote), [Tailscale](https://docs.nova-ai.com/gateway/tailscale), [Web surfaces](https://docs.nova-ai.com/web)
- Tools + automation: [Tools](https://docs.nova-ai.com/tools), [Skills](https://docs.nova-ai.com/tools/skills), [Cron jobs](https://docs.nova-ai.com/automation/cron-jobs), [Webhooks](https://docs.nova-ai.com/automation/webhook), [Gmail Pub/Sub](https://docs.nova-ai.com/automation/gmail-pubsub)
- Internals: [Architecture](https://docs.nova-ai.com/concepts/architecture), [Agent](https://docs.nova-ai.com/concepts/agent), [Session model](https://docs.nova-ai.com/concepts/session), [Gateway protocol](https://docs.nova-ai.com/reference/rpc)
- Troubleshooting: [Channel troubleshooting](https://docs.nova-ai.com/channels/troubleshooting), [Logging](https://docs.nova-ai.com/logging), [Docs home](https://docs.nova-ai.com)
...
Note: signed builds required for macOS permissions to stick across rebuilds (see [macOS Permissions](https://docs.nova-ai.com/platforms/mac/permissions)).

### iOS node (optional)

- Pairs as a node over the Gateway WebSocket (device pairing).
- Voice trigger forwarding + Canvas surface.
- Controlled via `nova-ai nodes …`.

Runbook: [iOS connect](https://docs.nova-ai.com/platforms/ios).

### Android node (optional)

- Pairs as a WS node via device pairing (`nova-ai devices ...`).
- Exposes Connect/Chat/Voice tabs plus Canvas, Camera, Screen capture, and Android device command families.
- Runbook: [Android connect](https://docs.nova-ai.com/platforms/android).
...
```bash
git clone https://github.com/nova-ai/nova-ai.git
cd nova-ai

pnpm install

# First run only (or after resetting local Nova AI config/workspace)
pnpm nova-ai setup
...
`pnpm nova-ai setup` writes the local config/workspace needed for `pnpm gateway:watch`. It is safe to re-run, but you normally only need it on first setup or after resetting local state. `pnpm gateway:watch` does not rebuild `dist/control-ui`, so rerun `pnpm ui:build` after `ui/` changes or use `pnpm ui:dev` when iterating on the Control UI. If you want this checkout to run onboarding directly, use `pnpm nova-ai onboard --install-daemon`.

Note: `pnpm nova-ai ...` runs TypeScript directly (via `tsx`). `pnpm build` produces `dist/` for running via Node / the packaged `nova-ai` binary, while `pnpm gateway:watch` rebuilds the runtime on demand during the dev loop.
...
Switch channels (git + npm): `nova-ai update --channel stable|beta|dev`.
Details: [Development channels](https://docs.nova-ai.com/install/development-channels).

## Agent workspace + skills

- Workspace root: `~/.nova-ai/workspace` (configurable via `agents.defaults.workspace`).
- Injected prompt files: `AGENTS.md`, `SOUL.md`, `TOOLS.md`.
- Skills: `~/.nova-ai/workspace/skills/<skill>/SKILL.md`.

## Configuration

Minimal `~/.nova-ai/nova-ai.json` (model + defaults):
...
[Full configuration reference (all keys + examples).](https://docs.nova-ai.com/gateway/configuration)

## Star History

[![Star History Chart](https://api.star-history.com/svg?repos=nova-ai/nova-ai&type=date&legend=top-left)](https://www.star-history.com/#nova-ai/nova-ai&type=date&legend=top-left)

## Molty

Nova AI was built for **Molty**, a space lobster AI assistant. 🦞
by Peter Steinberger and the community.

- [nova-ai.com](https://nova-ai.com)
- [soul.md](https://soul.md)
- [steipete.me](https://steipete.me)
- [@nova-ai](https://x.com/nova-ai)
