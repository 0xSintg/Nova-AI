...
describe("pairing setup code", () => {
  ...
  beforeEach(() => {
    vi.stubEnv("NOVA_AI_GATEWAY_TOKEN", "");
    vi.stubEnv("NOVA_AI_GATEWAY_PASSWORD", "");
    vi.stubEnv("NOVA_AI_GATEWAY_PORT", "");
  });
  ...
  it.each([
    ...
    {
      name: "uses NOVA_AI_GATEWAY_PASSWORD without resolving configured password SecretRef",
      auth: {
        mode: "password",
  ...
  it.each([
    ...
    },
    {
      ...
      options: {
        env: {
          NOVA_AI_GATEWAY_TOKEN: "new-token",
        },
