...
function openAIProviderUsesCustomBaseUrl(config: Nova AIConfig | undefined): boolean {
...
function configuredOpenAIAuthOrderStartsWithCodexProfile(config: Nova AIConfig | undefined) {
