...
function resolveAdaptiveReadMaxBytes(options?: Nova AIReadToolOptions): number {
...
export function createSandboxedReadTool(params: SandboxToolParams) {
  ...
  return createNova AIReadTool(base, {
...
export function createNova AIReadTool(
  base: AnyAgentTool,
  options?: Nova AIReadToolOptions,
): AnyAgentTool {
  return {
    ...base,
