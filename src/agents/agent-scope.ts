...
function findMutableAgentEntry(cfg: Nova AIConfig, agentId: string): AgentConfig | undefined {
...
export function resolveAgentModelPrimary(cfg: Nova AIConfig, agentId: string): string | undefined {
