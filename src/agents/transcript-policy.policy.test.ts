...
function createProviderRuntimeSmokeContext(): {
  ...
  delete env.NOVA_AI_BUNDLED_PLUGINS_DIR;
  delete env.NOVA_AI_SKIP_PROVIDERS;
  delete env.NOVA_AI_SKIP_CHANNELS;
  delete env.NOVA_AI_SKIP_CRON;
  delete env.NOVA_AI_TEST_MINIMAL_GATEWAY;
  return {
    config: {},
    env,
