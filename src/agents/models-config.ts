...
import { planNova AIModelsJson } from "./models-config.plan.js";
...
function resolveModelsConfigInput(config?: Nova AIConfig): {
  config: Nova AIConfig;
  sourceConfigForSecrets: Nova AIConfig;
} {
...
export async function ensureNova AIModelsJson(
  config?: Nova AIConfig,
