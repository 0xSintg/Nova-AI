...
import { resolveNova AIPluginToolInputs } from "./nova-ai-tools.plugin-context.js";
import { applyPluginToolDeliveryDefaults } from "./plugin-tool-delivery-defaults.js";
import type { AnyAgentTool } from "./tools/common.js";

describe("nova-ai plugin tool context", () => {
  it("forwards trusted requester sender identity", () => {
    const result = resolveNova AIPluginToolInputs({
      options: {
        config: {} as never,
