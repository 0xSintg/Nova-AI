...
describe("workspace bootstrap file caching", () => {
  ...
  beforeEach(async () => {
    ...
    workspaceDir = await makeTempWorkspace("nova-ai-bootstrap-cache-test-");
  });
  ...
  it("caches files independently by path", async () => {
    ...
    const workspace1 = await makeTempWorkspace("nova-ai-cache-test1-");
    const workspace2 = await makeTempWorkspace("nova-ai-cache-test2-");
