...
async function resolveContext(config: Nova AIConfig, sessionKey: string, workspaceDir: string) {
...
function createWorkSetupCommandConfig(scope: "agent" | "shared"): Nova AIConfig {
  return {
    agents: {
      defaults: {
        sandbox: {
