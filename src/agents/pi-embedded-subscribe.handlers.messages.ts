...
function isTranscriptOnlyNova AIAssistantMessage(message: AgentMessage | undefined): boolean {
...
export function handleMessageStart(
  ...
  if (msg?.role !== "assistant" || isTranscriptOnlyNova AIAssistantMessage(msg)) {
    return;
  }
