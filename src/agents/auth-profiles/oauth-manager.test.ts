...
const envSnapshot = captureEnv([
  ...
  "PI_CODING_AGENT_DIR",
  "NOVA_AI_OAUTH_DIR",
  "NOVA_AI_AUTH_PROFILE_SECRET_KEY",
]);
...
describe("createOAuthManager", () => {
  ...
  it("refreshes legacy oauthRef sidecar credentials and writes rotated tokens inline", async () => {
    ...
    tempDirs.push(tempRoot);
    process.env.NOVA_AI_STATE_DIR = tempRoot;
    process.env.NOVA_AI_OAUTH_DIR = path.join(tempRoot, "credentials");
