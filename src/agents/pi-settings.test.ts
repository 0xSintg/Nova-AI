...
describe("isSilentOverflowProneModel", () => {
  ...
  // nova-ai#75799 reporter's setup: an OpenAI-compatible in-house gateway
  ...
  // Nova AI's preemptive compaction continues to handle real overflow.
...
describe("applyPiAutoCompactionGuard", () => {
  // Direct repro of nova-ai#75799: pi-ai's silent-overflow detection misfires
  ...
  // state.messages intact; Nova AI's preemptive compaction continues to
