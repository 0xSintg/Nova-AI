...
function requireExecTool(tools: ReturnType<typeof createNova AICodingTools>) {
...
describe("Agent-specific exec tool defaults", () => {
  ...
  it("should apply agent-specific exec host defaults over global defaults", async () => {
    ...
    const mainTools = createNova AICodingTools({
      config: cfg,
      sessionKey: "agent:main:main",
    ...
    const helperTools = createNova AICodingTools({
      config: cfg,
