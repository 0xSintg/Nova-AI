...
function isCliAgentRuntime(runtime: string | undefined, cfg: Nova AIConfig | undefined): boolean {
...
function resolveImageFallbackDefaultProvider(cfg: Nova AIConfig | undefined): string {
