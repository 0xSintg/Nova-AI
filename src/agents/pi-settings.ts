...
export function resolveCompactionReserveTokensFloor(cfg?: Nova AIConfig): number {
...
export function resolveEffectiveCompactionMode(cfg?: Nova AIConfig): AgentCompactionMode {
 ...
 * before the provider call) when Nova AI or a plugin owns compaction:
 * `contextEngineInfo.ownsCompaction === true`, effective safeguard compaction,
 * or an active model that is silent-overflow-prone (nova-ai#75799).
