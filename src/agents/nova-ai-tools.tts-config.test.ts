...
import { testing, createNova AITools } from "./nova-ai-tools.js";
...
const mocks = vi.hoisted(() => {
  ...
  return {
    ...
    textToSpeech: vi.fn(async () => ({
      success: true,
      audioPath: "/tmp/nova-ai/tts-config-test.opus",
      provider: "microsoft",
...
vi.mock("./nova-ai-plugin-tools.js", () => ({
  resolveNova AIPluginToolsForOptions: () => [],
}));

vi.mock("./nova-ai-tools.nodes-workspace-guard.js", () => ({
...
describe("createNova AITools TTS config wiring", () => {
  beforeEach(() => {
...
describe("createNova AITools cron context wiring", () => {
  beforeEach(() => {
    mocks.createCronToolOptions.mockClear();
  });
