...
type SessionEventProcessor = {
  ...
  __nova-aiSessionEventWriteLockInstalled?: boolean;
};
...
type PromptReleaseStreamFn = ((...args: unknown[]) => unknown) & {
  __nova-aiSessionLockPromptReleaseInstalled?: boolean;
};

type LockableFunction = ((...args: unknown[]) => unknown) & {
  __nova-aiSessionWriteLockInstalled?: boolean;
};
...
function installLockableFunction(params: {
  ...
  if (typeof current !== "function" || current["__nova-aiSessionWriteLockInstalled"] === true) {
    return;
  }
  ...
  wrapped["__nova-aiSessionWriteLockInstalled"] = true;
...
export function installSessionEventWriteLock(params: {
  ...
  if (
    ...
    session["__nova-aiSessionEventWriteLockInstalled"] === true
  ) {
    return;
  }
  session["__nova-aiSessionEventWriteLockInstalled"] = true;
...
export function installPromptSubmissionLockRelease(params: {
  ...
  if (currentStreamFn["__nova-aiSessionLockPromptReleaseInstalled"] === true) {
    return;
  }
  ...
  wrappedStreamFn["__nova-aiSessionLockPromptReleaseInstalled"] = true;
