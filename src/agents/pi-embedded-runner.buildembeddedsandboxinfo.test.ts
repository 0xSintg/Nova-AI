...
function createSandboxContext(overrides?: Partial<SandboxContext>): SandboxContext {
  const base = {
    ...
    workspaceDir: "/tmp/nova-ai-sandbox",
    agentWorkspaceDir: "/tmp/nova-ai-workspace",
    workspaceAccess: "none",
    runtimeId: "nova-ai-sbx-test",
    runtimeLabel: "nova-ai-sbx-test",
    containerName: "nova-ai-sbx-test",
    ...
    browser: {
      ...
      containerName: "nova-ai-sbx-browser-test",
    },
