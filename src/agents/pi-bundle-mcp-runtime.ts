...
const SESSION_MCP_RUNTIME_MANAGER_KEY = Symbol.for("nova-ai.sessionMcpRuntimeManager");
...
function resolveSessionMcpRuntimeIdleTtlMs(cfg?: Nova AIConfig): number {
