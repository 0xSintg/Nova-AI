...
export function listAgentEntries(cfg: Nova AIConfig): AgentEntry[] {
...
export function listAgentIds(cfg: Nova AIConfig): string[] {
...
export function resolveDefaultAgentId(cfg: Nova AIConfig): string {
  const agents = listAgentEntries(cfg);
  if (agents.length === 0) {
    return DEFAULT_AGENT_ID;
  }
...
function resolveAgentEntry(cfg: Nova AIConfig, agentId: string): AgentEntry | undefined {
