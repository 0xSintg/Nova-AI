...
export function buildHeadlessExecApprovalDeniedMessage(params: {
  ...
  return [
    ...
    "Stricter values from tools.exec and ~/.nova-ai/exec-approvals.json both apply.",
    "Fix one of these:",
    ...
    'Tip: run "nova-ai doctor" and "nova-ai approvals get --gateway" to inspect the effective policy.',
  ].join("\n");
}
