...
export function hasConfiguredProviderModelRows(cfg: Nova AIConfig): boolean {
...
export function parseConfiguredModelVisibilityEntries(params: { cfg?: Nova AIConfig }): {
