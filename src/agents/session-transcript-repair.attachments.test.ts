...
describe("sanitizeToolCallInputs redacts sessions_spawn attachments", () => {
  it("replaces attachments[].content with __NOVA_AI_REDACTED__", () => {
        ...
        content: [
          {
            ...
            arguments: {
              task: "do thing",
              resumeSessionId: "__NOVA_AI_REDACTED__",
              streamTo: "__NOVA_AI_REDACTED__",
            },
          },
          {
            type: "toolUse",
