...
export const DEFAULT_SANDBOX_IMAGE = "nova-ai-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "nova-ai-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "nova-ai-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "nova-ai-sandbox-common:bookworm-slim";
...
export const DEFAULT_SANDBOX_BROWSER_PREFIX = "nova-ai-sbx-browser-";
export const DEFAULT_SANDBOX_BROWSER_NETWORK = "nova-ai-sandbox-browser";
