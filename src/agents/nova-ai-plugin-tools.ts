...
import {
  resolveNova AIPluginToolInputs,
  type Nova AIPluginToolOptions,
} from "./nova-ai-tools.plugin-context.js";
import { applyPluginToolDeliveryDefaults } from "./plugin-tool-delivery-defaults.js";
import type { AnyAgentTool } from "./tools/common.js";

type ResolveNova AIPluginToolsOptions = Nova AIPluginToolOptions & {
...
export function resolveNova AIPluginToolsForOptions(params: {
  options?: ResolveNova AIPluginToolsOptions;
  ...
  const resolveApiKeyForProvider = authProfileStore
    ...
    : undefined;
  const pluginToolInputs = resolveNova AIPluginToolInputs({
