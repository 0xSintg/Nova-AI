...
describe("loadMergedBundleMcpConfig", () => {
  it("lets Nova AI mcp.servers override bundle defaults while preserving raw transport shape", () => {
  ...
  it("maps Nova AI transports to downstream CLI types when requested", () => {
    expect(
