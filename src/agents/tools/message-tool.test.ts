...
type CreateNova AITools = typeof import("../nova-ai-tools.js").createNova AITools;
...
let createNova AITools: CreateNova AITools;
...
beforeAll(async () => {
  ...
  ({ createNova AITools } = await import("../nova-ai-tools.js"));
});
...
describe("message tool secret scoping", () => {
  ...
  it("forwards source reply delivery mode through createNova AITools", () => {
...
describe("message tool agent routing", () => {
  ...
  it("forwards agentThreadId through createNova AITools to the message tool", async () => {
    mockSendResult({ channel: "slack", to: "channel:C123" });
