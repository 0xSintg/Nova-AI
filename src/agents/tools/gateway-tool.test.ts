...
const {
  ...
  formatDoctorNonInteractiveHintMock: vi.fn(() => "Run: nova-ai doctor --non-interactive"),
...
describe("gateway tool restart continuation", () => {
  beforeEach(() => {
    ...
    formatDoctorNonInteractiveHintMock.mockReturnValue("Run: nova-ai doctor --non-interactive");
