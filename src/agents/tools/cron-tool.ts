...
export function createCronTool(opts?: CronToolOptions, deps?: CronToolDeps): AnyAgentTool {
  ...
  return {
    label: "Cron",
    name: "cron",
    ownerOnly: isNova AIOwnerOnlyCoreToolName("cron"),
...
Main cron => system events for heartbeat. Isolated cron => background task in \`nova-ai tasks\`.
    ...
    execute: async (_toolCallId, args) => {
      ...
      switch (action) {
        ...
        case "add": {
          ...
          // See: https://github.com/nova-ai/nova-ai/issues/11310
