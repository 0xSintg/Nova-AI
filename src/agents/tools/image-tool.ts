...
function hasExplicitDefaultPrimaryModel(cfg?: Nova AIConfig): boolean {
...
function pickMaxBytes(cfg?: Nova AIConfig, maxBytesMb?: number): number | undefined {
...
async function runImagePrompt(params: {
  ...
  const providerCfg: Nova AIConfig = effectiveCfg ?? {};
