...
export function coerceImageModelConfig(cfg?: Nova AIConfig): ImageModelConfig {
...
function findConfiguredImageModelMatches(params: { cfg?: Nova AIConfig; ref: string }): string[] {
