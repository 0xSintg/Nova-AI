...
// Keep the schema local to avoid a circular import through acp-spawn/nova-ai-tools.
...
function resolveAcpUnavailableMessage(opts?: { sandboxed?: boolean; config?: Nova AIConfig }) {
