...
function resolveWatchPaths(workspaceDir: string, config?: Nova AIConfig): string[] {
  const paths: string[] = [];
...
function resolveWatchTargets(workspaceDir: string, config?: Nova AIConfig): string[] {
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: Nova AIConfig }) {
