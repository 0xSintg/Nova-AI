...
export function isConfigPathTruthy(config: Nova AIConfig | undefined, pathStr: string): boolean {
...
const BUNDLED_SOURCES = new Set(["nova-ai-bundled"]);

function isBundledSkill(entry: SkillEntry): boolean {
  return BUNDLED_SOURCES.has(resolveSkillSource(entry.skill));
}

export function resolveBundledAllowlist(config?: Nova AIConfig): string[] | undefined {
