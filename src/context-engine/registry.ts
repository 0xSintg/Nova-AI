...
const LEGACY_SESSION_KEY_COMPAT = Symbol.for("nova-ai.contextEngine.sessionKeyCompat");
...
const CONTEXT_ENGINE_REGISTRY_STATE = Symbol.for("nova-ai.contextEngineRegistryState");
