...
async function writeDefaultConfigFile(config: Nova AIConfig): Promise<void> {
...
export async function setupCommand(
  ...
  runtime.log(`Next guided path: ${formatCliCommand("nova-ai onboard")}.`);
  runtime.log(
    `Next targeted changes: ${formatCliCommand("nova-ai configure")} for models, channels, Gateway, plugins, skills, and health checks.`,
  );
  runtime.log(`Add a chat channel later: ${formatCliCommand("nova-ai channels add")}.`);
}
