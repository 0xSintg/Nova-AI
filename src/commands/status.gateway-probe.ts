...
export async function resolveGatewayProbeAuthResolution(cfg: Nova AIConfig): Promise<{
  auth: {
    token?: string;
    password?: string;
  };
...
export async function resolveGatewayProbeAuth(cfg: Nova AIConfig): Promise<{
  token?: string;
  password?: string;
}> {
