...
vi.mock("./doctor-browser.js", () => ({
  detectLegacyNovaBrowserProfileResidue: vi.fn().mockResolvedValue(null),
  maybeArchiveLegacyNovaBrowserProfileResidue: vi.fn().mockResolvedValue({
    changes: [],
    warnings: [],
  }),
...
vi.mock("./doctor-platform-notes.js", () => ({
  ...
  noteMacStaleNova AIUpdateLaunchdJobs: vi.fn().mockResolvedValue(undefined),
