...
export function resetCleanupCommandMocks() {
  ...
  resolveCleanupPlanFromDisk.mockReturnValue({
    stateDir: "/tmp/.nova-ai",
    configPath: "/tmp/.nova-ai/nova-ai.json",
    oauthDir: "/tmp/.nova-ai/credentials",
    configInsideState: true,
    oauthInsideState: true,
    workspaceDirs: ["/tmp/.nova-ai/workspace"],
  });
  removePath.mockResolvedValue({ ok: true });
  listAgentSessionDirs.mockResolvedValue(["/tmp/.nova-ai/agents/main/sessions"]);
