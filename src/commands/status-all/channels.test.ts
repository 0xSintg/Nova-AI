      ...
      rows: [
        {
          ...
          state: "warn",
          detail:
            "plugin not installed - run nova-ai plugins install @nova-ai/feishu or nova-ai doctor --fix",
        },
      ],
      details: [],
    });
      ...
      rows: [
        {
          ...
          enabled: true,
          state: "warn",
          detail: "plugin load failed: dependency tree corrupted; run nova-ai doctor --fix",
        },
      ],
      details: [],
    });
