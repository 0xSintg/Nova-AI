...
describe("status-all format", () => {
  ...
  it("formats dashboard values consistently", () => {
    expect(formatStatusDashboardValue("https://nova-ai.local")).toBe("https://nova-ai.local");
  ...
  it("builds overview rows with shared ordering", () => {
    expect(
      buildStatusOverviewRows({
        ...
        dashboardValue: "https://nova-ai.local",
        ...
        middleRows: [{ Item: "Security", Value: "Run: nova-ai security audit --deep" }],
      ...
      { Item: "Dashboard", Value: "https://nova-ai.local" },
      ...
      { Item: "Security", Value: "Run: nova-ai security audit --deep" },
