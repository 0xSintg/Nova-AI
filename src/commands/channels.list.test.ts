...
describe("channels list", () => {
  ...
  it("default output shows configured official external channels when the plugin is missing", async () => {
    ...
    mocks.resolveMissingOfficialExternalChannelPluginRepairHint.mockReturnValue({
      ...
      channelId: "discord",
      label: "Discord",
      installSpec: "@nova-ai/discord",
      installCommand: "nova-ai plugins install @nova-ai/discord",
      doctorFixCommand: "nova-ai doctor --fix",
      repairHint:
        "Install the official external plugin with: nova-ai plugins install @nova-ai/discord, or run: nova-ai doctor --fix.",
    });
    mocks.readConfigFileSnapshot.mockResolvedValue({
      ...baseConfigSnapshot,
      config: {
    ...
    expect(output).toContain(
      "run nova-ai plugins install @nova-ai/discord or nova-ai doctor --fix",
    );
