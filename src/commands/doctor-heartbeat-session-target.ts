...
function resolveHeartbeatConfig(cfg: Nova AIConfig, agentId: string): HeartbeatConfig | undefined {
...
function listHeartbeatDoctorAgents(cfg: Nova AIConfig) {
 ...
 */
export function describeHeartbeatSessionTargetIssues(cfg: Nova AIConfig): string[] {
