...
export const UPDATE_IN_PROGRESS_ENV = "NOVA_AI_UPDATE_IN_PROGRESS";
export const UPDATE_POST_CORE_CONVERGENCE_ENV = "NOVA_AI_UPDATE_POST_CORE_CONVERGENCE";
 ...
 * `NOVA_AI_UPDATE_IN_PROGRESS` directly (`commands/doctor-update.ts`,
 ...
 * updaters set only `NOVA_AI_UPDATE_IN_PROGRESS`; they do not opt into the
