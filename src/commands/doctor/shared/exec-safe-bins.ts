...
function collectExecSafeBinScopes(cfg: Nova AIConfig): ExecSafeBinScopeRef[] {
...
export function scanExecSafeBinCoverage(cfg: Nova AIConfig): ExecSafeBinCoverageHit[] {
...
export function maybeRepairExecSafeBinProfiles(cfg: Nova AIConfig): {
