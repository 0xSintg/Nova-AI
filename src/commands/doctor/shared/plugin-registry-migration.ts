...
export const DISABLE_PLUGIN_REGISTRY_MIGRATION_ENV = "NOVA_AI_DISABLE_PLUGIN_REGISTRY_MIGRATION";
export const FORCE_PLUGIN_REGISTRY_MIGRATION_ENV = "NOVA_AI_FORCE_PLUGIN_REGISTRY_MIGRATION";
...
export type PluginRegistryInstallMigrationParams = LoadInstalledPluginIndexParams &
  InstalledPluginIndexStoreOptions & {
    ...
    readConfig?: () => Promise<Nova AIConfig> | Nova AIConfig;
  };
...
function listConfiguredChannelIds(config: Nova AIConfig): Set<string> {
...
function listConfiguredModelProviderIds(config: Nova AIConfig): Set<string> {
...
export async function migratePluginRegistryForInstall(
  ...
  const config = stripShippedPluginInstallConfigRecords(rawConfig) as Nova AIConfig;
