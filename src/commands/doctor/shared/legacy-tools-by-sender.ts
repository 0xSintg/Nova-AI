...
export function scanLegacyToolsBySenderKeys(cfg: Nova AIConfig): LegacyToolsBySenderKeyHit[] {
...
export function maybeRepairLegacyToolsBySenderKeys(cfg: Nova AIConfig): {
