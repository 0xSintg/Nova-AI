...
function resolveConfiguredCommandOwners(cfg: Nova AIConfig): string[] {
...
export function hasConfiguredCommandOwners(cfg: Nova AIConfig): boolean {
...
export function noteCommandOwnerHealth(cfg: Nova AIConfig): void {
  ...
  note(
    [
      ...
      `Fix: set commands.ownerAllowFrom to your channel user id, for example ${formatCliCommand("nova-ai config set commands.ownerAllowFrom '[\"telegram:123456789\"]'")}`,
