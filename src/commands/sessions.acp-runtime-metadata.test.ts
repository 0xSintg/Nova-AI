...
/**
 * Catalog #18 — `nova-ai sessions --json` reports `agentRuntime.id: "pi"` for
 ...
 *
 * Empirical observation from a deployed nova-ai container against a copilot
...
/**
 * Build a minimal `Nova AIConfig` that mirrors the deployed scenario:
 ...
 */
function buildConfigWithoutAgentRuntimePolicy(): Nova AIConfig {
  return {
    agents: {
      list: [
        {
