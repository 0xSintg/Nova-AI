...
import type {
  ...
  Nova AIPluginNodeInvokeTransportResult,
...
function createApprovalRuntime(params: {
  ...
  pluginId: string;
}): Nova AIPluginNodeInvokePolicyContext["approvals"] | undefined {
...
export async function applyPluginNodeInvokePolicy(params: {
  ...
  const invokeNode: Nova AIPluginNodeInvokePolicyContext["invokeNode"] = async (
    override = {},
