...
describe("resolvePinnedClientMetadata", () => {
  ...
  it.each([
    ["nova-ai-ios", "iOS 26.5.0", "iOS 26.4.2", "iPhone"],
    ["nova-ai-ios", "iPadOS 26.5.0", "iPadOS 26.4.2", "iPad"],
    ["nova-ai-ios", "iPadOS 26.5.0", "iOS 26.4.2", "iPad"],
    ["nova-ai-android", "Android 16", "Android 15", "Android"],
  ])(
