...
describe("gateway auth", () => {
  ...
  it("resolves token/password from NOVA_AI gateway env vars", () => {
    const auth = resolveGatewayAuth({
      authConfig: {},
      env: {
        NOVA_AI_GATEWAY_TOKEN: "env-token",
        NOVA_AI_GATEWAY_PASSWORD: "env-password",
  ...
  it("accepts password mode when env provides NOVA_AI_GATEWAY_PASSWORD", () => {
...
describe("trusted-proxy auth", () => {
  ...
  it.each([
    ...
    },
    {
      ...
      env: {
        NOVA_AI_GATEWAY_TOKEN: "shared-secret",
      } as NodeJS.ProcessEnv,
    },
