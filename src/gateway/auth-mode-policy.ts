...
export function hasAmbiguousGatewayAuthModeConfig(cfg: Nova AIConfig): boolean {
...
export function assertExplicitGatewayAuthModeWhenBothConfigured(cfg: Nova AIConfig): void {
