...
const resolveNova AIPackageRootSync = vi.hoisted(() => vi.fn((_params: unknown) => "/package"));
...
vi.mock("../infra/nova-ai-root.js", () => ({
  resolveNova AIPackageRootSync: (params: unknown) => resolveNova AIPackageRootSync(params),
}));
...
describe("prepareGatewayPluginBootstrap startup plugins", () => {
  beforeEach(() => {
    ...
    resolveNova AIPackageRootSync.mockClear().mockReturnValue("/package");
