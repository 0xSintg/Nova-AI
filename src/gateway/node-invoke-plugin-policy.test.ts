...
import type { Nova AIPluginNodeInvokePolicyContext } from "../plugins/types.js";
      ...
      nodeInvokePolicies: [
        {
          ...
          policy: {
            commands: ["demo.read"],
            handle: (ctx: Nova AIPluginNodeInvokePolicyContext) => ctx.invokeNode(),
          },
      ...
      nodeInvokePolicies: [
        {
          ...
          policy: {
            commands: ["demo.read"],
            handle: async (ctx: Nova AIPluginNodeInvokePolicyContext) => {
