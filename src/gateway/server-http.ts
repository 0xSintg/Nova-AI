        ...
        wss.handleUpgrade(req, socket, head, (ws) => {
          (
            ws as unknown as import("ws").WebSocket & {
              __nova-aiPreauthBudgetClaimed?: boolean;
              __nova-aiPreauthBudgetKey?: string;
            }
          )["__nova-aiPreauthBudgetKey"] = preauthBudgetKey;
