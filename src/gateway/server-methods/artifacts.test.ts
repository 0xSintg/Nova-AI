    ...
    mockedMessages([
      {
        ...
        __nova-ai: { seq: 2, runId: "run-global" },
      },
    ]);
    ...
    mockedMessages([
      {
        ...
        __nova-ai: { seq: 2, taskId: "task-global" },
      },
    ]);
    ...
    mockedMessages([
      {
        ...
        __nova-ai: { seq: 2, messageTaskId: "task-1" },
      },
    ]);
    const { calls, respond } = createResponder();
  ...
  it("resolves taskId queries through task status access and filters artifacts by messageTaskId", async () => {
    ...
    mockedMessages([
      ...
      },
      {
        ...
        __nova-ai: { seq: 3, messageTaskId: "task-2" },
      },
      {
        role: "assistant",
