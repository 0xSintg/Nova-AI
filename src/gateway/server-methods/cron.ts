...
function listConfiguredAnnounceChannelIds(cfg: Nova AIConfig): string[] {
...
function assertValidCronAnnounceDelivery(params: { cfg: Nova AIConfig; delivery?: CronDelivery }) {
...
function assertValidCronCreateDelivery(cfg: Nova AIConfig, jobCreate: CronJobCreate) {
