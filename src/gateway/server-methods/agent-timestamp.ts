 ...
 *
 * @see https://github.com/nova-ai/nova-ai/issues/3658
 */
...
/**
 * Build TimestampInjectionOptions from an Nova AIConfig.
 */
export function timestampOptsFromConfig(cfg: Nova AIConfig): TimestampInjectionOptions {
  return {
