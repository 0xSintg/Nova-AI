...
export function didSharedGatewayAuthChange(prev: Nova AIConfig, next: Nova AIConfig): boolean {
...
}): Promise<{ path: string; config: Nova AIConfig; queueFollowUp: () => void }> {
