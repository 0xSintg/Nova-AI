...
import type {
  ...
  Nova AIProviderIndexPluginInstall,
  Nova AIProviderIndexPlugin,
  Nova AIProviderIndexProviderAuthChoice,
  Nova AIProviderIndexProvider,
} from "./types.js";

const NOVA_AI_PROVIDER_INDEX_VERSION = 1;
...
function normalizeInstall(value: unknown): Nova AIProviderIndexPluginInstall | undefined {
  if (!isRecord(value)) {
    return undefined;
  }
...
function normalizePlugin(value: unknown): Nova AIProviderIndexPlugin | undefined {
  if (!isRecord(value)) {
    return undefined;
  }
...
function normalizeOnboardingScopes(
  value: unknown,
): Nova AIProviderIndexProviderAuthChoice["onboardingScopes"] | undefined {
...
function normalizeAssistantVisibility(
  value: unknown,
): Nova AIProviderIndexProviderAuthChoice["assistantVisibility"] | undefined {
...
function normalizeAuthChoice(params: {
  ...
  providerName: string;
  value: unknown;
}): Nova AIProviderIndexProviderAuthChoice | undefined {
...
function normalizeAuthChoices(params: {
  ...
  providerName: string;
  value: unknown;
}): readonly Nova AIProviderIndexProviderAuthChoice[] | undefined {
  if (!Array.isArray(params.value)) {
    return undefined;
  }
  const choices = params.value
    .map((value) => normalizeAuthChoice({ ...params, value }))
    .filter((choice): choice is Nova AIProviderIndexProviderAuthChoice => Boolean(choice));
...
function normalizeProvider(
  ...
  value: unknown,
): Nova AIProviderIndexProvider | undefined {
  if (!isRecord(value)) {
    return undefined;
  }
...
export function normalizeNova AIProviderIndex(value: unknown): Nova AIProviderIndex | undefined {
  if (!isRecord(value) || value.version !== NOVA_AI_PROVIDER_INDEX_VERSION) {
    return undefined;
  }
  if (!isRecord(value.providers)) {
    return undefined;
  }
  const providers: Record<string, Nova AIProviderIndexProvider> = {};
  ...
  return {
    version: NOVA_AI_PROVIDER_INDEX_VERSION,
