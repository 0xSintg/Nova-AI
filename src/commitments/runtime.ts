...
type CommitmentExtractionRuntime = {
  ...
  resolveDefaultModel?: (params: { cfg: Nova AIConfig; agentId?: string }) => ModelRef;
...
let queue: Array<Omit<CommitmentExtractionItem, "existingPending"> & { cfg?: Nova AIConfig }> = [];
...
async function hydrateBatch(
  batch: Array<Omit<CommitmentExtractionItem, "existingPending"> & { cfg?: Nova AIConfig }>,
