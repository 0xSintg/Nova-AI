...
type ExecToolConfig = NonNullable<NonNullable<Nova AIConfig["tools"]>["exec"]>;
...
async function loadSystemRunConfig(opts: HandleSystemRunInvokeOptions): Promise<Nova AIConfig> {
