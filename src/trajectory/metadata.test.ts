...
describe("trajectory metadata", () => {
  it("redacts harness argv and local paths with the support redaction rules", () => {
    ...
    process.argv = [
      "node",
      "/Users/tester/project/nova-ai.js",
      "--api-key",
      "super-secret",
      "--config=/Users/tester/.nova-ai/nova-ai.json",
    ];
    try {
      const metadata = buildTrajectoryRunMetadata({
        env: {
          HOME: "/Users/tester",
          NOVA_AI_STATE_DIR: "/Users/tester/.nova-ai",
        },
      ...
      expect(harness.invocation).toEqual([
        ...
        "--api-key",
        "<redacted>",
        "--config=$NOVA_AI_STATE_DIR/nova-ai.json",
      ]);
      expect(harness.entrypoint).toBe("~/project/nova-ai.js");
