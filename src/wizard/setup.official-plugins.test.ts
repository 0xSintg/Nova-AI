  ...
  it("installs selected optional official plugins through the shared onboarding installer", async () => {
    ...
    expect(multiselect).toHaveBeenCalledExactlyOnceWith({
      ...
      options: [
        ...
        },
        {
          value: "acpx",
          label: "ACPX Runtime",
          hint: "Nova AI ACP runtime backend",
        },
        {
          value: "diagnostics-otel",
          label: "Diagnostics OpenTelemetry",
          hint: "Nova AI diagnostics OpenTelemetry exporter",
        },
        {
          value: "diagnostics-prometheus",
          label: "Diagnostics Prometheus",
          hint: "Nova AI diagnostics Prometheus exporter",
        },
        {
          value: "diffs",
          label: "Diffs",
          hint: "Nova AI diff viewer plugin",
        },
        {
          value: "google-meet",
          label: "Google Meet",
          hint: "Nova AI Google Meet participant plugin",
        },
        {
          value: "lobster",
          label: "Lobster",
        ...
        },
        {
          ...
          hint: "Nova AI LanceDB-backed long-term memory plugin with auto-recall/capture",
        },
        {
          value: "openshell",
          label: "OpenShell Sandbox",
          hint: "Nova AI OpenShell sandbox backend",
        },
        {
          value: "voice-call",
          label: "Voice Call",
          hint: "Nova AI voice-call plugin",
        },
      ],
    });
    expect(ensureOnboardingPluginInstalled).toHaveBeenCalledExactlyOnceWith({
      ...
      entry: {
        ...
        label: "Diagnostics OpenTelemetry",
        description: "Nova AI diagnostics OpenTelemetry exporter",
        install: {
          clawhubSpec: "clawhub:@nova-ai/diagnostics-otel",
          npmSpec: "@nova-ai/diagnostics-otel",
          defaultChoice: "npm",
