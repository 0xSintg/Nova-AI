...
export const en = {
  ...
  wizard: {
    ...
    gateway: {
      ...
      plaintextPasswordHint: "Stores the password directly in Nova AI config",
    ...
    migration: {
      ...
      complete: "Migration complete. Run `nova-ai doctor` next.",
    ...
    plugins: {
      ...
      sensitiveField:
        '"{label}" is sensitive. Set it via:\n  nova-ai config set plugins.entries.{plugin}.config.{field} <value>\nor use the Web UI Settings page.',
    ...
    remote: {
      ...
      insecureRemoteUrl:
        "Use wss:// for remote hosts, or ws://127.0.0.1/localhost via SSH tunnel. Break-glass: NOVA_AI_ALLOW_INSECURE_PRIVATE_WS=1 for trusted private networks.",
      ...
      plaintextPasswordHint: "Stores the password directly in Nova AI config",
      plaintextPasswordLabel: "Enter password now",
      plaintextTokenHint: "Stores the token directly in Nova AI config",
    ...
    security: {
      ...
      beta: "Nova AI is a hobby project and still in beta. Expect sharp edges.",
      confirm:
        "I understand this is personal-by-default and shared/multi-user use requires lock-down. Continue?",
      hardeningRequired:
        "If you're not comfortable with security hardening and access control, don't run Nova AI.",
      learnMore: "Learn more",
      notMultitenant: "Nova AI is not a hostile multi-tenant boundary by default.",
      personalAgent: "By default, Nova AI is a personal agent: one trusted operator boundary.",
    ...
    skills: {
      ...
      docsLine: "Docs: https://docs.nova-ai.com/skills",
      enterEnv: "Enter {env}",
    ...
    nextcloudTalk: {
      ...
      helpInstallCommand:
        '2) Run: ./occ talk:bot:install "Nova AI" "<shared-secret>" "<webhook-url>" --feature webhook --feature response --feature reaction',
    ...
    whatsapp: {
      ...
      ownerNumberNote: "We need the sender/owner number so Nova AI can allowlist you.",
      ...
      separatePhoneLabel: "Separate phone just for Nova AI",
    ...
    irc: {
      ...
      nextStatusCommand: "Command: nova-ai channels status --probe",
    ...
    synologyChat: {
      ...
      incomingWebhookHelpReplies: "This is the URL Nova AI uses to send replies back to Chat.",
    ...
    signal: {
      ...
      multipleEntries: "Multiple entries: comma-separated.",
      nextLinkDevice: 'Link device with: signal-cli link -n "Nova AI"',
    ...
    twitch: {
      ...
      envPrompt: "Twitch env var NOVA_AI_TWITCH_ACCESS_TOKEN detected. Use env token?",
      ...
      helpEnvVars: "Env vars supported: NOVA_AI_TWITCH_ACCESS_TOKEN",
    ...
    channelsPrimer: {
      ...
      blurbs: {
        ...
        synologyChat: "Connect your Synology NAS Chat to Nova AI with full agent capabilities.",
    ...
    search: {
      ...
      configured: "configured",
      configureLaterHint: "Configure later with nova-ai configure --section web",
      docsLine: "Docs: {url}",
    ...
    finalize: {
      ...
      controlUiDocs: "Docs: https://docs.nova-ai.com/web/control-ui",
      dashboardCopyPaste: "Copy/paste this URL in a browser on this machine to control Nova AI.",
      dashboardLinkWithToken: "Dashboard link (with token): {url}",
      dashboardOpened: "Opened in your browser. Keep that tab to control Nova AI.",
      ...
      gatewayTokenStored:
        "Stored in: $NOVA_AI_CONFIG_PATH (default: ~/.nova-ai/nova-ai.json) under gateway.auth.token, or in NOVA_AI_GATEWAY_TOKEN.",
      ...
      outroDashboardLink: "Onboarding complete. Use the dashboard link above to control Nova AI.",
      outroDashboardOpened:
        "Onboarding complete. Dashboard opened; keep that tab to control Nova AI.",
      outroSeeded:
      ...
      restart: "Restart",
      securityReminder:
        "Running agents on your computer is risky — harden your setup: https://docs.nova-ai.com/security",
      ...
      webDocs: "Docs: https://docs.nova-ai.com/tools/web",
      ...
      whatNow: 'What now: https://nova-ai.com/showcase ("What People Are Building").',
      whatNowTitle: "What now",
      workspaceBackupTitle: "Workspace backup",
      workspaceDocs: "Docs: https://docs.nova-ai.com/concepts/agent-workspace",
