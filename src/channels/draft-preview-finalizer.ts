...
/**
 * @deprecated Use `LivePreviewFinalizerDraft` from `nova-ai/plugin-sdk/channel-message`.
 */
export type DraftPreviewFinalizerDraft<TId> = LivePreviewFinalizerDraft<TId>;

/**
 * @deprecated Use `LivePreviewFinalizerResult` from `nova-ai/plugin-sdk/channel-message`.
 */
...
/**
 * @deprecated Use `deliverFinalizableLivePreview` from `nova-ai/plugin-sdk/channel-message`.
 */
