...
/** @deprecated Use `channelRouteTargetsMatchExact` from `nova-ai/plugin-sdk/channel-route`. */
...
/** @deprecated Use `channelRouteTargetsShareConversation` from `nova-ai/plugin-sdk/channel-route`. */
