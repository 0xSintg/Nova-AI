...
export function listChannelMessageActions(cfg: Nova AIConfig): ChannelMessageActionName[] {
...
export function listChannelMessageCapabilities(cfg: Nova AIConfig): ChannelMessageCapability[] {
