...
export type ChannelMessageSendTextContext<TConfig = Nova AIConfig> = {
  cfg: TConfig;
  to: string;
  text: string;
...
export type ChannelMessageSendMediaContext<TConfig = Nova AIConfig> =
...
export type ChannelMessageSendPayloadContext<TConfig = Nova AIConfig> =
  ChannelMessageSendTextContext<TConfig> & {
...
export type ChannelMessageSendAttemptContext<TConfig = Nova AIConfig> =
...
export type ChannelMessageSendFailureContext<TConfig = Nova AIConfig> =
  ChannelMessageSendAttemptContext<TConfig> & {
    error: unknown;
    attemptToken?: unknown;
  };
...
export type ChannelMessageUnknownSendContext<TConfig = Nova AIConfig> = {
  cfg: TConfig;
  queueId: string;
  channel: string;
  to: string;
