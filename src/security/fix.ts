...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof Nova AIConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: Nova AIConfig; env: NodeJS.ProcessEnv }): {
  cfg: Nova AIConfig;
  changes: string[];
} {
