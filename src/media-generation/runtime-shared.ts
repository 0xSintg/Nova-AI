...
type CapabilityProviderCandidate = {
  ...
  isConfigured?: (ctx: { cfg?: Nova AIConfig; agentDir?: string }) => boolean;
};
...
function resolveCurrentDefaultProviderId(cfg?: Nova AIConfig): string {
...
function resolveAutoCapabilityFallbackRefs(params: {
  cfg: Nova AIConfig;
  agentDir?: string;
  listProviders: (cfg?: Nova AIConfig) => CapabilityProviderCandidate[];
}): string[] {
