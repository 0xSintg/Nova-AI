...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@nova-ai", { botUsername: "nova-ai" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@nova-ai args", {
        botUsername: "nova-ai",
      }),
    ).toBe("/help args");
    expect(
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "nova-ai" })).toBe(
      "/help@otherbot",
    );
  });
