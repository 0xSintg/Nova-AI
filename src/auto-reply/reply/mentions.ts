...
function resolveMentionPatterns(cfg: Nova AIConfig | undefined, agentId?: string): string[] {
  if (!cfg) {
    return [];
  }
...
export function buildMentionRegexes(cfg: Nova AIConfig | undefined, agentId?: string): RegExp[] {
