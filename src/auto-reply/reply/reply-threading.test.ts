...
const emptyCfg = {} as Nova AIConfig;
...
describe("resolveReplyToMode", () => {
  ...
  it("uses registered channel threading adapters for runtime reply-mode resolution", () => {
    ...
    expect(resolveReplyToMode({} as Nova AIConfig, "whatsapp", "work", "group")).toBe("first");
    expect(resolveReplyToMode({} as Nova AIConfig, "whatsapp", "default", "group")).toBe("all");
  });
});
