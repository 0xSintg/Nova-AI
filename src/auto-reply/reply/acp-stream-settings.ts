...
function resolveAcpStreamCoalesceIdleMs(cfg: Nova AIConfig): number {
...
function resolveAcpStreamMaxChunkChars(cfg: Nova AIConfig): number {
...
export function resolveAcpProjectionSettings(cfg: Nova AIConfig): AcpProjectionSettings {
