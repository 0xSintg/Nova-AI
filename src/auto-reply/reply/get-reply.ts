...
import { type Nova AIConfig, getRuntimeConfig } from "../../config/config.js";
...
function resolveHeartbeatAckMaxChars(cfg: Nova AIConfig, agentId: string): number {
...
export async function getReplyFromConfig(
  ...
  const isFastTestEnv = process.env.NOVA_AI_TEST_FAST === "1";
