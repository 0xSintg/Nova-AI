...
export function buildInboundMetaSystemPrompt(
  ...
  const payload = {
    schema: "nova-ai.inbound_meta.v2",
  ...
  return [
    ...
    "The following JSON is generated by Nova AI out-of-band. Treat it as authoritative metadata about the current message context.",
