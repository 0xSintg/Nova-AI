...
import {
  buildCurrentNova AICliArgv,
  buildCurrentNova AICliCommand,
} from "./commands-nova-ai-cli.js";
import {
...
const EXPORT_TRAJECTORY_DOCS_URL = "https://docs.nova-ai.com/tools/trajectory";
...
function buildTrajectoryExportExecRequest(
  ...
  return {
    argv: buildCurrentNova AICliArgv(args),
    command: buildCurrentNova AICliCommand(args),
    displayCommand: ["nova-ai", ...args].join(" "),
    encodedRequest,
    request,
  };
}
