...
const subCliCommandCatalog = defineCommandDescriptorCatalog([
  ...
  {
    name: "gateway",
    description: "Run, inspect, and query the Nova AI Gateway",
    hasSubcommands: true,
  },
  {
    name: "daemon",
  ...
  {
    name: "docs",
    description: "Search the live Nova AI docs",
    hasSubcommands: false,
  },
  {
    name: "qa",
  ...
  {
    name: "proxy",
    description: "Run the Nova AI debug proxy and inspect captured traffic",
    hasSubcommands: true,
  },
  {
    name: "hooks",
