    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["nova-ai", "Start Crestodian."],
          ["nova-ai crestodian", "Start Crestodian explicitly."],
          ['nova-ai crestodian -m "status"', "Run one status request."],
          [
            'nova-ai crestodian -m "set default model openai/gpt-5.2" --yes',
