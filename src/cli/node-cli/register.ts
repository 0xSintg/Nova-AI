    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          [
            "nova-ai node run --host 127.0.0.1 --port 18789",
            "Run the node host in the foreground.",
          ],
          ["nova-ai node status", "Check node host service status."],
          ["nova-ai node install", "Install the node host service."],
          ["nova-ai node start", "Start the installed node host service."],
          ["nova-ai node restart", "Restart the installed node host service."],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink("/cli/node", "docs.nova-ai.com/cli/node")}\n`,
    );
