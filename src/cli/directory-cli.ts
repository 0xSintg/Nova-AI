    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["nova-ai directory self --channel slack", "Show the connected account identity."],
          [
            'nova-ai directory peers list --channel slack --query "alice"',
            "Search contact/user IDs by name.",
          ],
          ["nova-ai directory groups list --channel discord", "List available groups/channels."],
          [
            "nova-ai directory groups members --channel discord --group-id <id>",
            "List members for a specific group.",
          ],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/directory",
          "docs.nova-ai.com/cli/directory",
        )}\n`,
    )
    .action(() => {
