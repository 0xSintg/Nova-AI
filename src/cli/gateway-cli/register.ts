      ...
      .addHelpText(
        ...
        () =>
          `\n${theme.heading("Examples:")}\n${formatHelpExamples([
            ["nova-ai gateway run", "Run the gateway in the foreground."],
            ["nova-ai gateway status", "Show service status plus connectivity/capability."],
            ["nova-ai gateway discover", "Find local and wide-area gateway beacons."],
            ["nova-ai gateway stability", "Show recent stability diagnostics."],
            ["nova-ai gateway call health", "Call a gateway RPC method directly."],
          ])}\n\n${theme.muted("Docs:")} ${formatDocsLink("/cli/gateway", "docs.nova-ai.com/cli/gateway")}\n`,
      ),
  );
