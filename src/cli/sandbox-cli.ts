...
const SANDBOX_EXAMPLES = {
  main: [
    ["nova-ai sandbox list", "List all sandbox containers."],
    ["nova-ai sandbox list --browser", "List only browser containers."],
    ["nova-ai sandbox recreate --all", "Recreate all containers."],
    ["nova-ai sandbox recreate --session main", "Recreate a specific session."],
    ["nova-ai sandbox recreate --agent mybot", "Recreate agent containers."],
    ["nova-ai sandbox explain", "Explain effective sandbox config."],
  ],
  list: [
    ["nova-ai sandbox list", "List all sandbox containers."],
    ["nova-ai sandbox list --browser", "List only browser containers."],
  ...
  recreate: [
    ["nova-ai sandbox recreate --all", "Recreate all containers."],
    ["nova-ai sandbox recreate --session main", "Recreate a specific session."],
    ["nova-ai sandbox recreate --agent mybot", "Recreate a specific agent (includes sub-agents)."],
    ["nova-ai sandbox recreate --browser --all", "Recreate only browser containers."],
    ["nova-ai sandbox recreate --all --force", "Skip confirmation."],
  ],
  explain: [
    ["nova-ai sandbox explain", "Show effective sandbox config."],
    ["nova-ai sandbox explain --session agent:main:main", "Explain a specific session."],
    ["nova-ai sandbox explain --agent work", "Explain an agent sandbox."],
    ["nova-ai sandbox explain --json", "JSON output."],
  ],
} as const;
...
export function registerSandboxCli(program: Command) {
  const sandbox = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/sandbox", "docs.nova-ai.com/cli/sandbox")}\n`,
    )
    .action(() => {
