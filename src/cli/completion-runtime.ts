...
export const COMPLETION_SKIP_PLUGIN_COMMANDS_ENV = "NOVA_AI_COMPLETION_SKIP_PLUGIN_COMMANDS";
...
function isCompletionProfileHeader(line: string): boolean {
  return line.trim() === "# Nova AI Completion";
}
...
function updateCompletionProfile(
  ...
  const block = `# Nova AI Completion\n${sourceLine}`;
 ...
 * Returns true if profile has `source <(nova-ai completion ...)` instead of cached file.
 */
...
export async function installCompletion(shell: string, yes: boolean, binName = "nova-ai") {
