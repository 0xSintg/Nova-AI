...
const LOCAL_MODEL_RUN_SYSTEM_PROMPT = "You are a personal assistant running inside Nova AI.";
...
function getAuthProfileIdsForProvider(cfg: Nova AIConfig, providerId: string): string[] {
...
export function registerCapabilityCli(program: Command) {
  ...
  const capability = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/infer", "docs.nova-ai.com/cli/infer")}\n`,
    );
