...
function resolveFetchConfig(config: Nova AIConfig): Record<string, unknown> | undefined {
...
function resolveSearchConfig(config: Nova AIConfig): Record<string, unknown> | undefined {
...
function getCapabilityWebSearchAutoDetectTargets(config: Nova AIConfig): CommandSecretTargetScope {
...
function getCapabilityWebFetchAutoDetectTargets(config: Nova AIConfig): CommandSecretTargetScope {
...
function isScopedChannelSecretTargetEntry(params: {
  ...
  return (
    ...
    params.entry.configFile === "nova-ai.json" &&
