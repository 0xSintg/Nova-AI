...
function addInstalledPluginToAllowlist(cfg: Nova AIConfig, pluginId: string): Nova AIConfig {
...
function removeInstalledPluginFromDenylist(cfg: Nova AIConfig, pluginId: string): Nova AIConfig {
  ...
  params.runtime.log(
    theme.warn(
      [
        ...
        "Run `nova-ai plugins doctor` for repair options.",
      ].join("\n"),
    ),
  );
}
