...
type RuntimeConfigMutationContext = {
  snapshot: import("../../config/types.nova-ai.js").ConfigFileSnapshot;
...
type RuntimeMutateConfigFileParams<T = void> = {
  ...
  mutate: (
    draft: import("../../config/types.nova-ai.js").Nova AIConfig,
    context: RuntimeConfigMutationContext,
  ) => Promise<T | void> | T | void;
};
type RuntimeReplaceConfigFileParams = {
  nextConfig: import("../../config/types.nova-ai.js").Nova AIConfig;
  baseHash?: string;
  afterWrite: RuntimeConfigAfterWrite;
  writeOptions?: RuntimeWriteConfigOptions;
};
...
export type PluginRuntimeCore = {
  ...
  config: {
    ...
    current: () => DeepReadonly<import("../../config/types.nova-ai.js").Nova AIConfig>;
    /**
     ...
     */
    loadConfig: () => import("../../config/types.nova-ai.js").Nova AIConfig;
    /**
     ...
     */
    writeConfigFile: (
      cfg: import("../../config/types.nova-ai.js").Nova AIConfig,
