...
import type { NovabotConfig, Nova AIConfig, Nova AISchemaType } from "../../plugin-sdk/index.js";
...
describe("plugin-sdk exports", () => {
  ...
  it("keeps deprecated root config type aliases aligned", () => {
    expectTypeOf<NovabotConfig>().toEqualTypeOf<Nova AIConfig>();
    expectTypeOf<Nova AISchemaType>().toEqualTypeOf<Nova AIConfig>();
  });
