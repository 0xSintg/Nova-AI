...
import type { Nova AIPluginService, Nova AIPluginServiceContext } from "./types.js";
...
function expectServiceLogger(ctx: Nova AIPluginServiceContext) {
...
function expectServiceContexts(
  contexts: Nova AIPluginServiceContext[],
  config: Parameters<typeof startPluginServices>[0]["config"],
) {
...
describe("startPluginServices", () => {
  ...
  it("starts services and stops them in reverse order", async () => {
    const starts: string[] = [];
    const stops: string[] = [];
    const contexts: Nova AIPluginServiceContext[] = [];
  ...
  it("grants internal diagnostics only to trusted diagnostics exporter services", async () => {
    ...
    const prometheusContexts: Nova AIPluginServiceContext[] = [];
    ...
    const officialInstallContexts: Nova AIPluginServiceContext[] = [];
    ...
    const untrustedContexts: Nova AIPluginServiceContext[] = [];
    ...
    const spoofedContexts: Nova AIPluginServiceContext[] = [];
