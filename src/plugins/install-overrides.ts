...
export const PLUGIN_INSTALL_OVERRIDES_ENV = "NOVA_AI_PLUGIN_INSTALL_OVERRIDES";
export const ALLOW_PLUGIN_INSTALL_OVERRIDES_ENV = "NOVA_AI_ALLOW_PLUGIN_INSTALL_OVERRIDES";
