...
import { loadNova AIPluginCliRegistry, loadNova AIPlugins } from "./loader.js";
import {
...
describe("plugin loader CLI metadata", () => {
  it.each([
    ...
    async ({ id, kind, error }) => {
      ...
      const registry = await loadNova AIPluginCliRegistry({
        cache: false,
        logger: {
          info: () => {},
          warn: () => {},
  ...
  register(api) {
    ...
    const registry = await loadNova AIPluginCliRegistry({
      env: { ...process.env, NOVA_AI_STATE_DIR: stateDir },
      logger: {
        info: () => {},
  ...
  it("uses the real channel entry in cli-metadata mode for CLI metadata capture", async () => {
    ...
    fs.writeFileSync(
      ...
      JSON.stringify(
        {
          name: "@nova-ai/cli-metadata-channel",
          nova-ai: { extensions: ["./index.cjs"], setupEntry: "./setup-entry.cjs" },
        },
        null,
        2,
      ),
...
module.exports = {
  ...
  it("skips bundled channel full entries that do not provide a dedicated cli-metadata entry", async () => {
    ...
    fs.writeFileSync(
      ...
      JSON.stringify(
        {
          name: "@nova-ai/bundled-skip-channel",
...
module.exports = {
  ...
  it("prefers bundled channel cli-metadata entries over full channel entries", async () => {
    ...
    fs.writeFileSync(
      ...
      JSON.stringify(
        {
          name: "@nova-ai/bundled-cli-channel",
          nova-ai: { extensions: ["./index.cjs"] },
        },
        null,
        2,
...
module.exports = {
  ...
  it("skips bundled non-channel full entries that do not provide a dedicated cli-metadata entry", async () => {
    ...
    fs.writeFileSync(
      ...
      JSON.stringify(
        {
          name: "@nova-ai/bundled-skip-provider",
          nova-ai: { extensions: ["./index.cjs"] },
        },
        null,
        2,
...
module.exports = {
  ...
  it("collects channel CLI metadata during full plugin loads", () => {
    ...
    fs.writeFileSync(
      ...
      JSON.stringify(
        {
          name: "@nova-ai/full-cli-metadata-channel",
          nova-ai: { extensions: ["./index.cjs"] },
        },
        null,
        2,
...
module.exports = {
  ...
  it("collects channel CLI metadata during discovery plugin loads", () => {
    ...
    fs.writeFileSync(
      ...
      JSON.stringify(
        {
          name: "@nova-ai/discovery-cli-metadata-channel",
          nova-ai: { extensions: ["./index.cjs"] },
        },
        null,
        2,
...
module.exports = {
  ...
  require("node:fs").writeFileSync(${JSON.stringify(runtimeMarker)}, "loaded", "utf-8");
    ...
    entry.register({
      ...
      runtime: {} as Nova AIPluginApi["runtime"],
