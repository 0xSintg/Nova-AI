...
const mocks = vi.hoisted(() => {
  ...
  return {
    discoverNova AIPlugins: vi.fn(() => ({ candidates: [], diagnostics: [] })),
...
vi.mock("./discovery.js", () => ({
  discoverNova AIPlugins: mocks.discoverNova AIPlugins,
}));
...
function createPluginRecord(
  ...
  return {
    ...
    hooks: [],
    source: `/tmp/${overrides.id}/nova-ai.plugin.json`,
...
describe("resolvePluginConfigContractsById", () => {
  beforeEach(() => {
    mocks.discoverNova AIPlugins.mockReset();
    mocks.discoverNova AIPlugins.mockReturnValue({ candidates: [], diagnostics: [] });
