...
import type { AnyAgentTool, Nova AIPluginApi } from "./types.js";
...
describe("captured plugin registration", () => {
  ...
  it("returns synthetic scheduled-turn ids independent of human-readable names", async () => {
    let scheduleSessionTurn: Nova AIPluginApi["scheduleSessionTurn"] | undefined;
    let registerSessionSchedulerJob: Nova AIPluginApi["registerSessionSchedulerJob"] | undefined;
    const captured = capturePluginRegistration({
