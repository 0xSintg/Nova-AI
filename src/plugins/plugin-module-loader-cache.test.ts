...
describe("getCachedPluginModuleLoader", () => {
  ...
  it("normalizes Windows absolute paths before creating and calling the source transformer", async () => {
    ...
    const loader = getCachedPluginModuleLoader({
      cache,
      modulePath: "C:\\Users\\alice\\nova-ai\\dist\\extensions\\feishu\\api.js",
      importerUrl: "file:///C:/Users/alice/nova-ai/dist/src/plugins/public-surface-loader.js",
    ...
    expectJitiOptions(
      createJiti,
      0,
      "file:///C:/Users/alice/nova-ai/dist/extensions/feishu/api.js",
      { tryNative: true },
    );
  ...
  it("skips the native-require fast path when tryNative is explicitly false", async () => {
    ...
    const loader = getCachedPluginModuleLoader({
      ...
      aliasMap: { "nova-ai/plugin-sdk": "/repo/shim.js" },
      tryNative: false,
      createLoader: asPluginModuleLoaderFactory(createJiti),
    });
  ...
  it("normalizes Windows absolute paths when native loading is disabled", async () => {
    ...
    const loader = getCachedPluginModuleLoader({
      cache,
      modulePath: "C:\\Users\\alice\\nova-ai\\extensions\\feishu\\api.ts",
      importerUrl: "file:///C:/Users/alice/nova-ai/src/plugins/loader.ts",
      loaderFilename: "C:\\Users\\alice\\nova-ai\\extensions\\feishu\\api.ts",
      tryNative: false,
      createLoader: asPluginModuleLoaderFactory(createJiti),
    });
    ...
    expect(nativeStub).not.toHaveBeenCalled();
    expectJitiOptions(createJiti, 0, "file:///C:/Users/alice/nova-ai/extensions/feishu/api.ts", {
      tryNative: false,
    });
    expect(fromSourceTransformer).toHaveBeenCalledWith(
      "file:///C:/Users/alice/nova-ai/extensions/feishu/api.ts",
    );
  });
