...
type LoadNova AIProviderIndex =
  typeof import("../model-catalog/index.js").loadNova AIProviderIndex;
...
const loadNova AIProviderIndex = vi.hoisted(() =>
  vi.fn<LoadNova AIProviderIndex>(() => ({ version: 1, providers: {} })),
);
...
describe("provider install catalog", () => {
  beforeEach(() => {
    vi.clearAllMocks();
    loadNova AIProviderIndex.mockReturnValue({ version: 1, providers: {} });
      ...
      plugins: [
        {
          pluginId: "openai",
          origin: "bundled",
          manifestPath: "/repo/extensions/openai/nova-ai.plugin.json",
          manifestHash: "hash",
          ...
          compat: [],
          packageName: "@nova-ai/openai",
          packageInstall: {
            defaultChoice: "npm",
            npm: {
              spec: "@nova-ai/openai@1.2.3",
              packageName: "@nova-ai/openai",
              selector: "1.2.3",
    ...
    loadPluginRegistrySnapshot.mockReturnValue({
      ...
      installRecords: {
        vllm: {
          source: "npm",
          spec: "@nova-ai/vllm",
          resolvedSpec: "@nova-ai/vllm@2.0.0",
      ...
      plugins: [
        {
          pluginId: "vllm",
          origin: "global",
          manifestPath: "/Users/test/.nova-ai/plugins/vllm/nova-ai.plugin.json",
          manifestHash: "hash",
          rootDir: "/Users/test/.nova-ai/plugins/vllm",
          enabled: true,
          startup: {
            sidecar: false,
            memory: false,
          ...
          compat: [],
          packageName: "@nova-ai/vllm",
          packageInstall: {
            npm: {
              spec: "@nova-ai/vllm-fork@1.0.0",
              packageName: "@nova-ai/vllm-fork",
              selector: "1.0.0",
              selectorKind: "exact-version",
              exactVersion: true,
  ...
  it("preserves durable ClawHub install records for provider setup reinstall hints", () => {
    loadPluginRegistrySnapshot.mockReturnValue({
      ...
      installRecords: {
        vllm: {
          source: "clawhub",
          spec: "clawhub:nova-ai/vllm@2026.5.2",
          integrity: "sha256-clawpack",
          clawhubPackage: "nova-ai/vllm",
        },
      },
      plugins: [
        {
    ...
    expect(resolveProviderInstallCatalogEntry("vllm")).toEqual({
      ...
      origin: "global",
      install: {
        clawhubSpec: "clawhub:nova-ai/vllm@2026.5.2",
      ...
      plugins: [
        {
          ...
          origin: "global",
          manifestPath: "/Users/test/.nova-ai/plugins/demo-provider/nova-ai.plugin.json",
          manifestHash: "hash",
          rootDir: "/Users/test/.nova-ai/plugins/demo-provider",
          enabled: true,
          startup: {
            sidecar: false,
            memory: false,
      ...
      plugins: [
        {
          pluginId: "demo-provider",
          origin: "workspace",
          manifestPath: "/repo/extensions/demo-provider/nova-ai.plugin.json",
          manifestHash: "hash",
  ...
  it("surfaces provider-index install metadata when the provider plugin is not installed", () => {
    loadNova AIProviderIndex.mockReturnValue({
      version: 1,
      providers: {
        moonshot: {
          id: "moonshot",
          ...
          plugin: {
            id: "moonshot",
            package: "@nova-ai/plugin-moonshot",
            install: {
              npmSpec: "@nova-ai/plugin-moonshot@1.2.3",
              defaultChoice: "npm",
    ...
    expect(resolveProviderInstallCatalogEntry("moonshot-api-key")).toEqual({
      ...
      installSource: {
        defaultChoice: "npm",
        npm: {
          spec: "@nova-ai/plugin-moonshot@1.2.3",
          packageName: "@nova-ai/plugin-moonshot",
          selector: "1.2.3",
          selectorKind: "exact-version",
          exactVersion: true,
          expectedIntegrity: "sha512-moonshot",
  ...
  it("surfaces provider-index ClawHub install metadata as the preferred source", () => {
      ...
      providers: {
        moonshot: {
          ...
          plugin: {
            ...
            package: "@nova-ai/plugin-moonshot",
            install: {
              clawhubSpec: "clawhub:nova-ai/moonshot@2026.5.2",
              npmSpec: "@nova-ai/plugin-moonshot@2026.5.2",
              defaultChoice: "clawhub",
              expectedIntegrity: "sha512-moonshot",
            },
          },
    ...
    expect(resolveProviderInstallCatalogEntry("moonshot-api-key")).toEqual({
      ...
      installSource: {
        defaultChoice: "clawhub",
        clawhub: {
          spec: "clawhub:nova-ai/moonshot@2026.5.2",
          packageName: "nova-ai/moonshot",
          version: "2026.5.2",
          exactVersion: true,
        },
        npm: {
          spec: "@nova-ai/plugin-moonshot@2026.5.2",
          packageName: "@nova-ai/plugin-moonshot",
          selector: "2026.5.2",
          selectorKind: "exact-version",
          exactVersion: true,
      ...
      plugins: [
        {
          pluginId: "moonshot",
          origin: "bundled",
          manifestPath: "/repo/extensions/moonshot/nova-ai.plugin.json",
          manifestHash: "hash",
  ...
  it("keeps missing provider-index entries visible when only some provider plugins are installed", () => {
    ...
    loadNova AIProviderIndex.mockReturnValue({
      ...
      providers: {
        groq: {
          ...
          plugin: {
            id: "groq",
            package: "@nova-ai/plugin-groq",
            install: {
              npmSpec: "@nova-ai/plugin-groq@1.0.0",
              defaultChoice: "npm",
            },
          },
          authChoices: [
        ...
        vllm: {
          ...
          plugin: {
            id: "vllm",
            package: "@nova-ai/plugin-vllm",
            install: {
              clawhubSpec: "clawhub:nova-ai/vllm@2026.5.2",
              npmSpec: "@nova-ai/plugin-vllm@2026.5.2",
              defaultChoice: "clawhub",
            },
          },
          authChoices: [
    ...
    expect(resolveProviderInstallCatalogEntry("vllm-server")).toEqual({
      ...
      installSource: {
        ...
        npm: {
          spec: "@nova-ai/plugin-vllm@2026.5.2",
          packageName: "@nova-ai/plugin-vllm",
          selector: "2026.5.2",
          selectorKind: "exact-version",
          exactVersion: true,
