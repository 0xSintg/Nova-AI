...
export type MemoryPluginRuntime = {
  ...
  closeMemorySearchManager?(params: { cfg: Nova AIConfig; agentId: string }): Promise<void>;
...
export type MemoryPluginPublicArtifactsProvider = {
  listArtifacts(params: { cfg: Nova AIConfig }): Promise<MemoryPluginPublicArtifact[]>;
};
