...
function makeTempDir() {
  return makeTrackedTempDir("nova-ai-bundle-manifest", tempDirs);
}
...
describe("bundle manifest parsing", () => {
  it("does not treat nova-ai.bundle.json as a bundle manifest", () => {
    const rootDir = makeTempDir();
    writeBundleManifest(rootDir, "nova-ai.bundle.json", {
      name: "Not Real",
      skills: ["skills"],
    });
