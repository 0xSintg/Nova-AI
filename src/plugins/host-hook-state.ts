...
function loadPluginHostHookSessionEntry(params: { cfg: Nova AIConfig; sessionKey: string }): {
  storePath: string;
  entry?: SessionEntry;
  canonicalKey: string;
  storeKey: string;
...
function isPluginPromptInjectionEnabled(cfg: Nova AIConfig, pluginId: string): boolean {
