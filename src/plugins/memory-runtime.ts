...
function resolveMemoryRuntimePluginIds(config: Nova AIConfig): string[] {
...
function resolveMemoryRuntimeWorkspaceDir(cfg: Nova AIConfig): string | undefined {
...
function ensureMemoryRuntime(cfg?: Nova AIConfig) {
...
export function resolveActiveMemoryBackendConfig(params: { cfg: Nova AIConfig; agentId: string }) {
