...
export type WebSearchProviderPlugin = {
  ...
  getConfiguredCredentialValue?: (config?: Nova AIConfig) => unknown;
  setConfiguredCredentialValue?: (configTarget: Nova AIConfig, value: unknown) => void;
  getConfiguredCredentialFallback?: (
    config?: Nova AIConfig,
  ) => WebSearchProviderConfiguredCredentialFallback | undefined;
  applySelectionConfig?: (config: Nova AIConfig) => Nova AIConfig;
  runSetup?: (ctx: WebSearchProviderSetupContext) => Nova AIConfig | Promise<Nova AIConfig>;
