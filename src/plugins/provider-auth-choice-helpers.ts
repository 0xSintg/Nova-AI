...
function normalizeModelProviderConfigsForWrite(cfg: Nova AIConfig): Nova AIConfig {
...
function normalizeConfigModelRefsForWrite(cfg: Nova AIConfig): Nova AIConfig {
