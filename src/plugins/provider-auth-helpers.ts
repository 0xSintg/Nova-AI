...
const resolveAuthAgentDir = (agentDir?: string, config?: Nova AIConfig) =>
...
function resolveProviderDefaultEnvSecretRef(provider: string, config?: Nova AIConfig): SecretRef {
