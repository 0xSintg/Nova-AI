...
import type { Nova AIPluginCliCommandDescriptor } from "./types.js";
...
const PLUGIN_CLI_ENTRIES_CACHE_KEY = Symbol.for("nova-ai.plugin-cli-registration-entries-cache");
...
export const loadValidatedConfigForPluginRegistration =
  async (): Promise<Nova AIConfig | null> => {
