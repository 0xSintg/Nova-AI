...
} & PluginActivationConfigSourceLike<Nova AIConfig>;
...
const hasExplicitMemorySlot = (plugins?: Nova AIConfig["plugins"]) =>
  Boolean(plugins?.slots && Object.prototype.hasOwnProperty.call(plugins.slots, "memory"));

const hasExplicitMemoryEntry = (plugins?: Nova AIConfig["plugins"]) =>
  Boolean(
    plugins?.entries &&
    Object.prototype.hasOwnProperty.call(plugins.entries, defaultSlotIdForKey("memory")),
  );

export const hasExplicitPluginConfig = (plugins?: Nova AIConfig["plugins"]) =>
