...
const ENV: NodeJS.ProcessEnv = { HOME: "/tmp/nova-ai-test-home" };
let loadCase = 0;

const RECORDS: Record<string, PluginInstallRecord> = {
  weixin: {
    source: "npm",
    spec: "@tencent-weixin/nova-ai-weixin@2.3.7",
    installPath:
      "/tmp/nova-ai-test-home/.nova-ai/npm/node_modules/@tencent-weixin/nova-ai-weixin",
...
async function loadWithMocks(params: {
  ...
  vi.doMock("./discovery.js", () => ({ discoverNova AIPlugins: discoverSpy }));
