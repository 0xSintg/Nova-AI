...
export const INSTALLED_PLUGIN_INDEX_WARNING =
  "DO NOT EDIT. This file is generated by Nova AI from plugin manifests, install records, and config policy. Use `nova-ai plugins registry --refresh`, `nova-ai plugins install/update/uninstall`, or `nova-ai plugins enable/disable` instead.";
...
export type InstalledPluginIndexRecord = {
  ...
  /**
   * Package-authored nova-ai.install metadata. This describes catalog/package
