...
import type { Nova AIPluginConfigSchema } from "./types.js";
...
type BuildPluginConfigSchemaOptions = {
  ...
  safeParse?: Nova AIPluginConfigSchema["safeParse"];
};
...
export function emptyPluginConfigSchema(): Nova AIPluginConfigSchema {
  return {
