...
import { relinkNova AIPeerDependenciesInManagedNpmRoot } from "./plugin-peer-link.js";
...
export function removePluginFromConfig(
  ...
  pluginId: string,
  opts?: { channelIds?: string[] },
): { config: Nova AIConfig; actions: Omit<UninstallActions, "directory"> } {
  ...
  const config: Nova AIConfig = {
    ...
    channels: channels as Nova AIConfig["channels"],
  };
