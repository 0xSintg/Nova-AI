...
function listPotentialEnabledChannelIds(config: Nova AIConfig, env: NodeJS.ProcessEnv): string[] {
...
function resolveGatewayStartupDreamingPluginIds(config: Nova AIConfig): Set<string> {
...
function collectConfiguredWebSearchProviderIds(config: Nova AIConfig): ReadonlySet<string> {
