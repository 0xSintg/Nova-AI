...
export class AcpSessionManager {
  ...
  resolveSession(params: { cfg: Nova AIConfig; sessionKey: string }): AcpSessionResolution {
  ...
  getObservabilitySnapshot(cfg: Nova AIConfig): AcpManagerObservabilitySnapshot {
  ...
  private resolveTurnTimeoutMs(params: { cfg: Nova AIConfig; meta: SessionAcpMeta }): number {
  ...
  private enforceConcurrentSessionLimit(params: { cfg: Nova AIConfig; sessionKey: string }): void {
  ...
  private async evictIdleRuntimeHandles(params: { cfg: Nova AIConfig }): Promise<void> {
