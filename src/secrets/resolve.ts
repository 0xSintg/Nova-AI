...
function resolveResolutionLimits(config: Nova AIConfig): ResolutionLimits {
...
function resolveConfiguredProvider(ref: SecretRef, config: Nova AIConfig): SecretProviderConfig {
