...
function makeContext(sourceConfig: Nova AIConfig): ResolverContext {
...
function collectAcpxConfigAssignments(config: Nova AIConfig): ResolverContext {
...
function expectInactiveAcpxConfig(config: Nova AIConfig): void {
