...
import { openClawRootFs, openClawRootFsSync } from "./nova-ai-root.fs.runtime.js";

const CORE_PACKAGE_NAMES = new Set(["nova-ai"]);
...
export async function resolveNova AIPackageRoot(opts: {
  cwd?: string;
  argv1?: string;
  moduleUrl?: string;
}): Promise<string | null> {
...
export function resolveNova AIPackageRootSync(opts: {
  cwd?: string;
  argv1?: string;
  moduleUrl?: string;
}): string | null {
...
export const testing = {
  clearNova AIPackageRootCaches(): void {
