...
import { readSecretFileSync as readSecretFileSyncImpl } from "@nova-ai/fs-safe/secret";
...
} from "@nova-ai/fs-safe/secret";
export { writeSecretFileAtomic as writePrivateSecretFileAtomic } from "@nova-ai/fs-safe/secret";
