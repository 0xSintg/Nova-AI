...
function resolveSlackPluginOriginTarget(params: { cfg: Nova AIConfig; turnSourceTo: string }) {
...
describe("exec approval session target", () => {
  ...
  it("returns null for blank session keys, missing entries, and unresolved targets", () => {
    withTempDirSync({ prefix: "nova-ai-exec-approval-session-target-" }, (tmpDir) => {
