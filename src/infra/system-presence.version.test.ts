  ...
  return withEnvAsync(
    {
      ...
      NOVA_AI_SERVICE_VERSION: undefined,
...
describe("system-presence version fallback", () => {
  ...
  it("uses runtime VERSION when NOVA_AI_VERSION is not set", async () => {
  ...
  it("prefers NOVA_AI_VERSION over runtime VERSION", async () => {
    await expectSelfVersion(
      {
  ...
  it("still prefers runtime VERSION over NOVA_AI_SERVICE_VERSION when NOVA_AI_VERSION is blank", async () => {
    await expectSelfVersion(
      {
        NOVA_AI_VERSION: " ",
        NOVA_AI_SERVICE_VERSION: "2.4.6-service",
  ...
  it("uses runtime VERSION when NOVA_AI_VERSION and NOVA_AI_SERVICE_VERSION are blank", async () => {
    await expectSelfVersion(
      {
        NOVA_AI_VERSION: " ",
        NOVA_AI_SERVICE_VERSION: "\t",
