...
function makeTargetsCfg(targets: Array<{ channel: string; to: string }>): Nova AIConfig {
  return {
    approvals: {
      exec: {
        enabled: true,
...
function makeSessionCfg(options: { discordExecApprovalsEnabled?: boolean } = {}): Nova AIConfig {
  return {
