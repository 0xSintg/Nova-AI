 ...
 *
 * @see https://github.com/nova-ai/nova-ai/issues/31884
 * @see https://github.com/nova-ai/nova-ai/issues/18558
 */
...
const INTERNAL_RUNTIME_DELIMITED_BLOCKS = [
  ["<<<BEGIN_NOVA_AI_INTERNAL_CONTEXT>>>", "<<<END_NOVA_AI_INTERNAL_CONTEXT>>>"],
] as const;
