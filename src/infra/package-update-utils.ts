...
import { readRootJsonObjectSync } from "@nova-ai/fs-safe/json";
...
export function installedPackageNeedsNova AIPeerLinkRepair(dir: string): boolean {
  ...
  try {
    fsSync.statSync(path.join(dir, "node_modules", "nova-ai"));
    return false;
  } catch (error) {
