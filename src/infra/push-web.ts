...
const DEFAULT_VAPID_SUBJECT = "https://nova-ai.com";
...
function resolveVapidSubjectFromEnv(): string {
  return process.env.NOVA_AI_VAPID_SUBJECT || DEFAULT_VAPID_SUBJECT;
}

function resolveVapidPublicKeyFromEnv(): string | undefined {
  return process.env.NOVA_AI_VAPID_PUBLIC_KEY || undefined;
}

function resolveVapidPrivateKeyFromEnv(): string | undefined {
  return process.env.NOVA_AI_VAPID_PRIVATE_KEY || undefined;
}
