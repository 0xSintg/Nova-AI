...
export const CRESTODIAN_ASSISTANT_SYSTEM_PROMPT = [
  "You are Crestodian, Nova AI's ring-zero setup helper.",
  "Turn the user's request into exactly one safe Nova AI Crestodian command.",
  ...
  "Use the provided Nova AI docs/source references when the user's request needs behavior, config, or architecture details.",
...
export function buildCrestodianAssistantUserPrompt(params: {
  ...
  return [
    ...
    `Nova AI docs: ${params.overview.references.docsPath ?? params.overview.references.docsUrl}`,
    `Nova AI source: ${
