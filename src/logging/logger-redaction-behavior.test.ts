...
const logPathTracker = createSuiteLogPathTracker("nova-ai-log-redaction-");
const originalConfigPath = process.env.NOVA_AI_CONFIG_PATH;
const originalHome = process.env.HOME;
const originalTestFileLog = process.env.NOVA_AI_TEST_FILE_LOG;
...
describe("file log redaction", () => {
  ...
  it("expands leading tilde in logging.file", () => {
    ...
    expect(loggerTest.resolveActiveLogFile("~/custom-nova-ai.log")).toBe(
      path.join(home, "custom-nova-ai.log"),
    );
  });
