...
let originalNova AITestConsole: string | undefined;
...
beforeEach(() => {
  ...
  originalNova AITestConsole = process.env.NOVA_AI_TEST_CONSOLE;
  process.env.NOVA_AI_TEST_CONSOLE = "1";
...
afterEach(() => {
  ...
  if (originalNova AITestConsole === undefined) {
    delete process.env.NOVA_AI_TEST_CONSOLE;
  } else {
    process.env.NOVA_AI_TEST_CONSOLE = originalNova AITestConsole;
  }
