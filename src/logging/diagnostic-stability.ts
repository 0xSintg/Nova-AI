...
function getDiagnosticStabilityState(): DiagnosticStabilityState {
  const globalStore = globalThis as typeof globalThis & {
    __nova-aiDiagnosticStabilityState?: DiagnosticStabilityState;
  };
  globalStore["__nova-aiDiagnosticStabilityState"] ??= createState();
  return globalStore["__nova-aiDiagnosticStabilityState"];
}
...
export function resetDiagnosticStabilityRecorderForTest(): void {
  ...
  globalStore["__nova-aiDiagnosticStabilityState"] = next;
}
