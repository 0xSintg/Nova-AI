...
const SUPPORT_EXPORT_PREFIX = "nova-ai-diagnostics-";
...
function readStabilityBundle(
  ...
  if (target === false) {
    return { status: "missing", dir: "$NOVA_AI_STATE_DIR/logs/stability" };
  }
...
function renderSummary(params: {
  ...
  return [
    ...
    "- `logs/nova-ai-sanitized.jsonl`: sanitized log summaries and metadata",
