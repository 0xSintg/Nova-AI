...
function resolveDiagnosticSessionStorePaths(config?: Nova AIConfig): string[] | undefined {
  if (!config) {
    return undefined;
  }
  try {
...
function shouldWriteCriticalMemoryPressureBundle(config?: Nova AIConfig): boolean {
...
export function resolveStuckSessionWarnMs(config?: Nova AIConfig): number {
