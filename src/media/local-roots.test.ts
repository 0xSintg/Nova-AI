...
describe("local media roots", () => {
  ...
  it.each([
    {
      ...
      stateDir: path.join("/tmp", "nova-ai-media-roots-state"),
    ...
    },
    {
      ...
      stateDir: path.join("/tmp", "nova-ai-agent-media-roots-state"),
  ...
  it.each([
    {
      ...
      stateDir: path.join("/tmp", "nova-ai-flexible-media-roots-state"),
      cfg: {},
    ...
    },
    {
      ...
      stateDir: path.join("/tmp", "nova-ai-messaging-media-roots-state"),
    ...
    },
    {
      ...
      stateDir: path.join("/tmp", "nova-ai-messaging-fs-media-roots-state"),
      cfg: {
        tools: {
          profile: "messaging",
    ...
    },
    {
      ...
      stateDir: path.join("/tmp", "nova-ai-messaging-read-media-roots-state"),
      cfg: {
        tools: {
          profile: "messaging",
  ...
  it("keeps the config-dir media cache root when state and config paths differ", () => {
    const stateDir = path.join("/tmp", "nova-ai-legacy-state");
    const configDir = path.join("/tmp", "nova-ai-current-config");
