...
export function resolveConfiguredMediaMaxBytes(cfg?: Nova AIConfig): number | undefined {
...
export function resolveGeneratedMediaMaxBytes(cfg: Nova AIConfig | undefined, kind: MediaKind) {
