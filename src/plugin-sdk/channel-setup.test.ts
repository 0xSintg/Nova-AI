import { runSetupWizardFinalize } from "nova-ai/plugin-sdk/plugin-test-runtime";
...
describe("createOptionalChannelSetupSurface", () => {
  it("returns a matched adapter and wizard for optional plugins", async () => {
    ...
    expect(
      ...
      "Example setup requires @nova-ai/example to be installed. Docs: https://docs.nova-ai.com/channels/example",
    );
    ...
    ).rejects.toThrow("@nova-ai/example");
  });
});
