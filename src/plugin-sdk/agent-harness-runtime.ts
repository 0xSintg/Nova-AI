...
export { VERSION as NOVA_AI_VERSION } from "../version.js";
...
export { resolveNova AIAgentDir } from "./agent-dir-compat.js";
export {
  resolveAgentDir,
 ...
 * preserve the same Nova AI-owned fallback signals as the built-in PI path
