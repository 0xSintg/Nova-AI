import {
  ...
  type Nova AIPluginApiWithoutFacades,
} from "../plugins/api-facades.js";
import type { Nova AIPluginApi } from "./plugin-runtime.js";

export type TestPluginApiInput = Partial<Nova AIPluginApi>;

export function createTestPluginApi(api: TestPluginApiInput = {}): Nova AIPluginApi {
  ...
  const mergedApi = {
    ...
    on() {},
    ...flatApi,
  } as Nova AIPluginApiWithoutFacades;
