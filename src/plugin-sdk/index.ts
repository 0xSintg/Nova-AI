...
/** @deprecated Use Nova AIConfig instead */
export type { Nova AIConfig as NovabotConfig } from "../config/config.js";
/** @deprecated Use Nova AIConfig instead */
export type { Nova AIConfig as Nova AISchemaType } from "../config/config.js";
export type {
