...
export function installNova AIOwnedToolHooks(params?: {
 ...
 * Pair with `installNova AIOwnedToolHooks()` when a test asserts before/after hook behavior.
 */
...
export function resetNova AIOwnedToolHooks(): void {
  resetGlobalHookRunner();
  resetPluginRuntimeStateForTest();
