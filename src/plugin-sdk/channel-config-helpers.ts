...
type ChannelConfigAccessorParams<Config extends Nova AIConfig = Nova AIConfig> = {
  cfg: Config;
  accountId?: string | null;
};
...
type MultiAccountChannelConfigAdapterParams<
  ...
  Config extends Nova AIConfig = Nova AIConfig,
> = {
  sectionKey: string;
...
export function adaptScopedAccountAccessor<Result, Config extends Nova AIConfig = Nova AIConfig>(
...
> {
  const base = {
    resolveAllowFrom({ cfg, accountId }: { cfg: Nova AIConfig; accountId?: string | null }) {
...
function setTopLevelChannelEnabledInConfigSection<Config extends Nova AIConfig>(params: {
  cfg: Config;
  sectionKey: string;
  enabled: boolean;
}): Config {
...
function removeTopLevelChannelConfigSection<Config extends Nova AIConfig>(params: {
  cfg: Config;
  sectionKey: string;
}): Config {
...
function clearTopLevelChannelConfigFields<Config extends Nova AIConfig>(params: {
  cfg: Config;
  sectionKey: string;
  clearBaseFields: string[];
}): Config {
