...
const FACADE_LOADER_GLOBAL = "__nova-aiTestLoadBundledPluginPublicSurfaceModuleSync";
...
describe("plugin-sdk facade loader", () => {
  it("honors trusted bundled plugin dir overrides under the package root", () => {
    const pluginId = nextTrustedPluginId("nova-ai-facade-loader-override-");
    const overrideA = createBundledPluginFixture({
      pluginId,
      kind: "dist",
      prefix: "nova-ai-facade-loader-a-",
      marker: "override-a",
    });
    const overrideB = createBundledPluginFixture({
      pluginId,
      kind: "dist-runtime",
      prefix: "nova-ai-facade-loader-b-",
      marker: "override-b",
    });

    process.env.NOVA_AI_BUNDLED_PLUGINS_DIR = overrideA.bundledPluginsDir;
    ...
    process.env.NOVA_AI_BUNDLED_PLUGINS_DIR = overrideB.bundledPluginsDir;
  ...
  it("falls back to package source surfaces when an override dir lacks a bundled plugin", () => {
    const fixture = createPackageSourcePluginFixture({
      prefix: "nova-ai-facade-loader-source-fallback-",
      marker: "source-fallback",
    });
    process.env.NOVA_AI_BUNDLED_PLUGINS_DIR = createTempDirSync("nova-ai-facade-loader-empty-");
  ...
  it("shares loaded facade ids with facade-runtime", () => {
    const fixture = createBundledPluginFixture({
      prefix: "nova-ai-facade-loader-ids-",
      marker: "identity-check",
    });
    process.env.NOVA_AI_BUNDLED_PLUGINS_DIR = fixture.bundledPluginsDir;
  ...
  it("uses native require for Windows dist facade loads", () => {
    const fixture = createBundledPluginFixture({
      prefix: "nova-ai-facade-loader-windows-",
  ...
  it("breaks circular facade re-entry during module evaluation", () => {
    const fixture = createCircularPluginFixture("nova-ai-facade-loader-circular-");
    process.env.NOVA_AI_BUNDLED_PLUGINS_DIR = fixture.bundledPluginsDir;
  ...
  it("clears the cache on load failure so retries re-execute", () => {
    const fixture = createThrowingPluginFixture("nova-ai-facade-loader-throw-");
    process.env.NOVA_AI_BUNDLED_PLUGINS_DIR = fixture.bundledPluginsDir;
