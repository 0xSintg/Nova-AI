...
import type { Nova AIPluginApi } from "../plugins/types.js";
...
export type { Nova AIConfig } from "../config/config.js";
...
type ChatChannelThreadingReplyModeOptions<TResolvedAccount> =
  ...
  | {
      scopedAccountReplyToMode: {
        resolveAccount: (cfg: Nova AIConfig, accountId?: string | null) => TResolvedAccount;
        resolveReplyToMode: (
