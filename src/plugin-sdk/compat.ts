 ...
 * older broad plugin-sdk imports. Use focused nova-ai/plugin-sdk subpaths
 * instead.
 */
...
const shouldWarnCompatImport =
  ...
  process.env.NOVA_AI_SUPPRESS_PLUGIN_SDK_COMPAT_WARNING !== "1";

if (shouldWarnCompatImport) {
  process.emitWarning(
    "nova-ai/plugin-sdk/compat is deprecated for new plugins. Migrate to focused nova-ai/plugin-sdk/<subpath> imports. See https://docs.nova-ai.com/plugins/sdk-migration",
    {
      code: "NOVA_AI_PLUGIN_SDK_COMPAT_DEPRECATED",
      detail:
        "Bundled plugins must use scoped plugin-sdk subpaths. External plugins may keep compat temporarily while migrating. Migration guide: https://docs.nova-ai.com/plugins/sdk-migration",
    },
  );
}
...
export { resolvePreferredNova AITmpDir } from "./temp-path.js";
...
/** @deprecated Use `nova-ai/plugin-sdk/channel-message`. */
