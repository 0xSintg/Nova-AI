...
import type { ModelDefinitionConfig, Nova AIConfig } from "../config/types.js";
import { loadBundledPluginPublicSurfaceModuleSync } from "./facade-loader.js";

type FacadeModule = {
  applyLitellmConfig: (cfg: Nova AIConfig) => Nova AIConfig;
  applyLitellmProviderConfig: (cfg: Nova AIConfig) => Nova AIConfig;
