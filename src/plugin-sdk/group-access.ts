...
/** @deprecated Use `resolveChannelMessageIngress` from `nova-ai/plugin-sdk/channel-ingress-runtime`. */
...
/** @deprecated Use route descriptors with `resolveChannelMessageIngress` from `nova-ai/plugin-sdk/channel-ingress-runtime`. */
...
/** @deprecated Use `resolveOpenProviderRuntimeGroupPolicy` plus `resolveChannelMessageIngress` from `nova-ai/plugin-sdk/channel-ingress-runtime`. */
