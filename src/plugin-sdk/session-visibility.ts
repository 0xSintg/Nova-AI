...
export function resolveSessionToolsVisibility(cfg: Nova AIConfig): SessionToolsVisibility {
...
export function resolveSandboxSessionToolsVisibility(cfg: Nova AIConfig): "spawned" | "all" {
  return cfg.agents?.defaults?.sandbox?.sessionToolsVisibility ?? "spawned";
}

export function createAgentToAgentPolicy(cfg: Nova AIConfig): AgentToAgentPolicy {
