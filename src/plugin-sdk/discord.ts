...
/**
 * @deprecated Compatibility facade for the `nova-ai/plugin-sdk/discord` subpath.
...
export type { Nova AIConfig } from "./config-types.js";
export type { Nova AIPluginApi, PluginRuntime } from "./channel-plugin-common.js";
...
export type DiscordAccountConfig = NonNullable<NonNullable<Nova AIConfig["channels"]>["discord"]>;
...
type DiscordApiFacadeModule = {
  ...
  inspectDiscordAccount: (params: { cfg: Nova AIConfig; accountId?: string | null }) => unknown;
  listDiscordAccountIds: (cfg: Nova AIConfig) => string[];
  ...
  resolveDefaultDiscordAccountId: (cfg: Nova AIConfig) => string;
...
function resolveCompatRuntimeConfig(params: { cfg?: Nova AIConfig }): Nova AIConfig {
...
export function listDiscordAccountIds(cfg: Nova AIConfig): string[] {
...
export function resolveDefaultDiscordAccountId(cfg: Nova AIConfig): string {
