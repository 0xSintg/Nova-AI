...
describe("avatar policy", () => {
  ...
  it("detects avatar-like path strings", () => {
    expect(looksLikeAvatarPath("avatars/nova-ai.svg")).toBe(true);
    expect(looksLikeAvatarPath("nova-ai.webp")).toBe(true);
