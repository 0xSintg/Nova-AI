...
function listConfiguredChannelIds(cfg: Nova AIConfig): string[] {
...
function listConfiguredChannelAccountIds(cfg: Nova AIConfig, channelId: string): string[] {
  if (!hasRecord(cfg.channels)) {
    return [];
  }
...
export function collectChannelRouteTargets(cfg: Nova AIConfig): ChannelRouteTarget[] {
