...
function expectNova AISchemaInvalidPreservesField(params: {
  config: unknown;
  ...
  const res = Nova AISchema.safeParse(params.config);
...
describe("legacy config detection", () => {
  ...
  it("rejects removed legacy provider sections", () => {
    expectNova AISchemaInvalidPreservesField({
  ...
  it("preserves claude-cli auth profile mode during validation", () => {
    ...
    const res = Nova AISchema.safeParse(config);
