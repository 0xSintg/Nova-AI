...
export type DiscordVoiceRealtimeConfig = {
  ...
  /** Whether bidi should force the Nova AI agent brain for every substantive turn. */
  ...
  /** Debounce window before buffered transcripts are sent to the Nova AI agent. */
  debounceMs?: number;
...
export type DiscordVoiceAgentSessionConfig = {
  /** Which Nova AI conversation should receive voice turns. Default: "voice". */
  mode?: "voice" | "target";
...
export type DiscordVoiceConfig = {
  ...
  /** Route voice turns through an existing Nova AI Discord conversation. */
