...
let runtimeConfigSnapshot: Nova AIConfig | null = null;
let runtimeConfigSourceSnapshot: Nova AIConfig | null = null;
...
function configSnapshotsMatch(left: Nova AIConfig, right: Nova AIConfig): boolean {
  if (left === right) {
    return true;
  }
  try {
...
export function hashRuntimeConfigValue(value: Nova AIConfig): string {
...
export function getRuntimeConfigSnapshot(): Nova AIConfig | null {
  return runtimeConfigSnapshot;
}

export function getRuntimeConfigSourceSnapshot(): Nova AIConfig | null {
...
export function resolveRuntimeConfigCacheKey(config: Nova AIConfig): string {
...
export function selectApplicableRuntimeConfig(params: {
  inputConfig?: Nova AIConfig;
  runtimeConfig?: Nova AIConfig | null;
  runtimeSourceConfig?: Nova AIConfig | null;
}): Nova AIConfig | undefined {
...
export function loadPinnedRuntimeConfig(loadFresh: () => Nova AIConfig): Nova AIConfig {
