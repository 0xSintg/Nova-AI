...
function createCustomRootCfg(customRoot: string, defaultAgentId = "ops"): Nova AIConfig {
  return {
    session: {
...
const discoveryResolvers = [
  {
    label: "async",
    resolve: async (cfg: Nova AIConfig, env: NodeJS.ProcessEnv) =>
