...
export type WideAreaDiscoveryConfig = {
  enabled?: boolean;
  /** Optional unicast DNS-SD domain (e.g. "nova-ai.internal"). */
  domain?: string;
};
...
export type GatewayControlUiConfig = {
  ...
  enabled?: boolean;
  /** Optional base path prefix for the Control UI (e.g. "/nova-ai"). */
  basePath?: string;
   ...
   * Default off; prefer hosted /__nova-ai__/canvas or /__nova-ai__/a2ui content.
   */
 ...
 * Used when Novabot runs behind an identity-aware proxy (Pomerium, Caddy + OAuth, etc.)
...
export type GatewayTailscaleConfig = {
   ...
   * startup. Lets operators manage Funnel exposure outside Nova AI without
...
export type GatewayReloadConfig = {
   ...
   * @see https://github.com/nova-ai/nova-ai/issues/65485
   */
...
export type GatewayConfig = {
   ...
   * Env var NOVA_AI_HANDSHAKE_TIMEOUT_MS takes precedence. Default: 15000.
   */
