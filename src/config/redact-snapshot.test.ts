...
import type { ConfigFileSnapshot } from "./types.nova-ai.js";
...
describe("redactConfigSnapshot", () => {
          ...
          plugins: [
            {
              ...
              manifestPath: "/private/plugin/root/nova-ai.plugin.json",
            },
          ],
          diagnostics: [],
        },
  ...
  it("does not redact passwordFile path fields", () => {
    const snapshot = makeSnapshot({
      channels: {
        irc: {
          passwordFile: "/etc/nova-ai/irc-password.txt",
          nickserv: {
            passwordFile: "/etc/nova-ai/nickserv-password.txt",
    ...
    expect(irc.passwordFile).toBe("/etc/nova-ai/irc-password.txt");
    expect(nickserv.passwordFile).toBe("/etc/nova-ai/nickserv-password.txt");
