import type { Nova AIConfig, HookConfig } from "../config/config.js";
...
const HOOK_SOURCE_POLICIES: Record<HookSource, HookSourcePolicy> = {
  "nova-ai-bundled": {
    ...
    canOverride: ["nova-ai-bundled"],
    canBeOverriddenBy: ["nova-ai-managed", "nova-ai-plugin"],
  },
  "nova-ai-plugin": {
    precedence: 20,
    trustedLocalCode: true,
    defaultEnableMode: "default-on",
    canOverride: ["nova-ai-bundled", "nova-ai-plugin"],
    canBeOverriddenBy: ["nova-ai-managed"],
  },
  "nova-ai-managed": {
    precedence: 30,
    trustedLocalCode: true,
    defaultEnableMode: "default-on",
    canOverride: ["nova-ai-bundled", "nova-ai-managed", "nova-ai-plugin"],
    canBeOverriddenBy: ["nova-ai-managed"],
  },
  "nova-ai-workspace": {
    precedence: 40,
    ...
    canOverride: ["nova-ai-workspace"],
    canBeOverriddenBy: ["nova-ai-workspace"],
  },
};
...
export function resolveHookEnableState(params: {
  ...
  if (entry.hook.source === "nova-ai-plugin") {
    return { enabled: true };
  }
