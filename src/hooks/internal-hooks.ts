/**
 * Hook system for Nova AI agent events
 *
 ...
 */
const INTERNAL_HOOK_HANDLERS_KEY = Symbol.for("nova-ai.internalHookHandlers");
...
const INTERNAL_HOOKS_ENABLED_KEY = Symbol.for("nova-ai.internalHooksEnabled");
