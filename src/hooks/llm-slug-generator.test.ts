...
vi.mock("../agents/agent-scope.js", () => ({
  ...
  resolveAgentWorkspaceDir: vi.fn(() => "/tmp/nova-ai-agent"),
  resolveAgentDir: vi.fn(() => "/tmp/nova-ai-agent/.nova-ai-agent"),
  resolveAgentEffectiveModelPrimary: vi.fn((cfg: Nova AIConfig) => {
