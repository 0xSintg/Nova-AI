...
execution:
  ...
  config:
    firstPrompt: "@nova-ai Reconnect dedupe setup marker. Reply exactly: RECONNECT-FIRST-OK"
    secondPrompt: "@nova-ai Reconnect dedupe follow-up marker. Reply exactly: RECONNECT-SECOND-OK"
