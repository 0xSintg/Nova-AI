...
execution:
  kind: flow
  summary: Install @nova-ai/kitchen-sink, restart the gateway, exercise command inventory/tool/channel/OpenAI paths, and record CPU/RSS/log evidence.
  config:
    requiredProviderMode: live-frontier
    requiredProvider: openai
    pluginSpec: npm:@nova-ai/kitchen-sink@latest
