...
successCriteria:
  - The runtime-packaged bundled plugin tree is used as NOVA_AI_BUNDLED_PLUGINS_DIR.
          ...
          expr: |-
            (async () => {
              ...
              const cliEnv = {
                ...
                HOME: homeDir,
                NOVA_AI_HOME: homeDir,
                NOVA_AI_CONFIG_PATH: configPath,
                NOVA_AI_STATE_DIR: stateDir,
                NOVA_AI_OAUTH_DIR: path.join(stateDir, "credentials"),
                NOVA_AI_BUNDLED_PLUGINS_DIR: distRuntimeExtensions,
