...
successCriteria:
  - Pi may expose Nova AI read while Codex app-server mode may omit duplicate Nova AI dynamic read.
...
execution:
  ...
  config:
    ...
    toolCoverage:
      ...
      reason: Codex app-server intentionally owns read natively; current Nova AI coding surface has no separate list tool.
    knownHarnessGap:
      issue: "#80312"
