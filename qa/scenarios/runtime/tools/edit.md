...
successCriteria:
  - Pi may expose Nova AI edit while Codex app-server mode may omit duplicate Nova AI dynamic edit.
...
execution:
  ...
  config:
    ...
    toolCoverage:
      ...
      qaImpact: P1
      action: split native edit behavior from Nova AI dynamic tool parity
      reason: Codex app-server intentionally owns edit natively; the fixture must not require Nova AI dynamic edit exposure.
    knownHarnessGap:
      issue: "#80319"
      reason: QA tool-defaults currently needs native edit behavior coverage instead of Nova AI dynamic edit exposure.
