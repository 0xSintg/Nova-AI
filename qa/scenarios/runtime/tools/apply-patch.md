...
successCriteria:
  - Pi may expose Nova AI apply_patch while Codex app-server mode may omit duplicate Nova AI dynamic apply_patch.
...
execution:
  ...
  config:
    ...
    knownHarnessGap:
      issue: "#80320"
      reason: Codex-native apply_patch is intentionally not an Nova AI dynamic tool; QA fault injection still uses synthetic failure-path inputs.
