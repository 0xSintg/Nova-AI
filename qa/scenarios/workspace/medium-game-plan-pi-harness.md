...
execution:
  kind: flow
  summary: Run with `pnpm nova-ai qa suite --provider-mode live-frontier --model openai/gpt-5.5 --alt-model openai/gpt-5.5 --fast --thinking medium --scenario medium-game-plan-pi-harness`.
  config:
