...
Nova AI is the AI that actually does things.
...
Nova AI started as a personal playground to learn AI and build something genuinely useful:
an assistant that can run real tasks on a real computer.
It evolved through several names and shells: Warelay -> Novabot -> Moltbot -> Nova AI.
...
Security in Nova AI is a deliberate tradeoff: strong defaults without killing capability.
...
Nova AI has an extensive plugin API.
...
- Code plugins run Nova AI plugin code and are appropriate for deeper runtime extension.
...
Nova AI docs should document core extension points; plugin promotion belongs in ClawHub, preferably under vetted org publishers for official plugins.
...
Nova AI supports MCP as both a server and a runtime integration surface.
...
Nova AI is currently terminal-first by design.
...
Nova AI is primarily an orchestration system: prompts, tools, protocols, and integrations.
TypeScript was chosen to keep Nova AI hackable by default.
