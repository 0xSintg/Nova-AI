...
show_usage() {
    cat << EOF
clawlog - Nova AI Logging Utility

USAGE:
    clawlog [OPTIONS]

DESCRIPTION:
    View Nova AI logs with full details (bypasses Apple's privacy redaction).
    Requires sudo access configured for /usr/bin/log command.

LOG FLOW ARCHITECTURE:
    Nova AI logs flow through the macOS unified log (subsystem: ai.nova-ai).
