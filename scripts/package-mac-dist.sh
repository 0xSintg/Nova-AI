...
# Output:
# - dist/Nova AI.app
# - dist/Nova AI-<version>.zip
# - dist/Nova AI-<version>.dmg
...
export BUNDLE_ID="${BUNDLE_ID:-ai.nova-ai.mac}"
...
ZIP="$ROOT_DIR/dist/Nova AI-$VERSION.zip"
DMG="$ROOT_DIR/dist/Nova AI-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/Nova AI-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/Nova AI-$VERSION.dSYM.zip"
