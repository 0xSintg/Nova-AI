...
function printHelp() {
  console.log(`Usage: node scripts/nova-ai-performance-source-summary.mjs --source-dir <dir> [--output <summary.md>]

Summarizes Nova AI-native performance probe artifacts for CI reports.`);
}
