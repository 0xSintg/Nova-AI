...
const opts = parseFlagArgs(
  process.argv.slice(2),
  {
    ...
    maxDurationRegressionPct:
      readEnvNumber("NOVA_AI_STARTUP_BENCH_MAX_DURATION_REGRESSION_PCT") ?? 20,
    maxFirstOutputRegressionPct:
      readEnvNumber("NOVA_AI_STARTUP_BENCH_MAX_FIRST_OUTPUT_REGRESSION_PCT") ?? 20,
    maxRssRegressionPct: readEnvNumber("NOVA_AI_STARTUP_BENCH_MAX_RSS_REGRESSION_PCT") ?? 20,
    skipBaseline: false,
  },
  [
