...
IMAGE_NAME="$(docker_e2e_resolve_image "nova-ai-session-runtime-context-e2e" NOVA_AI_SESSION_RUNTIME_CONTEXT_E2E_IMAGE)"
CONTAINER_NAME="nova-ai-session-runtime-context-e2e-$$"
RUN_LOG="$(mktemp -t nova-ai-session-runtime-context-log.XXXXXX)"
