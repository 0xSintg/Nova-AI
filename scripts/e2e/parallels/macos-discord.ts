...
${this.input.guestNode} ${this.input.guestNova AIEntry} config set channels.discord.token ${shellQuote(this.input.config.token)}
${this.input.guestNode} ${this.input.guestNova AIEntry} config set channels.discord.enabled true
${this.input.guestNode} ${this.input.guestNova AIEntry} config set channels.discord.groupPolicy allowlist
${this.input.guestNode} ${this.input.guestNova AIEntry} config set channels.discord.guilds ${shellQuote(guilds)} --strict-json
${this.input.guestNode} ${this.input.guestNova AIEntry} doctor --fix --yes --non-interactive
${this.input.guestNode} ${this.input.guestNova AIEntry} gateway restart
${this.input.guestNode} ${this.input.guestNova AIEntry} channels status --probe --json`);
  }
