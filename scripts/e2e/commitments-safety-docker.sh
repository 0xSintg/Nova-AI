...
IMAGE_NAME="$(docker_e2e_resolve_image "nova-ai-commitments-safety-e2e" NOVA_AI_COMMITMENTS_SAFETY_E2E_IMAGE)"
CONTAINER_NAME="nova-ai-commitments-safety-e2e-$$"
RUN_LOG="$(mktemp -t nova-ai-commitments-safety-log.XXXXXX)"
