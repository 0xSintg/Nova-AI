...
const appServerLog =
  process.env.NOVA_AI_CODEX_MEDIA_PATH_APP_SERVER_LOG ??
  "/tmp/nova-ai-codex-media-path-app-server.jsonl";
const timeoutSeconds = Number.parseInt(
  process.env.NOVA_AI_CODEX_MEDIA_PATH_TIMEOUT_SECONDS ?? "180",
  10,
);

if (!port || !token) {
  throw new Error("missing PORT/NOVA_AI_GATEWAY_TOKEN");
}
