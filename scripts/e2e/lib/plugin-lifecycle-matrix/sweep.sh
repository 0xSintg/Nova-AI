...
nova-ai_e2e_install_package /tmp/nova-ai-plugin-lifecycle-install.log "mounted Nova AI package" /tmp/npm-prefix
...
pack_root="$(mktemp -d "/tmp/nova-ai-plugin-lifecycle-pack.XXXXXX")"
registry_root="$(mktemp -d "/tmp/nova-ai-plugin-lifecycle-registry.XXXXXX")"
