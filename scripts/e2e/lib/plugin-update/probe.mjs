...
const pluginRecordSnapshot = () => {
  const config = readJson(nova-aiPath("nova-ai.json"));
...
function seedInstallState() {
  writeJson(nova-aiPath("extensions", "lossless-claw", "package.json"), {
    name: "@example/lossless-claw",
    version: "0.9.0",
  });
  writeJson(process.env.NOVA_AI_CONFIG_PATH, { plugins: {} });
  writeJson(nova-aiPath("plugins", "installs.json"), {
    version: 1,
    warning: "DO NOT EDIT. This file is generated by Nova AI plugin registry commands.",
...
function isCorruptPluginDisabledAfterUpdate(evidence, pluginId) {
  ...
  return (
    ...
    message.includes("Nova AI will continue without it")
  );
}
