...
IMAGE_NAME="$(docker_e2e_resolve_image "nova-ai-release-upgrade-user-journey-e2e" NOVA_AI_RELEASE_UPGRADE_USER_JOURNEY_E2E_IMAGE)"
SKIP_BUILD="${NOVA_AI_RELEASE_UPGRADE_USER_JOURNEY_E2E_SKIP_BUILD:-0}"
PACKAGE_TGZ="$(docker_e2e_prepare_package_tgz release-upgrade-user-journey "${NOVA_AI_CURRENT_PACKAGE_TGZ:-}")"
...
NOVA_AI_TEST_STATE_SCRIPT_B64="$(docker_e2e_test_state_shell_b64 release-upgrade-user-journey empty)"
...
if ! docker_e2e_run_with_harness \
  ...
  -e "NOVA_AI_RELEASE_UPGRADE_BASELINE_SPEC=${NOVA_AI_RELEASE_UPGRADE_BASELINE_SPEC:-nova-ai@latest}" \
