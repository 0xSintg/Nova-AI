...
IMAGE_NAME="$(docker_e2e_resolve_image "nova-ai-crestodian-first-run-e2e" NOVA_AI_CRESTODIAN_FIRST_RUN_E2E_IMAGE)"
CONTAINER_NAME="nova-ai-crestodian-first-run-e2e-$$"
RUN_LOG="$(mktemp -t nova-ai-crestodian-first-run-log.XXXXXX)"
...
NOVA_AI_TEST_STATE_SCRIPT_B64="$(docker_e2e_test_state_shell_b64 crestodian-first-run empty)"
