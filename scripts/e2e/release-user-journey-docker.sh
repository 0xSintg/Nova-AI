...
IMAGE_NAME="$(docker_e2e_resolve_image "nova-ai-release-user-journey-e2e" NOVA_AI_RELEASE_USER_JOURNEY_E2E_IMAGE)"
SKIP_BUILD="${NOVA_AI_RELEASE_USER_JOURNEY_E2E_SKIP_BUILD:-0}"
PACKAGE_TGZ="$(docker_e2e_prepare_package_tgz release-user-journey "${NOVA_AI_CURRENT_PACKAGE_TGZ:-}")"
...
NOVA_AI_TEST_STATE_SCRIPT_B64="$(docker_e2e_test_state_shell_b64 release-user-journey empty)"
