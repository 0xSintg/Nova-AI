...
function parseArgs(argv) {
  return parseFlagArgs(
    argv,
    {
      ...
      maxWallMs: readEnvNumber("NOVA_AI_TEST_PERF_MAX_WALL_MS"),
      baselineWallMs: readEnvNumber("NOVA_AI_TEST_PERF_BASELINE_WALL_MS"),
      maxRegressionPct: readEnvNumber("NOVA_AI_TEST_PERF_MAX_REGRESSION_PCT") ?? 10,
    },
    [
