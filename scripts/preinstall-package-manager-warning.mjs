...
export function createPackageManagerWarningMessage(packageManager) {
  ...
  return [
    `[nova-ai] warning: detected ${packageManager} for install lifecycle.`,
    "[nova-ai] this repo works best with pnpm; npm-compatible installs are slower and much larger here.",
    "[nova-ai] prefer: corepack pnpm install",
  ].join("\n");
}
