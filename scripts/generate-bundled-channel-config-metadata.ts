...
function resolvePackageChannelMeta(source: BundledPluginSource) {
  const nova-aiMeta =
    ...
    "nova-ai" in source.packageJson
      ? (source.packageJson.nova-ai as Record<string, unknown> | undefined)
      : undefined;
  const channelMeta =
    nova-aiMeta &&
    typeof nova-aiMeta.channel === "object" &&
    nova-aiMeta.channel &&
    !Array.isArray(nova-aiMeta.channel)
      ? (nova-aiMeta.channel as Record<string, unknown>)
      : undefined;
  return channelMeta;
}
