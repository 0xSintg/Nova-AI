...
- NOVA_AI_IOS_VERSION = exact canonical iOS version
- NOVA_AI_MARKETING_VERSION = short iOS/App Store version
- NOVA_AI_BUILD_VERSION = explicit build number or local numeric fallback
EOF
}
...
NOVA_AI_IOS_VERSION = ${IOS_VERSION}
NOVA_AI_MARKETING_VERSION = ${MARKETING_VERSION}
NOVA_AI_BUILD_VERSION = ${BUILD_NUMBER}
EOF
