...
# Defaults target the Nova AI assets so you can just run the script from repo root.
...
DEST_ICNS=${DEST_ICNS:-"$ROOT_DIR/apps/macos/Sources/Nova AI/Resources/Nova AI.icns"}
