...
const rules = [
  ...
  },
  {
    ...
    moduleSpecifiers: [
      "nova-ai/plugin-sdk/agent-dir-compat",
      "nova-ai/plugin-sdk/channel-config-schema-legacy",
      "nova-ai/plugin-sdk/channel-reply-pipeline",
      "nova-ai/plugin-sdk/channel-runtime",
      "nova-ai/plugin-sdk/compat",
      "nova-ai/plugin-sdk/discord",
      "nova-ai/plugin-sdk/infra-runtime",
      "nova-ai/plugin-sdk/mattermost",
      "nova-ai/plugin-sdk/matrix",
      "nova-ai/plugin-sdk/telegram-account",
      "nova-ai/plugin-sdk/testing",
      "nova-ai/plugin-sdk/test-utils",
      "nova-ai/plugin-sdk/zalouser",
    ],
