---
name: optimizetests
description: Optimize Nova AI slow tests, imports, misplaced coverage, and CI wall time without dropping coverage.
---

# Optimize Tests

Goal: real Nova AI test/runtime speedups with coverage intact. Do not add shards,
...
2. Establish evidence before edits:
   ...
   - Import suspicion: add `NOVA_AI_VITEST_IMPORT_DURATIONS=1 NOVA_AI_VITEST_PRINT_IMPORT_BREAKDOWN=1`
