...
export type ConnectableNova AITransport = Nova AITransport & {
...
export type Nova AIEvent<TData = unknown> = {
  version: 1;
  id: string;
  ts: number;
