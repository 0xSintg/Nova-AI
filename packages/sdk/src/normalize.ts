import type { GatewayEvent, JsonObject, Nova AIEvent, Nova AIEventType } from "./types.js";
...
function normalizeLifecycleEndEventType(data: JsonObject): Nova AIEventType {
...
function normalizeAgentEventType(payload: JsonObject): Nova AIEventType {
...
function normalizeNamedEventType(event: GatewayEvent): Nova AIEventType {
...
export function normalizeGatewayEvent(event: GatewayEvent): Nova AIEvent {
  const payload = asRecord(event.payload);
