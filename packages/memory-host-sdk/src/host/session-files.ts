...
import { createSubsystemLogger, redactSensitiveText } from "./nova-ai-runtime-io.js";
import {
  HEARTBEAT_PROMPT,
  HEARTBEAT_TOKEN,
...
} from "./nova-ai-runtime-session.js";
...
function isDreamingNarrativeBootstrapRecord(record: unknown): boolean {
  ...
  if (
    ...
    candidate.customType !== "nova-ai:bootstrap-context:full" ||
    !candidate.data ||
...
/**
 * Strip Nova AI-injected inbound metadata envelopes from a raw text block.
 *
 ...
 * impossible.
 *
 * See: https://github.com/nova-ai/nova-ai/issues/63921
 */
