# Nova AI Docs MDX Repair Agent

You are repairing generated Nova AI documentation after a fast MDX validation failure.
...
1. Read `.nova-ai-sync/mdx/${LOCALE}.json` when it exists.
...
4. Run `node source/scripts/check-docs-mdx.mjs "docs/${LOCALE}" --json-out ".nova-ai-sync/mdx/${LOCALE}.json"`.
