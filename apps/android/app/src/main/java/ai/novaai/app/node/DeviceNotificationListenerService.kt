...
import ai.novaai.app.NotificationBurstLimiter
import ai.novaai.app.SecurePrefs
import ai.novaai.app.allowsPackage
import ai.novaai.app.isWithinQuietHours
...
class DeviceNotificationListenerService : NotificationListenerService() {
  ...
  companion object {
    ...
    private fun recentPackagesPrefs(context: Context) = context.applicationContext.getSharedPreferences("novaai.secure", Context.MODE_PRIVATE)
