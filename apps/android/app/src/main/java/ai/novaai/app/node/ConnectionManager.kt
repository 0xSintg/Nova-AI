...
import ai.novaai.app.gateway.GatewayClientInfo
import ai.novaai.app.gateway.GatewayConnectOptions
import ai.novaai.app.gateway.GatewayEndpoint
import ai.novaai.app.gateway.GatewayTlsParams
...
class ConnectionManager(
  ...
  fun buildUserAgent(): String {
    ...
    return "NovaAIAndroid/$version (Android $releaseLabel; SDK ${Build.VERSION.SDK_INT})"
  }
  ...
  fun buildNodeConnectOptions(): GatewayConnectOptions =
    GatewayConnectOptions(
      ...
      client = buildClientInfo(clientId = "novaai-android", clientMode = "node"),
  ...
  fun buildOperatorConnectOptions(): GatewayConnectOptions =
    GatewayConnectOptions(
      ...
      commands = emptyList(),
      permissions = emptyMap(),
      client = buildClientInfo(clientId = "novaai-android", clientMode = "ui"),
      userAgent = buildUserAgent(),
    )
