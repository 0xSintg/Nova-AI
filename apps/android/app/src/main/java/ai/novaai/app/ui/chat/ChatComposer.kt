...
import ai.novaai.app.ui.mobileAccentBorderStrong
...
import ai.novaai.app.ui.mobileHeadline
import ai.novaai.app.ui.mobileSurface
import ai.novaai.app.ui.mobileText
import ai.novaai.app.ui.mobileTextSecondary
import ai.novaai.app.ui.mobileTextTertiary
  ...
  Column(modifier = Modifier.fillMaxWidth(), verticalArrangement = Arrangement.spacedBy(8.dp)) {
    ...
    if (!healthOk) {
      Text(
        ...
        style = mobileCallout,
        color = ai.novaai.app.ui.mobileWarning,
      )
    }
...
private fun mobileBodyStyle() =
  MaterialTheme.typography.bodyMedium.copy(
    fontFamily = ai.novaai.app.ui.mobileFontFamily,
