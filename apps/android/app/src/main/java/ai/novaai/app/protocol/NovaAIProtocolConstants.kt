...
enum class NovaAICanvasCommand(
  val rawValue: String,
) {
...
enum class NovaAICanvasA2UICommand(
  val rawValue: String,
) {
...
enum class NovaAICameraCommand(
  val rawValue: String,
) {
  List("camera.list"),
  Snap("camera.snap"),
...
enum class NovaAILocationCommand(
  val rawValue: String,
) {
  Get("location.get"),
  ;
...
enum class NovaAIDeviceCommand(
  val rawValue: String,
) {
...
enum class NovaAINotificationsCommand(
  val rawValue: String,
) {
...
enum class NovaAISystemCommand(
  val rawValue: String,
) {
...
enum class NovaAIPhotosCommand(
  val rawValue: String,
) {
...
enum class NovaAIContactsCommand(
  val rawValue: String,
) {
...
enum class NovaAICalendarCommand(
  val rawValue: String,
) {
...
enum class NovaAIMotionCommand(
  val rawValue: String,
) {
...
enum class NovaAICallLogCommand(
  val rawValue: String,
) {
