...
class DeviceAuthPayloadTest {
  ...
  fun buildV3_matchesCanonicalVector() {
    ...
    assertEquals(
      "v3|dev-1|novaai-macos|ui|operator|operator.admin,operator.read|1700000000000|tok-123|nonce-abc|ios|iphone",
      payload,
    )
  }
