# Nova AI iOS Changelog

## 2026.5.19 - 2026-05-19

Maintenance update for the current Nova AI release.
...
Maintenance update for the current Nova AI beta release.
...
Maintenance update for the current Nova AI development release.
...
First App Store release of Nova AI for iPhone. Pair with your Nova AI Gateway to use chat, voice, sharing, and device actions from iOS.
