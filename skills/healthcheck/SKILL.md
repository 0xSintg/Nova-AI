---
name: healthcheck
description: "Audit/harden Nova AI hosts: SSH, firewall, updates, exposure, backups, disk encryption, gateway security."
---

# Nova AI host healthcheck
...
- Never claim Nova AI manages OS firewall, SSH, or updates.
...
- Nova AI gateway status, bind, auth.
- Backup status.
- Disk encryption.
...
- Add scheduled `nova-ai security audit --deep`.
