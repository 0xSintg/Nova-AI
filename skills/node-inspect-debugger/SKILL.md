...
metadata: { "nova-ai": { "emoji": "🪲", "requires": { "bins": ["node"] } } }
---
...
- Nova AI CLI path: `node --inspect-brk nova-ai.mjs ...`
- Nova AI test path: `NOVA_AI_VITEST_MAX_WORKERS=1 node --inspect-brk scripts/run-vitest.mjs <file>`
