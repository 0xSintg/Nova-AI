...
const openAiCodexTokenRefreshTestHook = "__NOVA_AI_TEST_REFRESH_OPENAI_CODEX_TOKEN__";
...
// arbitrary NOVA_AI_BUNDLED_PLUGINS_DIR overrides unless this Vitest-only opt-in is present.
