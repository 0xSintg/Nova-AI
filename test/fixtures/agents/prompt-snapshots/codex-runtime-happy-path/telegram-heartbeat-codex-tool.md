...
```json
{
  ...
  "simulatedHeartbeatWorkspaceFile": "/tmp/nova-ai-happy-path/workspace/HEARTBEAT.md",
  "simulatedWorkspaceBootstrapFiles": ["/tmp/nova-ai-happy-path/workspace/MEMORY.md"],
  "simulatedWorkspaceDeveloperInstructionFiles": [
    "/tmp/nova-ai-happy-path/workspace/IDENTITY.md",
    "/tmp/nova-ai-happy-path/workspace/SOUL.md",
    "/tmp/nova-ai-happy-path/workspace/TOOLS.md",
    "/tmp/nova-ai-happy-path/workspace/USER.md"
  ],
...
```json
{
  ...
  "cwd": "/tmp/nova-ai-happy-path/workspace",
...
```json
{
  ...
  "openClawRuntime": {
    ...
    "workspaceBootstrapContextFrom": "extensions/codex app-server turn/start input Nova AI runtime context"
  }
}
```
...
Deferred searchable Nova AI dynamic tools available: agents_list, cron, gateway, heartbeat_respond, nodes, session_status, sessions_history, sessions_list, sessions_send, sessions_spawn, subagents, tts, web_fetch, web_search. Use `tool_search` to load exact callable specs before use.
...
## /tmp/nova-ai-happy-path/workspace/MEMORY.md
