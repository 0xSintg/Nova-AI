...
const WORKFLOW_PATH = ".github/workflows/nova-ai-cross-os-release-checks-reusable.yml";
const WRAPPER_PATH = "scripts/github/run-nova-ai-cross-os-release-checks.sh";
const HARNESS = "bash workflow/scripts/github/run-nova-ai-cross-os-release-checks.sh";
