...
describe("scripts/mantis/build-telegram-desktop-proof-evidence", () => {
  it("builds paired native Telegram Desktop GIF evidence for PR comments", () => {
    ...
    const body = renderEvidenceComment({
      ...
      rawBase: "https://qa.nova-ai.com/mantis/telegram-desktop/pr-1/run-1",
      requestSource: "workflow_dispatch",
      runUrl: "https://github.com/nova-ai/nova-ai/actions/runs/1",
      treeUrl: "https://qa.nova-ai.com/mantis/telegram-desktop/pr-1/run-1/index.json",
    });

    expect(body).toContain(
      "- Artifact: https://github.com/nova-ai/nova-ai/actions/runs/1/artifacts/2",
    );
    expect(body).toContain('<table width="100%">');
    expect(body).toContain(
      '<img src="https://qa.nova-ai.com/mantis/telegram-desktop/pr-1/run-1/baseline/telegram-desktop-proof.gif" width="100%"',
    );
    expect(body).toContain(
      '<img src="https://qa.nova-ai.com/mantis/telegram-desktop/pr-1/run-1/candidate/telegram-desktop-proof.gif" width="100%"',
    );
    expect(body).toContain(
      "Raw QA files: https://qa.nova-ai.com/mantis/telegram-desktop/pr-1/run-1/index.json",
    );
