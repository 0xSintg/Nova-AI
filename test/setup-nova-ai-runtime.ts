...
const WORKER_RUNTIME_STATE = Symbol.for("nova-ai.testSetupRuntimeState");
const WORKER_PLUGIN_RUNTIME_HELPERS = Symbol.for("nova-ai.testSetupPluginRuntimeHelpers");
const WORKER_CLEANUP_HELPERS = Symbol.for("nova-ai.testSetupCleanupHelpers");
...
const createStubPlugin = (params: {
  ...
  config: {
    ...
    isConfigured: async (_account, cfg: Nova AIConfig) => {
      const channels = cfg.channels as Record<string, unknown> | undefined;
