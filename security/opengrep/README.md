...
`precise.yml` is Nova AI's shipped precise OpenGrep rulepack. Each rule is tied
...
Some Nova AI paths are excluded by `.gitignore` for build reasons even though
