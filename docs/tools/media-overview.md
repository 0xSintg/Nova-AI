...
read_when:
  - Looking for an overview of Nova AI's media capabilities
...
Nova AI generates images, videos, and music, understands inbound media
...
For async tools, Nova AI submits the request to the provider, returns a task
...
Nova AI wakes the agent with the generated media paths so it can tell the
user and relay the result through the message tool. Nova AI treats missing
...
<AccordionGroup>
  ...
  <Accordion title="DeepInfra">
    ...
    registered until Nova AI has dedicated provider contracts for those
    categories.
  </Accordion>
  <Accordion title="xAI">
    ...
    not registered in Nova AI until the shared realtime-voice contract can
    represent it.
  </Accordion>
</AccordionGroup>
