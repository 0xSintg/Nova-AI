...
[Tavily](https://tavily.com) is a search API designed for AI applications. Nova AI exposes it in two ways:
...
<Tip>
Choosing Tavily in onboarding or `nova-ai configure --section web` enables the bundled Tavily plugin automatically.
</Tip>
