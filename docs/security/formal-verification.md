---
summary: Machine-checked security models for Nova AI's highest-risk paths.
...
This page tracks Nova AI's **formal security models** (TLA+/TLC today; more as needed).

> Note: some older links may refer to the previous project name.

**Goal (north star):** provide a machine-checked argument that Nova AI enforces its
...
**What this is not (yet):** a proof that "Nova AI is secure in all respects" or that the full TypeScript implementation is correct.

## Where the models live

Models are maintained in a separate repo: [vignesh07/nova-ai-formal-models](https://github.com/vignesh07/nova-ai-formal-models).
...
```bash
git clone https://github.com/vignesh07/nova-ai-formal-models
cd nova-ai-formal-models
