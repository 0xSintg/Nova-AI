...
read_when:
  - Planning a broad Nova AI application modernization pass
...
modernization task. If adopting this guidance as a repo-local Nova AI skill,
create `.agents/skills/nova-ai-frontend/SKILL.md` first, keep the frontmatter
