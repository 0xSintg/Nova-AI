...
If the active memory plugin exposes shared recall artifacts, Nova AI can search
...
currently exposing public bridge inputs yet. Run `nova-ai wiki doctor` first,
...
`nova-ai wiki status`, `nova-ai wiki doctor`, and `nova-ai wiki bridge
...
nova-ai wiki apply synthesis "Alpha Summary" --body "..." --source-id source.alpha
