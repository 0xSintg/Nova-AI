---
summary: "Contributor guide for adding a new shared capability to the Nova AI plugin system"
read_when:
...
<Info>
  This is a **contributor guide** for Nova AI core developers. If you are
...
Use this when Nova AI needs a new shared domain such as image generation, video generation, or some future vendor-backed feature area.
