---
summary: "Testing utilities and patterns for Nova AI plugins"
...
Reference for test utilities, patterns, and lint enforcement for Nova AI
plugins.
...
These test-helper subpaths are repo-local source entrypoints for Nova AI's own
bundled plugin tests. They are not package exports for third-party plugins.

**Plugin API mock import:** `nova-ai/plugin-sdk/plugin-test-api`

**Agent runtime contract import:** `nova-ai/plugin-sdk/agent-runtime-test-contracts`

**Channel contract import:** `nova-ai/plugin-sdk/channel-contract-testing`

**Channel test helper import:** `nova-ai/plugin-sdk/channel-test-helpers`

**Channel target test import:** `nova-ai/plugin-sdk/channel-target-testing`

**Plugin contract import:** `nova-ai/plugin-sdk/plugin-test-contracts`

**Plugin runtime test import:** `nova-ai/plugin-sdk/plugin-test-runtime`

**Provider contract import:** `nova-ai/plugin-sdk/provider-test-contracts`

**Provider HTTP mock import:** `nova-ai/plugin-sdk/provider-http-test-mocks`

**Environment/network test import:** `nova-ai/plugin-sdk/test-env`

**Generic fixture import:** `nova-ai/plugin-sdk/test-fixtures`

**Node builtin mock import:** `nova-ai/plugin-sdk/test-node-mocks`

Prefer the focused subpaths below for new plugin tests. The broad
`nova-ai/plugin-sdk/testing` barrel is legacy compatibility only.
...
} from "nova-ai/plugin-sdk/channel-feedback";
import { installCommonResolveTargetErrorCases } from "nova-ai/plugin-sdk/channel-target-testing";
import { AUTH_PROFILE_RUNTIME_CONTRACT } from "nova-ai/plugin-sdk/agent-runtime-test-contracts";
import { createTestPluginApi } from "nova-ai/plugin-sdk/plugin-test-api";
import { expectChannelInboundContextContract } from "nova-ai/plugin-sdk/channel-contract-testing";
import { createStartAccountContext } from "nova-ai/plugin-sdk/channel-test-helpers";
import { describePluginRegistrationContract } from "nova-ai/plugin-sdk/plugin-test-contracts";
import { registerSingleProviderPlugin } from "nova-ai/plugin-sdk/plugin-test-runtime";
import { describeOpenAIProviderRuntimeContract } from "nova-ai/plugin-sdk/provider-test-contracts";
import { getProviderHttpMocks } from "nova-ai/plugin-sdk/provider-http-test-mocks";
import { withEnv, withFetchPreconnect, withServer } from "nova-ai/plugin-sdk/test-env";
import {
  bundledPluginRoot,
  createCliRuntimeCapture,
  typedCases,
} from "nova-ai/plugin-sdk/test-fixtures";
import { mockNodeBuiltinModule } from "nova-ai/plugin-sdk/test-node-mocks";
```
...
suites that depend on bundled Nova AI inventory stay under `src/plugins/contracts`.
...
import type { MockFn, PluginRuntime, RuntimeEnv } from "nova-ai/plugin-sdk/plugin-test-runtime";
```
...
Nova AI's loader acceptance gates. Add at least one loader-backed smoke test
...
Prefer the shared plugin runtime mock from `nova-ai/plugin-sdk/channel-test-helpers`
...
1. **No monolithic root imports** -- `nova-ai/plugin-sdk` root barrel is rejected
...
Nova AI uses Vitest with V8 coverage thresholds. For plugin tests:
