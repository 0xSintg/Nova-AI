---
summary: "Adds Amazon Bedrock Mantle model provider support to Nova AI."
read_when:
...
Adds Amazon Bedrock Mantle model provider support to Nova AI.

## Distribution

- Package: `@nova-ai/amazon-bedrock-mantle-provider`
