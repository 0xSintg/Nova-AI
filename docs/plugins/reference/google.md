---
summary: "Adds Google, Google Gemini CLI, Google Vertex model provider support to Nova AI."
read_when:
...
Adds Google, Google Gemini CLI, Google Vertex model provider support to Nova AI.

## Distribution

- Package: `@nova-ai/google-plugin`
