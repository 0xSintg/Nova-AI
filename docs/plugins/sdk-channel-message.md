...
`nova-ai/plugin-sdk/channel-message`. The adapter describes the native message
...
`nova-ai/plugin-sdk/channel-message-runtime` for monitor/send code paths that
are already doing asynchronous message I/O.

New channel and plugin send code should use the message lifecycle helpers from
`nova-ai/plugin-sdk/channel-message-runtime`: `sendDurableMessageBatch`,
`withDurableMessageSendContext`, or `deliverInboundReplyWithMessageSendContext`.
The older
`deliverOutboundPayloads(...)` helper in `nova-ai/plugin-sdk/outbound-runtime`
...
`nova-ai/plugin-sdk/channel-message`, then call the runtime's
...
```typescript
import { deriveDurableFinalDeliveryRequirements } from "nova-ai/plugin-sdk/channel-message";
...
| -------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------- |
| `nova-ai/plugin-sdk/channel-reply-pipeline` | `nova-ai/plugin-sdk/channel-message`                                                                                      |
...
| `deliverDurableInboundReplyPayload(...)`     | `deliverInboundReplyWithMessageSendContext(...)` from `nova-ai/plugin-sdk/channel-message-runtime`                        |
