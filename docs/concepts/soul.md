---
summary: "Use SOUL.md to give your Nova AI agent an actual voice instead of generic assistant sludge"
read_when:
...
Nova AI injects it on normal sessions, so it has real weight. If your agent
...
For Nova AI, `SOUL.md` is that layer.
...
Path fixed for Nova AI workspaces: use `SOUL.md`, not `http://SOUL.md`.
...
<CardGroup cols={2}>
  <Card title="Agent workspace" href="/concepts/agent-workspace" icon="folder-open">
    Workspace files Nova AI injects into model context.
  </Card>
  <Card title="System prompt" href="/concepts/system-prompt" icon="message-lines">
    How `SOUL.md` is composed into Nova AI and Codex runtime context.
  </Card>
