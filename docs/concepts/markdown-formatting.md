...
Nova AI formats outbound Markdown by converting it into a shared intermediate
...
```markdown
Hello **world** - see [docs](https://docs.nova-ai.com).
```
...
```json
{
  ...
  "links": [{ "start": 19, "end": 23, "href": "https://docs.nova-ai.com" }]
}
```
