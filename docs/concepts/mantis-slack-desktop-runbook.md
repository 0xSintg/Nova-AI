...
Linux desktop, VNC rescue, Slack Web, a real Nova AI gateway, screenshots,
...
- Mantis artifacts: owned by the Nova AI run. They live under
...
- remote logs such as `slack-desktop-command.log`, `nova-ai-gateway.log`,
...
- `crabbox.remote_run`: sync, browser launch, Nova AI install/build or
...
remote status after Mantis has copied metadata proving that the Nova AI gateway
