...
Nova AI also builds a separate idempotent replay view for sessions that
...
Nova AI auto-enables pruning for Anthropic profiles:
...
If you set explicit values, Nova AI does not override them.
