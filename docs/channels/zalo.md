...
Zalo ships as a bundled plugin in current Nova AI releases, so normal packaged
...
- Install via CLI: `nova-ai plugins install @nova-ai/zalo`
- Pinned version: `nova-ai plugins install @nova-ai/zalo@2026.5.2`
- Or from a source checkout: `nova-ai plugins install ./path/to/local/zalo-plugin`
...
This page reflects current Nova AI behavior for **Zalo Bot Creator / Marketplace bots**.
...
- Approve via:
  - `nova-ai pairing list zalo`
  - `nova-ai pairing approve zalo <CODE>`
...
This table summarizes current **Zalo Bot Creator / Marketplace bot** behavior in Nova AI.
...
- Example: `nova-ai message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `nova-ai channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `nova-ai logs --follow`
