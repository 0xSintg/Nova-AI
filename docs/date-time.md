...
Nova AI defaults to **host-local time for transport timestamps** and **user timezone only in the system prompt**.
...
When `timeFormat: "auto"`, Nova AI inspects the OS preference (macOS/Windows)
