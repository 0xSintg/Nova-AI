---
summary: "Run Nova AI Gateway 24/7 on a cheap Hetzner VPS (Docker) with durable state and baked-in binaries"
read_when:
  - You want Nova AI running 24/7 on a cloud VPS (not your laptop)
  - You want a production-grade, always-on Gateway on your own VPS
  - You want full control over persistence, binaries, and restart behavior
  - You are running Nova AI in Docker on Hetzner or a similar provider
title: "Hetzner"
---

## Goal

Run a persistent Nova AI Gateway on a Hetzner VPS using Docker, with durable state, baked-in binaries, and safe restart behavior.

If you want "Nova AI 24/7 for ~$5", this is the simplest reliable setup.
...
<Steps>
  ...
  <Step title="Create persistent host directories">
    ...
    ```bash
    mkdir -p /root/.nova-ai/workspace

    # Set ownership to the container user (uid 1000):
    chown -R 1000:1000 /root/.nova-ai
    ```
  ...
  <Step title="Configure environment variables">
    ...
    NOVA_AI_CONFIG_DIR=/root/.nova-ai
    NOVA_AI_WORKSPACE_DIR=/root/.nova-ai/workspace
...
- Infrastructure: [nova-ai-terraform-hetzner](https://github.com/andreesg/nova-ai-terraform-hetzner)
- Docker config: [nova-ai-docker-config](https://github.com/andreesg/nova-ai-docker-config)
