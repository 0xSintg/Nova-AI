---
summary: "Inworld streaming text-to-speech for Nova AI replies"
read_when:
...
Inworld is a streaming text-to-speech (TTS) provider. In Nova AI it
...
Nova AI posts to Inworld's streaming TTS endpoint, concatenates the
...
<Steps>
  ...
  <Step title="Send a message">
    Send a reply through any connected channel. Nova AI synthesizes the
...
<AccordionGroup>
  ...
  <Accordion title="Audio outputs">
    ...
    Nova AI asks Inworld for `OGG_OPUS` so the audio plays as a native
