---
summary: "Use NVIDIA's OpenAI-compatible API in Nova AI"
read_when:
  - You want to use open models in Nova AI for free
...
<Steps>
  ...
  <Step title="Export the key and run onboarding">
    ...
    nova-ai onboard --auth-choice nvidia-api-key
    ```
  </Step>
  <Step title="Set an NVIDIA model">
    ```bash
    nova-ai models set nvidia/nvidia/nemotron-3-super-120b-a12b
    ```
  </Step>
</Steps>
...
```bash
nova-ai onboard --auth-choice nvidia-api-key --nvidia-api-key "nvapi-..."
```
