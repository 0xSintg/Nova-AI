...
<Steps>
  ...
  <Step title="Configure Nova AI">
    Point Nova AI at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or Nova AI
...
<CardGroup cols={2}>
  <Card title="Anthropic provider" href="/providers/anthropic" icon="bolt">
    Native Nova AI integration with Claude CLI or API keys.
  </Card>
