---
summary: "fal image, video, and music generation setup in Nova AI"
title: "Fal"
read_when:
  - You want to use fal image generation in Nova AI
  - You need the FAL_KEY auth flow
  - You want fal defaults for image_generate, video_generate, or music_generate
---

Nova AI ships a bundled `fal` provider for hosted image, video, and music
generation.
...
<Steps>
  <Step title="Set the API key">
    ```bash
    nova-ai onboard --auth-choice fal-api-key
    ```
  </Step>
...
explicit transparent-background control in Nova AI, so `background:
...
<Tip>
Use `nova-ai models list --provider fal` to see the full list of available fal
