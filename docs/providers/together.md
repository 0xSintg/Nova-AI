...
title: "Together AI"
read_when:
  - You want to use Together AI with Nova AI
...
<Steps>
  ...
  <Step title="Run onboarding">
    ```bash
    nova-ai onboard --auth-choice together-api-key
    ```
  </Step>
...
Nova AI ships this bundled Together catalog:
...
<AccordionGroup>
  <Accordion title="Environment note">
    ...
    gateway processes. Use `~/.nova-ai/.env` or `env.shellEnv` config for
  ...
  <Accordion title="Troubleshooting">
    - Verify your key works: `nova-ai models list --provider together`
