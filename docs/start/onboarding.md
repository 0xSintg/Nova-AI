---
summary: "First-run setup flow for Nova AI (macOS app)"
read_when:
...
- By default, Nova AI is a personal agent: one trusted operator boundary.
...
<Frame caption="Choose what permissions do you want to give Nova AI">
...
<Step title="CLI">
  ...
  The app can install the global `nova-ai` CLI via npm, pnpm, or bun.
