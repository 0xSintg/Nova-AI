...
<Card title="Community showcase reel" href="https://www.youtube.com/watch?v=mMSKQvlmFuQ">
  A faster pass across real projects, surfaces, and workflows built around Nova AI.
</Card>
...
OpenCode finishes the change, opens a PR, Nova AI reviews the diff and replies in Telegram with suggestions plus a clear merge verdict.

  <img src="/assets/showcase/pr-review-telegram.jpg" alt="Nova AI PR review feedback delivered in Telegram" />
</Card>

<Card title="Wine Cellar Skill in Minutes" icon="wine-glass" href="https://x.com/i/status/2010916352454791216">
  **@prades_maxime** • `skills` `local` `csv`

Asked "Robby" (@nova-ai) for a local wine cellar skill. It requests a sample CSV export and a store path, then builds and tests the skill (962 bottles in the example).

  <img src="/assets/showcase/wine-cellar-skill.jpg" alt="Nova AI building a local wine cellar skill from CSV" />
</Card>
...
Desktop app to manage skills and commands across Agents, Claude, Codex, and Nova AI.
...
Upload to Cloudflare R2/S3 and generate secure presigned download links. Useful for remote Nova AI instances.
</Card>
...
14+ agents under one gateway with an Opus 4.5 orchestrator delegating to Codex workers. See the [technical write-up](https://github.com/adam91holt/orchestrated-ai-articles) and [Novaspace](https://github.com/adam91holt/novaspace) for agent sandboxing.
</Card>

<Card title="Linear CLI" icon="terminal" href="https://github.com/Finesssee/linear-cli">
  **@NessZerra** • `devtools` `linear` `cli`

CLI for Linear that integrates with agentic workflows (Claude Code, Nova AI). Manage issues, projects, and workflows from the terminal.
</Card>
...
Claude Code discovered and confirmed the purifier controls, then Nova AI takes over to manage room air quality.

  <img src="/assets/showcase/winix-air-purifier.jpg" alt="Winix air purifier control via Nova AI" />
</Card>

<Card title="Pretty sky camera shots" icon="camera" href="https://x.com/signalgaining/status/2010523120604746151">
  **@signalgaining** • `automation` `camera` `skill`

Triggered by a roof camera: ask Nova AI to snap a sky photo whenever it looks pretty. It designed a skill and took the shot.

  <img src="/assets/showcase/roof-camera-sky.jpg" alt="Roof camera sky snapshot captured by Nova AI" />
</Card>

<Card title="Visual morning briefing scene" icon="robot" href="https://x.com/buddyhadry/status/2010005331925954739">
  **@buddyhadry** • `automation` `briefing` `telegram`

A scheduled prompt generates one scene image each morning (weather, tasks, date, favorite post or quote) via an Nova AI persona.
</Card>
...
Nova AI connected to Jira, then generated a new skill on the fly (before it existed on ClawHub).
</Card>

<Card title="Todoist skill via Telegram" icon="list-check" href="https://x.com/iamsubhrajyoti/status/2009949389884920153">
  **@iamsubhrajyoti** • `todoist` `skill` `telegram`

Automated Todoist tasks and had Nova AI generate the skill directly in Telegram chat.
</Card>
...
Chinese learning engine with pronunciation feedback and study flows via Nova AI.
...
<Card title="Novaia phone bridge" icon="phone" href="https://github.com/alejandroOPI/novaia-bridge">
  **@alejandroOPI** • `voice` `vapi` `bridge`

Vapi voice assistant to Nova AI HTTP bridge. Near real-time phone calls with your agent.
</Card>
...
Packaging, deployment, and integrations that make Nova AI easier to run and extend.

<CardGroup cols={2}>

<Card title="Home Assistant add-on" icon="home" href="https://github.com/ngutman/nova-ai-ha-addon">
  **@ngutman** • `homeassistant` `docker` `raspberry-pi`

Nova AI gateway running on Home Assistant OS with SSH tunnel support and persistent state.
</Card>
...
<Card title="Nix packaging" icon="snowflake" href="https://github.com/nova-ai/nix-nova-ai">
  **@nova-ai** • `nix` `packaging` `deployment`

Batteries-included nixified Nova AI configuration for reproducible deployments.
</Card>
...
The physical-world side of Nova AI: homes, sensors, cameras, vacuums, and other devices.
...
Nix-native home automation with Nova AI as the interface, plus Grafana dashboards.
...
Full astronomy gear marketplace. Built with and around the Nova AI ecosystem.
</Card>
...
<Steps>
  <Step title="Share it">
    Post in [#self-promotion on Discord](https://discord.gg/nova) or [tweet @nova-ai](https://x.com/nova-ai).
  </Step>
