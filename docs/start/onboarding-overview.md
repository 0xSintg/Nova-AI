---
summary: "Overview of Nova AI onboarding options and flows"
read_when:
...
Nova AI has two onboarding paths. Both configure auth, the Gateway, and
...
| **Command**    | `nova-ai onboard`                     | Launch the app            |
...
CLI command docs: [`nova-ai onboard`](/cli/onboard)

## macOS app onboarding

Open the Nova AI app. The first-run wizard walks you through the same steps
