---
summary: "CLI reference for `nova-ai health` (gateway health snapshot via RPC)"
read_when:
...
nova-ai health
nova-ai health --json
nova-ai health --timeout 2500
nova-ai health --verbose
nova-ai health --debug
```

Notes:

- Default `nova-ai health` asks the running gateway for its health snapshot. When the
