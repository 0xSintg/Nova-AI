---
summary: "CLI reference for `nova-ai system` (system events, heartbeat, presence)"
read_when:
...
nova-ai system event --text "Check for urgent follow-ups" --url ws://127.0.0.1:18789 --token "$NOVA_AI_GATEWAY_TOKEN"
nova-ai system heartbeat enable
nova-ai system heartbeat last
nova-ai system presence
```
