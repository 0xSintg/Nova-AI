---
summary: "CLI reference for `nova-ai voicecall` (voice-call plugin command surface)"
read_when:
...
nova-ai voicecall smoke    [-t <phone>] [--message <text>] [--mode <m>] [--yes] [--json]
nova-ai voicecall call     -m <text> [-t <phone>] [--mode <m>]
nova-ai voicecall start    --to <phone> [--message <text>] [--mode <m>]
nova-ai voicecall continue --call-id <id> --message <text>
nova-ai voicecall speak    --call-id <id> --message <text>
nova-ai voicecall dtmf     --call-id <id> --digits <digits>
nova-ai voicecall end      --call-id <id>
nova-ai voicecall status   [--call-id <id>] [--json]
nova-ai voicecall tail     [--file <path>] [--since <n>] [--poll <ms>]
nova-ai voicecall latency  [--file <path>] [--last <n>]
nova-ai voicecall expose   [--mode <m>] [--path <p>] [--port <port>] [--serve-path <p>]
```
...
| `--message <text>` | `Nova AI voice call smoke test.` | Message to speak during the smoke call. |
...
nova-ai voicecall smoke --to "+15555550123"        # dry run
nova-ai voicecall smoke --to "+15555550123" --yes  # live notify call
```
...
```bash
nova-ai voicecall call --to "+15555550123" --message "Hello"
nova-ai voicecall call -m "Heads up" --mode notify
```
...
```bash
nova-ai voicecall status
nova-ai voicecall status --json
...
```bash
nova-ai voicecall expose --mode serve
nova-ai voicecall expose --mode funnel
nova-ai voicecall expose --mode off
```
