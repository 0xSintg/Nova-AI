...
Nova AI treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.nova-ai/settings/voicewake.json`

Shape:

```json
{ "triggers": ["nova-ai", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
