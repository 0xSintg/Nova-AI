---
summary: "Nova AI is a multi-channel gateway for AI agents that runs on any OS."
read_when:
  - Introducing Nova AI to newcomers
title: "Nova AI"
---
...
<p align="center">
    <img
        src="/assets/nova-ai-logo-text-dark.png"
        alt="Nova AI"
        width="500"
        class="dark:hidden"
    />
    <img
        src="/assets/nova-ai-logo-text.png"
        alt="Nova AI"
        width="500"
...
<Columns>
  <Card title="Get Started" href="/start/getting-started" icon="rocket">
    Install Nova AI and bring up the Gateway in minutes.
  </Card>
  <Card title="Run Onboarding" href="/start/wizard" icon="sparkles">
    Guided setup with `nova-ai onboard` and pairing flows.
  </Card>
...
Nova AI is a **self-hosted gateway** that connects your favorite chat apps and channel surfaces — built-in channels plus bundled or external channel plugins such as Discord, Google Chat, iMessage, Matrix, Microsoft Teams, Signal, Slack, Telegram, WhatsApp, Zalo, and more — to AI coding agents like Pi. You run a single Gateway process on your own machine (or a server), and it becomes the bridge between your messaging apps and an always-available AI assistant.
...
<p align="center">
  <img src="/whatsapp-nova-ai.jpg" alt="Nova AI" width="420" />
</p>

## Configuration (optional)

Config lives at `~/.nova-ai/nova-ai.json`.

- If you **do nothing**, Nova AI uses the bundled Pi binary in RPC mode with per-sender sessions.
...
```json5
{
  ...
  messages: { groupChat: { mentionPatterns: ["@nova-ai"] } },
}
```
