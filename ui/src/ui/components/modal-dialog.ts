...
export class Nova AIModalDialog extends LitElement {
  @property() label = "";
  ...
  override render() {
    const labelId = this.label ? "nova-ai-modal-dialog-label" : "";
    const descriptionId = this.description ? "nova-ai-modal-dialog-description" : "";
    return html`
      <dialog
        role="dialog"
        aria-modal="true"
...
if (!customElements.get("nova-ai-modal-dialog")) {
  customElements.define("nova-ai-modal-dialog", Nova AIModalDialog);
}

declare global {
  interface HTMLElementTagNameMap {
    "nova-ai-modal-dialog": Nova AIModalDialog;
  }
}
