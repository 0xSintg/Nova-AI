...
const SYNTHETIC_TRANSCRIPT_REPAIR_RESULT =
  "[nova-ai] missing tool result in session history; inserted synthetic error result for transcript repair.";
...
function hasTranscriptMeta(message: unknown): boolean {
  return Boolean(
    ...
    (message as { __nova-ai?: unknown })["__nova-ai"] &&
    typeof (message as { __nova-ai?: unknown })["__nova-ai"] === "object",
  );
}
...
export function handleChatEvent(state: ChatState, payload?: ChatEventPayload) {
  ...
  // See https://github.com/nova-ai/nova-ai/issues/1909
