...
export const en: TranslationMap = {
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "On mobile? Copy the full URL (including #token=...) from nova-ai dashboard --no-open on your desktop.",
    ...
    cards: {
      ...
      modelAuthAttentionExpiredDesc: "{providers} — re-authenticate with nova-ai models auth",
  ...
  login: {
    ...
    failure: {
      ...
      pairing: {
        ...
        stepList: "Run nova-ai devices list on the Gateway host.",
        stepApproveId: "Approve this request: nova-ai devices approve {requestId}.",
      ...
      network: {
        ...
        stepGateway: "Confirm the Gateway is running with nova-ai status or nova-ai gateway run.",
        stepUrl:
